...
`));class Se extends g{constructor(){super(),this.state={showSearchInput:!1,geocoder:{},results:"",geoResult:{},parsedText:""},this.openSearchInput=this.openSearchInput.bind(this),this.onClick=this.onClick.bind(this),this.onSearch=this.onSearch.bind(this),this.onGetResult=this.onGetResult.bind(this),this.onConfirm=this.onConfirm.bind(this),this.onPressKey=this.onPressKey.bind(this),this.onLanguageChange=this.onLanguageChange.bind(this)}componentWillMount(){const{i18n:t}=this.props;let e=new window.MapboxGeocoder({accessToken:"pk.eyJ1IjoiamZxdWVyYWx0IiwiYSI6ImNrODcwb29vajBjMDkzbWxqZHh6ZDU5aHUifQ.BjT63Mdh-P2myNvygIhSpw",language:t?t.locale:"es",mapboxgl:window.mapboxgl,types:"country"});window.geoCoder=e,e.on("results",this.onGetResult),this.setState({geocoder:e})}componentWillUnmount(){window.removeEventListener("keydown",this.onPressKey)}componentDidMount(){this.state.geocoder.addTo("#blank"),window.addEventListener("keydown",this.onPressKey)}componentDidUpdate(t,e,n){t.i18n!==this.props.i18n&&this.onLanguageChange()}onLanguageChange(){const{i18n:t}=this.props,{geocoder:e}=this.state;e.setLanguage(t.locale)}onPressKey(t){"Enter"===t.code&&this.state.showSearchInput?(t.preventDefault(),this.onConfirm()):"Escape"===t.code&&this.state.showSearchInput&&(t.preventDefault(),this.openSearchInput())}onConfirm(){let{geoResult:t}=this.state;t.center&&(this.openSearchInput(),this.setState({results:"",geoResult:{},parsedText:""}),this.props.map.flyTo({center:t.center,maxDuration:500}),setTimeout(()=>{$t.setSearchParam("country",t.place_name),$t.setSearchParam("iso2",t.properties.short_code.toUpperCase())},501))}onSearch(t){let e=t.target.value,{geocoder:n}=this.state;n.query(e),this.setState({parsedText:e.toUpperCase()})}openSearchInput(){console.log("s"),this.setState({showSearchInput:!this.state.showSearchInput})}onGetResult(t){let{features:e}=t;if(e[0]){let t=e[0].text.toUpperCase();this.setState({results:t,geoResult:e[0]})}else this.setState({results:"",geoResult:{}})}onClick(){this.state.showSearchInput||this.openSearchInput()}render(t,{showSearchInput:e,results:n,parsedText:a}){return u("div",{onClick:this.onClick,class:Le+" "+(e?"show":"")},u("span",{class:"icon-provider"},fe),u("div",null,u("input",{class:"placeholder",value:n,disabled:!0}),u("input",{class:"countryInput",onInput:this.onSearch,value:a})),u("span",{id:"blank"}))}}let De,Pe,ze=t=>t;const Te={url:new URL("./src/components/WorldMap.js",document.baseURI).href},He="pk.eyJ1IjoiamZxdWVyYWx0IiwiYSI6ImNrODcwb29vajBjMDkzbWxqZHh6ZDU5aHUifQ.BjT63Mdh-P2myNvygIhSpw",Ae=I(De||(De=ze`
  & {
...
`)),Ue={asia:{lng:105.04,lat:20.13,zoom:2.04},eu:{lng:26.81,lat:55.71,zoom:2.12},us:{lng:-98.22,lat:37.68,zoom:2.7},africa:{lng:14.63,lat:2.61,zoom:1.88},lat:{lng:-36,lat:-20.2,zoom:1.56},me:{lng:53.39,lat:26.28,zoom:3.19}},je={asia:{lng:89.9,lat:36.2,zoom:1.15},eu:{lng:21.5,lat:50.4,zoom:1.52},us:{lng:-98.37,lat:43.09,zoom:2},africa:{lng:26.4,lat:14.4,zoom:1.43},lat:{lng:-63.6,lat:-16.4,zoom:1.44},me:{lng:53.4,lat:22,zoom:1.08}};function We(t){let e;switch(t){case"1":e="#eb5757";break;case"2":e="#f2994a";break;case"3":e="#6fcf97";break;default:e="#ccc"}return e}function Ve(t){let e={};for(let n in t)for(let a in t[n].data)for(let r in t[n].data[a]){let o=t[n].data[a][r];"all"!==a&&"US"!==a||(e[o.unit_code]=o)}return e}class Oe extends g{constructor(){super(),this.__handleSelect=this.__handleSelect.bind(this),this.initMap=this.initMap.bind(this),this.updateMap=this.updateMap.bind(this),this.updateMapLanguage=this.updateMapLanguage.bind(this),this.onMapClick=this.onMapClick.bind(this),this.onGetResult=this.onGetResult.bind(this);let t={lng:40.7,lat:25,zoom:1.06},e=t;e=screen.width<=699?je:Ue;let n=window.location.href,a=!1;for(let r in e)-1!=n.indexOf("lockdown."+r)&&(t=e[r],a=!0);this.state={lng:t.lng,lat:t.lat,zoom:t.zoom,countries:[],mapData:{},lookupTable:{},isMapReady:!1,isLocationSet:a,geocoder:{},lastCountry:{}}}setMapState(t,e=[],n){const a={};e.forEach(t=>a[t.lockdown.iso]=t),Object.keys(n).forEach(e=>{var r,o,i=n[e],s=a[e];t.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:i.feature_id},{kind:null==s||null===(r=s.lockdown)||void 0===r||null===(o=r.measure[0])||void 0===o?void 0:o.value,name:e})})}async initMap(t,e){window.mapboxgl||(console.log("check the map"),await((t=100)=>new Promise(e=>{setTimeout(()=>{e()},t)}))(),await this.initMap(t,e));let n=new window.mapboxgl.Map({accessToken:He,container:this.ref,style:"mapbox://styles/jfqueralt/ckavedmnk253z1iphmsy39s3r?optimize=true",center:[this.state.lng,this.state.lat],zoom:this.state.zoom,keyboard:!1,pitchWithRotate:!1,hash:!0}),a=new window.MapboxGeocoder({accessToken:He,language:this.props.currentLanguage?this.props.currentLanguage.locale:"es",mapboxgl:window.mapboxgl,types:"country"});a.on("results",this.onGetResult),a.addTo("#mapBlank"),window.map=n;const r=t[this.props.selectedDate];n.on("style.load",()=>{let t=null,e=this.props.currentLanguage.locale;e=e.includes("zh-")?e.includes("-CN")?"zh-Hans":"zh-Hant":e.split("-")[0],n.setLayoutProperty("water-line-label","text-field",["get","name_"+e]),n.setLayoutProperty("country-label","text-field",["get","name_"+e]),n.setLayoutProperty("water-point-label","text-field",["get","name_"+e]),n.on("mousemove","admin-0-fill",(function(e){var a=n.queryRenderedFeatures(e.point,{layers:["admin-0-fill"]});e.features.length>0&&(t&&n.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:t},{hover:!1}),t=a[0].id,n.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:t},{hover:!0}))})),n.on("click","admin-0-fill",this.onMapClick),console.log("the style is loaded")}),n.on("load",(function(){console.log("map is loaded"),o(e)}));const o=t=>{n.addSource("admin-0",{type:"vector",url:"mapbox://mapbox.boundaries-adm0-v3"});const e=Ve(t);n.addLayer({id:"admin-0-fill",type:"fill",source:"admin-0","source-layer":"boundaries_admin_0",filter:["all",["any",["==","all",["get","worldview"]],["in","US",["get","worldview"]]],["!",["has","dispute"]]],paint:{"fill-color":["case",["!=",["feature-state","kind"],null],["match",["feature-state","kind"],"1",We("1"),"2",We("2"),"3",We("3"),"4",We("4"),We("0")],["==",["feature-state","kind"],null],We("0"),["case",["boolean",["feature-state","hover"],!1],"rgba(204,204,204,0.5)","rgba(204,204,204,0)"]],"fill-opacity":["case",["boolean",["feature-state","hover"],!1],.7,1]}},"admin-1-boundary-bg"),n.setPaintProperty("country-label","text-color","hsl(0, 0%, 10%)"),n.setPaintProperty("country-label","text-halo-color","hsla(0, 0%, 100%,0.6)"),n.setPaintProperty("country-label","text-halo-width",1),n.setPaintProperty("state-label","text-color","hsl(0, 0%, 30%)"),n.setPaintProperty("state-label","text-halo-width",0),n.setPaintProperty("admin-0-boundary","line-color","hsla(0, 0%, 90%, 0.8)"),n.setPaintProperty("admin-0-boundary-disputed","line-color","hsla(0, 0%, 90%, 0.5)"),n.setPaintProperty("admin-0-boundary-bg","line-color","hsla(0, 0%, 84%, 0.3)"),n.setPaintProperty("admin-1-boundary","line-color","hsla(0, 0%, 90%, 0.6)"),n.setPaintProperty("settlement-major-label","text-halo-width",0),n.setPaintProperty("settlement-minor-label","text-halo-width",0),n.setPaintProperty("water","fill-color","#e0e0e0");const a=t=>{r.forEach((function(t){n.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:e[t.lockdown.iso].feature_id},{kind:t.lockdown.measure[0].value,name:t.lockdown.iso})})),this.setState({isMapReady:!0})};n.isSourceLoaded("admin-0")?a():n.on("sourcedata",(function t(e){"admin-0"===e.sourceId&&e.isSourceLoaded&&(a(),n.off("sourcedata",t))}))};return this.setState({map:n,geocoder:a}),n}async updateMap(t,e,n){const a=Ve(e);let r=t[n];if(void 0===r){let{startDate:e,endDate:o}=this.props;e=Zt(e||Xt(new Date,-14),"yyyy-MM-dd"),o=Zt(o||Xt(new Date,56),"yyyy-MM-dd");let[i]=await Promise.all([fetch(new URL(`https://lockdownsnapshots-apim.azure-api.net/status/world/${e}/${o}`,Te.url)).then(t=>t.json())]);r=i[n],t=i,this.setState({mapData:t},()=>this.setMapState(this.state.map,r,a))}else this.setMapState(this.state.map,r,a)}updateMapLanguage(t){let e=t.locale;this.state.geocoder.setLanguage(e),e.includes("zh-")&&(e=e.includes("-CN")?"zh-Hans":"zh-Hant"),this.state.map.setLayoutProperty("water-line-label","text-field",["get","name_"+e]),this.state.map.setLayoutProperty("water-point-label","text-field",["get","name_"+e]);this.state.map.setLayoutProperty("country-label","text-field",["get","name_"+e])}async componentDidMount(){Gt.addEventListener("close",t=>{t.detail.countryDialogClosed&&form.focus()});let{startDate:t,endDate:e}=this.props;t=Zt(t||Xt(new Date,-14),"yyyy-MM-dd"),e=Zt(e||Xt(new Date,56),"yyyy-MM-dd");const[n,a]=await Promise.all([fetch(new URL(`https://lockdownsnapshots-apim.azure-api.net/status/world/${t}/${e}`,Te.url)).then(t=>t.json()),fetch(new URL("./../../data/boundaries-adm0-v3.json",Te.url)).then(t=>t.json())]),r=Object.values[a];if(this.setState({countries:r,mapData:n,lookupTable:a}),await this.initMap(n,a),navigator.permissions){const t=await navigator.permissions.query({name:"geolocation"});"granted"!==t.state||this.state.isLocationSet||navigator.geolocation.getCurrentPosition(t=>{const{latitude:e,longitude:n}=t.coords;this.state.map.setCenter([n,e]),this.setState({isLocationSet:!0})}),t.addEventListener("change",t=>{"granted"!==t.target.state||this.state.isLocationSet?localStorage.removeItem("geolocation"):navigator.geolocation.getCurrentPosition(t=>{localStorage.setItem("geolocation","true");const{latitude:e,longitude:n}=t.coords;this.state.map.setCenter([n,e]),this.setState({isLocationSet:!0})})})}}onMapClick(t){let{map:e,lookupTable:n}=this.state;const a=e.queryRenderedFeatures(t.point,{layers:["admin-0-fill"]});console.log("click"),this.state.geocoder.query(n.adm0.data.all[a[0].properties.iso_3166_1].name),this.setState({lastCountry:{country:n.adm0.data.all[a[0].properties.iso_3166_1].name,iso2:a[0].properties.iso_3166_1}})}componentWillUnmount(){this.state.map&&this.state.map.remove()}componentDidUpdate(t,e,n){this.state.isMapReady&&(this.updateMap(this.state.mapData,this.state.lookupTable,this.props.selectedDate),t.currentLanguage!==this.props.currentLanguage&&this.updateMapLanguage(this.props.currentLanguage))}__handleSelect(t){t.preventDefault();const[e,n]=this.selectRef.value.split(",");$t.setSearchParam("country",n),$t.setSearchParam("iso2",e)}__resetFocus(){this.countrySelectRef.focus()}onGetResult(t){console.log(t);let{features:e}=t;if(e[0]){let t=e[0].text;$t.setSearchParam("country",t),$t.setSearchParam("iso2",this.state.lastCountry.iso2)}else $t.setSearchParam("country",this.state.lastCountry.countryName),$t.setSearchParam("iso2",this.state.lastCountry.iso2)}render({currentLanguage:t}){var e;return[u("div",{class:Ae},u("form",{id:"form",tabindex:"-1",onSubmit:this.__handleSelect},u("label",{for:"countries"},"Choose a country:"),u("select",{ref:t=>this.selectRef=t,id:"countries"},null===(e=this.state.countries)||void 0===e?void 0:e.map(t=>u("option",{value:t.ISO+","+t.name},t.name))),u("input",{type:"submit",value:"View country details"}))),u(Se,{i18n:t,map:this.state.map}),u("div",{class:"map-container",ref:t=>this.ref=t}),u("span",{id:"mapBlank",class:Ee})]}}const Ie={url:new URL("./src/services/totalsService.js",document.baseURI).href};const Be=new class extends qt{constructor(){super(),this.cache={},this.corona={},fetch(new URL("../../data/totals.json",Ie.url)).then(t=>t.json()).then(t=>{this.corona=t.corona})}async getTotals(t){var e;let{date:n}=t,a=t.startDate,r=t.endDate;a=Zt(a||Xt(new Date,-14),"yyyy-MM-dd"),r=Zt(r||Xt(new Date,56),"yyyy-MM-dd");const o=`${a}${r}`;if(t.forceRefresh||"failed"===(null===(e=this.cache[o])||void 0===e?void 0:e.status)||!this.cache[o]){try{const t=await(await fetch(`https://lockdownsnapshots-apim.azure-api.net/totals/lockdown/${a}/${r}`)).json();this.cache[o]=t}catch(t){this.cache[o]={status:"failed"}}var i=this.cache[o];if("failed"===i.status)return this.dispatchEvent(new Event("change")),i}return{status:"success",corona:this.corona,territories:this.cache[o][n]}}};let Ne;const Re=I(Ne||(Ne=(t=>t)`
  dl {
    display: flex;
    height: 100%;
    padding: 0;
...
`));class Fe extends g{constructor(){super(),this.state={totals:{}}}async componentDidUpdate(t){if(this.props.selectedDate!==t.selectedDate){const{startDate:t,endDate:e,selectedDate:n}=this.props;this.setState({totals:await Be.getTotals({date:n,startDate:t,endDate:e})})}}async componentDidMount(){A("(min-width: 900px)",t=>{this.setState({desktop:t})});const t=await Be.getTotals({date:this.props.selectedDate,startDate:this.props.startDate,endDate:this.props.endDate});this.setState({totals:t})}render({selectedDate:t,i18n:e},{totals:n,desktop:a}){var r,o;const i=[{description:e.t("header.totals.territoriesLockdown"),value:Number((null===(r=n.territories)||void 0===r?void 0:r.lockdown)||0).toLocaleString()},{description:e.t("header.totals.peopleAffected"),value:Number((null===(o=n.territories)||void 0===o?void 0:o.affected)||0).toLocaleString()}];return u("div",{class:Re},u("dl",null,(a?i:i.slice(0,2)).map(t=>u("div",null,u("dt",{class:"ld-font-light"},t.description),u("dd",{class:"ld-font-front"},t.value)))))}}let Ze;const Ye=I(Ze||(Ze=(t=>t)`
  @keyframes fadeOutUp {
    from {
      opacity: 1;
    }
...
`)),qe=t=>[u("a",{class:"skiplink",href:"#main"},"Go to main content"),u("header",{class:Ye+" "+(t.show?"":"hide")},u("div",{class:"ld-logo-wrapper"},u("a",{href:"","aria-current":"page"},u("p",null,"BETA"),ne)),u("div",{class:"totals"},u(Fe,{selectedDate:t.selectedDate,startDate:t.startDate,endDate:t.endDate,i18n:t.i18n})))];var $e,Ge,Xe,Ke=0,Qe=[],Je=t.__r,tn=t.diffed,en=t.__c,nn=t.unmount;function an(e,n){t.__h&&t.__h(Ge,e,Ke||n),Ke=0;var a=Ge.__H||(Ge.__H={__:[],__h:[]});return e>=a.__.length&&a.__.push({}),a.__[e]}function rn(t){return Ke=1,function(t,e,n){var a=an($e++,2);return a.t=t,a.__c||(a.__c=Ge,a.__=[n?n(e):un(void 0,e),function(t){var e=a.t(a.__[0],t);a.__[0]!==e&&(a.__[0]=e,a.__c.setState({}))}]),a.__}(un,t)}function on(e,n){var a=an($e++,3);!t.__s&&hn(a.__H,n)&&(a.__=e,a.__H=n,Ge.__H.__h.push(a))}function sn(t){return Ke=5,function(t,e){var n=an($e++,7);return hn(n.__H,e)?(n.__H=e,n.__h=t,n.__=t()):n.__}((function(){return{current:t}}),[])}function ln(){Qe.some((function(e){if(e.__P)try{e.__H.__h.forEach(cn),e.__H.__h.forEach(dn),e.__H.__h=[]}catch(n){return e.__H.__h=[],t.__e(n,e.__v),!0}})),Qe=[]}function cn(t){"function"==typeof t.u&&t.u()}function dn(t){t.u=t.__()}function hn(t,e){return!t||e.some((function(e,n){return e!==t[n]}))}function un(t,e){return"function"==typeof e?e(t):e}function pn(t,e){for(var n in t)if("__source"!==n&&!(n in e))return!0;for(var a in e)if("__source"!==a&&t[a]!==e[a])return!0;return!1}t.__r=function(t){Je&&Je(t),$e=0;var e=(Ge=t.__c).__H;e&&(e.__h.forEach(cn),e.__h.forEach(dn),e.__h=[])},t.diffed=function(e){tn&&tn(e);var n=e.__c;n&&n.__H&&n.__H.__h.length&&(1!==Qe.push(n)&&Xe===t.requestAnimationFrame||((Xe=t.requestAnimationFrame)||function(t){var e,n=function(){clearTimeout(a),cancelAnimationFrame(e),setTimeout(t)},a=setTimeout(n,100);"undefined"!=typeof window&&(e=requestAnimationFrame(n))})(ln))},t.__c=function(e,n){n.some((function(e){try{e.__h.forEach(cn),e.__h=e.__h.filter((function(t){return!t.__||dn(t)}))}catch(a){n.some((function(t){t.__h&&(t.__h=[])})),n=[],t.__e(a,e.__v)}})),en&&en(e,n)},t.unmount=function(e){nn&&nn(e);var n=e.__c;if(n&&n.__H)try{n.__H.__.forEach(cn)}catch(e){t.__e(e,n.__v)}};!function(t){var e,n;function a(e){var n;return(n=t.call(this,e)||this).isPureReactComponent=!0,n}n=t,(e=a).prototype=Object.create(n.prototype),e.prototype.constructor=e,e.__proto__=n,a.prototype.shouldComponentUpdate=function(t,e){return pn(this.props,t)||pn(this.state,e)}}(g);var fn=t.__b;t.__b=function(t){t.type&&t.type.t&&t.ref&&(t.props.ref=t.ref,t.ref=null),fn&&fn(t)};var gn=t.__e;function mn(t){return t&&((t=function(t,e){for(var n in e)t[n]=e[n];return t}({},t)).__c=null,t.__k=t.__k&&t.__k.map(mn)),t}function bn(){this.__u=0,this.o=null,this.__b=null}function wn(t){var e=t.__.__c;return e&&e.u&&e.u(t)}function Cn(){this.i=null,this.l=null}t.__e=function(t,e,n){if(t.then)for(var a,r=e;r=r.__;)if((a=r.__c)&&a.__c)return a.__c(t,e.__c);gn(t,e,n)},(bn.prototype=new g).__c=function(t,e){var n=this;null==n.o&&(n.o=[]),n.o.push(e);var a=wn(n.__v),r=!1,o=function(){r||(r=!0,a?a(i):i())};e.__c=e.componentWillUnmount,e.componentWillUnmount=function(){o(),e.__c&&e.__c()};var i=function(){var t;if(!--n.__u)for(n.__v.__k[0]=n.state.u,n.setState({u:n.__b=null});t=n.o.pop();)t.forceUpdate()};n.__u++||n.setState({u:n.__b=n.__v.__k[0]}),t.then(o,o)},bn.prototype.render=function(t,e){return this.__b&&(this.__v.__k[0]=mn(this.__b),this.__b=null),[u(g,null,e.u?null:t.children),e.u&&t.fallback]};var vn=function(t,e,n){if(++n[1]===n[0]&&t.l.delete(e),t.props.revealOrder&&("t"!==t.props.revealOrder[0]||!t.l.size))for(n=t.i;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;t.i=n=n[2]}};(Cn.prototype=new g).u=function(t){var e=this,n=wn(e.__v),a=e.l.get(t);return a[0]++,function(r){var o=function(){e.props.revealOrder?(a.push(r),vn(e,t,a)):r()};n?n(o):o()}},Cn.prototype.render=function(t){this.i=null,this.l=new Map;var e=x(t.children);t.revealOrder&&"b"===t.revealOrder[0]&&e.reverse();for(var n=e.length;n--;)this.l.set(e[n],this.i=[1,0,this.i]);return t.children},Cn.prototype.componentDidUpdate=Cn.prototype.componentDidMount=function(){var t=this;t.l.forEach((function(e,n){vn(t,n,e)}))};!function(){function t(){}var e=t.prototype;e.getChildContext=function(){return this.props.context},e.render=function(t){return t.children}}();var xn=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;g.prototype.isReactComponent={};var yn="undefined"!=typeof Symbol&&Symbol.for&&Symbol.for("react.element")||60103,_n=t.event;function kn(t,e){t["UNSAFE_"+e]&&!t[e]&&Object.defineProperty(t,e,{configurable:!1,get:function(){return this["UNSAFE_"+e]},set:function(t){this["UNSAFE_"+e]=t}})}t.event=function(t){_n&&(t=_n(t)),t.persist=function(){};var e=!1,n=!1,a=t.stopPropagation;t.stopPropagation=function(){a.call(t),e=!0};var r=t.preventDefault;return t.preventDefault=function(){r.call(t),n=!0},t.isPropagationStopped=function(){return e},t.isDefaultPrevented=function(){return n},t.nativeEvent=t};var Mn={configurable:!0,get:function(){return this.class}},Ln=t.vnode;t.vnode=function(t){t.$$typeof=yn;var e=t.type,n=t.props;if(e){if(n.class!=n.className&&(Mn.enumerable="className"in n,null!=n.className&&(n.class=n.className),Object.defineProperty(n,"className",Mn)),"function"!=typeof e){var a,r,o;for(o in n.defaultValue&&void 0!==n.value&&(n.value||0===n.value||(n.value=n.defaultValue),delete n.defaultValue),Array.isArray(n.value)&&n.multiple&&"select"===e&&(x(n.children).forEach((function(t){-1!=n.value.indexOf(t.props.value)&&(t.props.selected=!0)})),delete n.value),n)if(a=xn.test(o))break;if(a)for(o in r=t.props={},n)r[xn.test(o)?o.replace(/[A-Z0-9]/,"-$&").toLowerCase():o]=n[o]}!function(e){var n=t.type,a=t.props;if(a&&"string"==typeof n){var r={};for(var o in a)/^on(Ani|Tra|Tou)/.test(o)&&(a[o.toLowerCase()]=a[o],delete a[o]),r[o.toLowerCase()]=o;if(r.ondoubleclick&&(a.ondblclick=a[r.ondoubleclick],delete a[r.ondoubleclick]),r.onbeforeinput&&(a.onbeforeinput=a[r.onbeforeinput],delete a[r.onbeforeinput]),r.onchange&&("textarea"===n||"input"===n.toLowerCase()&&!/^fil|che|ra/i.test(a.type))){var i=r.oninput||"oninput";a[i]||(a[i]=a[r.onchange],delete a[r.onchange])}}}(),"function"==typeof e&&!e.m&&e.prototype&&(kn(e.prototype,"componentWillMount"),kn(e.prototype,"componentWillReceiveProps"),kn(e.prototype,"componentWillUpdate"),e.m=!0)}Ln&&Ln(t)};let Sn;function Dn(t){const[e,n]=rn(!1),a=sn(null);return on(()=>{e&&a.current.focus({preventScroll:!0})},[e]),on(()=>{t.currentDropdown!==t.toggle&&n(!1)},[t.currentDropdown]),u("div",{class:Pn},u("div",{class:"ld-expandable"},u("button",{onClick:()=>{t.onDropDown(!e&&t.toggle),n(!e)},class:"ld-expandable--toggle","aria-expanded":e},u("div",{class:"ld-expandable--icon"},e?Tn:zn),u("div",{class:"ld-expandable--toggle-content"},u("h2",null,t.toggle))),u("div",{ref:a,class:"ld-expandable--detail "+(e?"ld-expandable--expanded":"ld-expandable--closed"),role:"region",tabindex:"-1"},t.detail)))}const Pn=I(Sn||(Sn=(t=>t)`
  .ld-expandable {
    width: 100%;
    height: auto;
...
`)),zn=u("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-right",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},u("path",{stroke:"none",d:"M0 0h24v24H0z"}),u("polyline",{points:"9 6 15 12 9 18"})),Tn=u("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-down",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},u("path",{stroke:"none",d:"M0 0h24v24H0z"}),u("polyline",{points:"6 9 12 15 18 9"})),Hn={url:new URL("./src/services/updatesService.js",document.baseURI).href};const An=new class extends qt{async getUpdates(t){if(t||!this.updates)try{this.updates=await fetch(new URL("../../data/updates.json",Hn.url)).then(t=>t.json()),await this.updates}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:this.updates}}};let En,Un,jn=t=>t;const Wn=I(En||(En=jn`
  & {
    display: flex;
    align-items: center;
    justify-content: center;
...
`));let On;const In={new_entry:"new entry",announcement:"announcement",rectification:"rectification",promoting_project:"project promotion",promoting_petition:"petition"};function Bn(){var t,e;const[n,a]=rn(void 0);return on(async()=>{const t=await An.getUpdates();a(t)},[]),navigator.onLine||"success"===(null==n?void 0:n.status)?!n&&navigator.onLine?u("div",{class:Wn},re):"failed"===n.status&&navigator.onLine?u("div",{style:"margin-top: 14px;"},"An error occured while fetching updates."):u("div",{class:Nn},u("ul",null,null==n||null===(t=n.data)||void 0===t||null===(e=t.updates)||void 0===e?void 0:e.map(t=>u("li",null,u("div",{class:"ld-ticker--bar"},u("div",{class:"ld-ticker--dot-container"},u("div",{"aria-label":In[t.type.toLowerCase()],class:"ld-ticker--dot "+t.type.toLowerCase()})),u("div",{class:"ld-ticker--line"})),u("div",{class:"ld-ticker--content"},u("div",{class:"ld-ticker--title"},t.title),u("div",{class:"ld-ticker--content"},t.content),t.link?u("div",{class:"ld-ticker--link"},u("a",{target:"_blank",rel:"noopener noreferer",href:t.link},"Source")):"",u("div",{class:"ld-ticker--date"},t.date)))))):u("div",{class:Vn},ae,u("b",null,"You are not connected to the internet"),u("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."))}const Nn=I(On||(On=(t=>t)`
  & ul {
    list-style: none;
    margin: 0;
    padding: 20px 0 0 0;
...
`));function Rn(t){let e;"serviceWorker"in navigator&&navigator.serviceWorker.getRegistration().then(n=>{n&&(n.addEventListener("updatefound",()=>{e=n.installing,e.addEventListener("statechange",()=>{"installed"===e.state&&navigator.serviceWorker.controller&&t(!0)})}),n.waiting&&navigator.serviceWorker.controller&&(t(!0),e=n.waiting))})}function Fn(t){const[e,n]=[...document.querySelectorAll("link[rel='icon']")],a=document.querySelector("link[rel='manifest']"),r=document.querySelector("meta[name='theme-color']");t?(a.href="/manifest-dark.json",e.href="src/assets/favicon-32x32-dark.png",n.href="src/assets/favicon-16x16-dark.png",r.setAttribute("content","#303136")):(a.href="/manifest.json",e.href="src/assets/favicon-32x32.png",n.href="src/assets/favicon-16x16.png",r.setAttribute("content","#ffffff")),document.getElementsByTagName("head")[0].appendChild(a),document.getElementsByTagName("head")[0].appendChild(e),document.getElementsByTagName("head")[0].appendChild(n),document.getElementsByTagName("head")[0].appendChild(r)}let Zn,Yn;window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),Yn=!0,Zn=t});class qn extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}).innerHTML="<slot><button>Install</button></slot>"}connectedCallback(){this.setAttribute("hidden",""),this.addEventListener("click",this._handlePrompt.bind(this)),window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),Zn=t,this.removeAttribute("hidden"),this.dispatchEvent(new CustomEvent("pwa-installable",{detail:!0}))}),Yn&&this.removeAttribute("hidden")}async _handlePrompt(t){t.preventDefault(),Zn.prompt();const{outcome:e}=await Zn.userChoice;"accepted"===e?(this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!0})),this.setAttribute("hidden",""),Zn=null):this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!1}))}}customElements.define("pwa-install-button",qn);class $n extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}).innerHTML="<slot><button>New update available!</button></slot>",this._refreshing=!1}async connectedCallback(){this.addEventListener("click",this._postMessage.bind(this)),navigator.serviceWorker.addEventListener("controllerchange",()=>{this._refreshing||(window.location.reload(),this._refreshing=!0)})}async _postMessage(t){t.preventDefault();(await navigator.serviceWorker.getRegistration()).waiting.postMessage({type:"SKIP_WAITING"})}}customElements.define("pwa-update-available",$n);let Gn;const Xn=I(Gn||(Gn=(t=>t)`
  & {
    padding-top: 20px;
  }
...
`)),ua=(t,e,n,a,r,o)=>{switch(t){case"info":return{title:"info",template:[u("h1",null,"Lockdown"),u("p",{class:"ld-alpha"},o.t("menu.informationSection.banner")),u("p",null,u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.main.text")),u(Dn,{toggle:o.t("menu.informationSection.about.title"),currentDropdown:n,onDropDown:a,detail:u("p",null,o.t("menu.informationSection.about.text.p1"),u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.about.text.p2"),u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.about.text.p3"))}),u(Dn,{toggle:o.t("menu.informationSection.sources.title"),currentDropdown:n,onDropDown:a,detail:u("p",null,u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.sources.subtitle"),u("ul",{class:"ld-sources"},u("li",null,u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://TIOF.Click/LockdownData"}," ",o.t("menu.informationSection.sources.linksList.first.linkTitle")),u("br",null),o.t("menu.informationSection.sources.linksList.first.text")),u("li",null,u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://covid19api.com/"},o.t("menu.informationSection.sources.linksList.second.linkTitle")),u("br",null),o.t("menu.informationSection.sources.linksList.second.text")," ",u("a",{href:"https://systems.jhu.edu/",target:"_blank"},o.t("menu.informationSection.sources.linksList.second.highlight")),u("br",null))),o.t("menu.informationSection.sources.issues.text")," ",u("a",{rel:"noopener noreferrer",target:"_blank",href:"https://github.com/Code-for-All/lockdown/issues"},o.t("menu.informationSection.sources.issues.highlight")),".")}),u(Dn,{toggle:o.t("menu.informationSection.credits.title"),currentDropdown:n,onDropDown:a,detail:u("p",null,u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.credits.text"),u("a",{href:"https://docs.google.com/spreadsheets/d/1mVyQxxLxAF3E1dw870WHXTOLgYzmumojvzIekpgvLV0/edit?ts=5e74ac83#gid=634415797",target:"_blank"},o.t("menu.informationSection.credits.highlight")),".")}),u(Dn,{toggle:o.t("menu.informationSection.dataPrivacity.title"),currentDropdown:n,onDropDown:a,detail:[u("p",null,o.t("menu.informationSection.dataPrivacity.paragraphs.p1")),u("p",null,o.t("menu.informationSection.dataPrivacity.paragraphs.p2"))]})]};case"settings":return{title:"settings",template:[" ",u(Kn,{onClose:e,onLocateChange:r,locale:o})," "]};case"contribute":return{title:"contribute",template:[u("p",null,"Do you have any NPI source you would want to share with us? Please follow this link:"),u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://docs.google.com/forms/d/e/1FAIpQLSfDWe2qlzUnd3e-YYspMzT9adUswDEYIdJMb7jz7ule34-yiA/viewform"},"Submit data"),u("p",null,"Additionally, you can become part of the project by joining one of the following teams:",u("ul",null,u("li",null,"Editors"),u("li",null,"Devs"),u("li",null,"UI/UX"))),u("p",null,"Contact us via Telegram at:",u("br",null),u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://t.me/ProjectLockdown"}," @ProjectLockdown"))]};case"updates":return{title:"updates",template:[" ",u(Bn,null)," "]};default:return{title:"",template:void 0}}};class pa extends g{constructor(t){super(t),this.state={activeItem:"info",showLateralMenu:!1,showMenu:!1,currentDropdown:1},this.showSideBar=this.showSideBar.bind(this),this.closeNavbar=this.closeNavbar.bind(this),this.switchContent=this.switchContent.bind(this),this.onDropDown=this.onDropDown.bind(this)}componentDidMount(){let t=0;A("(min-width: 960px)",e=>{this.setState({isMobile:!e}),e&&t>0&&(t++,this.props.close())})}showSideBar(){this.setState({showLateralMenu:!0,showMenu:!0})}switchContent(t){if("settings"===t&&this.state.updateAvailable&&this.setState({updateAvailable:!1}),this.state.isMobile&&this.props.opened&&t===this.prevVal)return this.props.close(),this.setState({activeItem:this.prevVal}),void(this.prevVal="");this.prevVal=t,this.setState({activeItem:t,showLateralMenu:t!==this.state.activeItem})}closeNavbar(){this.setState({showLateralMenu:!1,showSideBar:!1,activeItem:"info"})}onDropDown(t){this.setState({currentDropdown:t})}render(t,{activeItem:e,updateAvailable:n,currentDropdown:a}){return this.state.showLateralMenu||!0===this.props.isMobile?[u("div",{class:"menu-overlay "+ha}),u("main",{id:"main",class:"ld-menu "+la+" "+(this.state.showLateralMenu?sa:"")},u("div",{class:"ld-menu-nav"},u("button",{class:da,onClick:this.closeNavbar},ee),u("nav",null,u(Jn,{onClose:this.closeNavbar,switchContent:this.switchContent},u("button",{id:"info"},"info"),u("button",{id:"settings"},"settings"),u("button",{id:"updates"},"updates"),u("button",{id:"contribute"},"contribute")))),u("div",{class:"ld-menu--content"},u("div",{class:"mb-only"},u("div",{class:"ld-menu--header"},u("h1",null,e))),ua(e,this.closeNavbar,a,this.onDropDown,t.onLocateChange,t.locale).template))]:u("button",{onClick:this.showSideBar,class:ca},de)}}class fa extends g{async componentWillMount(){const t=await this.props.component(),e=t.default||t;this.setState({Component:e})}render({props:t},{Component:e}){return u(e,t)}}var ga="object"==typeof global&&global&&global.Object===Object&&global,ma="object"==typeof self&&self&&self.Object===Object&&self,ba=ga||ma||Function("return this")(),wa=ba.Symbol,Ca=Object.prototype,va=Ca.hasOwnProperty,xa=Ca.toString,ya=wa?wa.toStringTag:void 0;var _a=Object.prototype.toString;var ka=wa?wa.toStringTag:void 0;function Ma(t){return null==t?void 0===t?"[object Undefined]":"[object Null]":ka&&ka in Object(t)?function(t){var e=va.call(t,ya),n=t[ya];try{t[ya]=void 0;var a=!0}catch(t){}var r=xa.call(t);return a&&(e?t[ya]=n:delete t[ya]),r}(t):function(t){return _a.call(t)}(t)}function La(t){var e=typeof t;return null!=t&&("object"==e||"function"==e)}var Sa=/^\s+|\s+$/g,Da=/^[-+]0x[0-9a-f]+$/i,Pa=/^0b[01]+$/i,za=/^0o[0-7]+$/i,Ta=parseInt;function Ha(t){if("number"==typeof t)return t;if(function(t){return"symbol"==typeof t||function(t){return null!=t&&"object"==typeof t}(t)&&"[object Symbol]"==Ma(t)}(t))return NaN;if(La(t)){var e="function"==typeof t.valueOf?t.valueOf():t;t=La(e)?e+"":e}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(Sa,"");var n=Pa.test(t);return n||za.test(t)?Ta(t.slice(2),n?2:8):Da.test(t)?NaN:+t}var Aa=function(){return ba.Date.now()},Ea=Math.max,Ua=Math.min;let ja,Wa,Va=t=>t;const Oa=I(ja||(ja=Va`
  & {
    @media (max-width: 960px) {
      max-width: 200px;
    }
...
`)),Ba=["S","M","T","W","T","F","S"],Na=["January","February","March","April","May","June","July","August","September","October","November","December"];class Ra extends g{constructor(){super(),this.state={days:[],currentMonth:(new Date).getMonth(),lastSelection:!1,currentYear:2020,allMonthsDate:new Array(12),enableArrows:!1},this.onPressKey=this.onPressKey.bind(this),this.getMonthData=this.getMonthData.bind(this),this.fillAllMonths=this.fillAllMonths.bind(this),this.chooseDay=this.chooseDay.bind(this),this.changeMonth=this.changeMonth.bind(this)}componentDidMount(){window.addEventListener("keydown",this.onPressKey);const{currentMonth:t,allMonthsDate:e}=this.state;let n=new Date(2020,t,1),a=new Date(2020,t+1,0),r=this.getMonthData(n,a),o=e;o[t]=r,this.setState({days:r,allMonthsDate:o},this.fillAllMonths)}componentWillUnmount(){window.removeEventListener("keydown",this.onPressKey)}onPressKey(t){console.log(t),"Escape"===t.code&&this.props.show&&this.props.close()}getMonthData(t,e){let n=e.getDate(),a=7-(t.getDay()+1),r=n+a,o=r/7,i=0;r%7>0&&(i=7-r%7,r+=7-r%7,o=r/7);let s=[],l=0;for(let t=0;t<o;t++){s.push([]);for(let e=0;e<7;e++)0===t&&e<a||t===o-1&&i>0&&e>7-i-1?s[t].push({day:null,label:Ba[e]}):(l++,s[t].push({day:l,label:Ba[e]}))}return s}fillAllMonths(){const t=this.state.currentMonth;let e,n,a=this.state.allMonthsDate;for(let r=0;r<12;r++)if(r!==t){e=new Date(2020,r,1),n=new Date(2020,r+1,0);let t=this.getMonthData(e,n);a[r]=t}this.setState({allMonthsDate:a,enableArrows:!0})}chooseDay(t,e,n){let a=this.state.days;!1!==this.state.lastSelection&&(a[this.state.lastSelection[0]][this.state.lastSelection[1]].selected=!1),t.selected=!0,a[e][n]=t,this.props.onSelect(new Date(this.state.currentYear,this.state.currentMonth,t.day)),this.setState({days:a,lastSelection:[e,n]})}changeMonth(t){const{enableArrows:e,currentMonth:n,allMonthsDate:a}=this.state;if(e){let e,r;(n>0||t)&&(n<11||!t)&&(t?(r=n+1,e=a[r]):(r=n-1,e=a[r]),this.setState({days:e,currentMonth:r}))}}render(t){return[u("div",{class:"overlay "+Ia+" "+(this.props.show?"show":""),onClick:this.props.close}),u("div",{class:"calendar "+Oa+" "+(this.props.show?"show":"")+" "+this.props.customClass},u("div",{class:"calendar actions"},u("span",{onClick:()=>this.changeMonth(!1)},le),u("h3",null,Na[this.state.currentMonth]," ",this.state.currentYear),u("span",{onClick:()=>this.changeMonth(!0)},ce)),u("div",{class:"calendar header"},Ba.map(t=>u("div",{class:"header item"},t))),u("div",{class:"calendar container"},this.state.days.map((t,e)=>u("div",{class:"week"},t.map((t,n)=>u("div",{onClick:()=>this.chooseDay(t,e,n),class:`day ${null===t.day?"empty":""} ${t.selected?"selected":""}`},u("span",null,t.day)))))))]}}const Fa=t=>{if("object"==typeof t){let e={};return Object.keys(t).forEach(n=>{let a=function t(e,n){if("object"!=typeof e||Array.isArray(e)){let t={};return t[n]=e.replace(/{(.*?)}/g,""),t}{let a=[];for(let r in e){let o;if(o=t(e[r],n?`${n}_${r}`:r),Array.isArray(o)){let t={};for(let e of o)t={...t,...e};o=t}a.push(o)}return a}}(t[n],n);if(Array.isArray(a)){let t={};for(let e of a)t={...t,...e};a=t}e={...e,...a}}),e}return t};let Za,Ya,qa,$a,Ga,Xa,Ka=t=>t;const Qa=[7.5,16,24.5,33,41.5,50,58.5,67,75.5,84,94];let Ja=!1;function tr(t,e){let n=e;return void 0!==e?(n=e.replace("-",""),"zhHK"===n&&(n="zhTW"),void 0!==Ja[n]&&null!==Ja[n]||(n=e.split("-")[0],void 0!==Ja[n]&&null!==Ja[n]||(n="enUS"))):n="enUS",Zt(t,"dd MMM",{locale:Ja?Ja[n]:et})}function er(t,e){let n=e;return e?(n=e.replace("-",""),void 0!==Ja[n]&&null!==Ja[n]||(n=e.split("-")[0],void 0!==Ja[n]&&null!==Ja[n]||(n="enUS"))):n="enUS",Zt(t,"dd MMMM yyyy",{locale:Ja?Ja[n]:et})}const nr=I(Za||(Za=Ka`
  & {
    position: absolute;
    bottom: 30px;
    left: 0;
...
`));class lr extends g{constructor(){super(),this.state={currentDateValue:35,currentPosition:24.5,datePickerPosition:"left",showDatePicker:!1,currentSelectedDay:"",firstDay:"",lastDay:"",currentSliderRange:[]},this.dateRef={},this.range={},this.container={},this.onSliderChange=this.onSliderChange.bind(this),this.onBtnClick=this.onBtnClick.bind(this),this.onChooseDate=this.onChooseDate.bind(this),this.calendarWillClose=this.calendarWillClose.bind(this),this.closeDatePicker=this.closeDatePicker.bind(this),this.submitChanges=this.submitChanges.bind(this),this.onPressKey=this.onPressKey.bind(this),this.updateDates=this.updateDates.bind(this)}async componentWillMount(){Ja=await(async t=>({...await import("./c4571ca8.js")}))()}componentDidMount(){window.addEventListener("keydown",this.onPressKey);let t=[],e=Xt(new Date,-35);for(let n=1;n<=70;n++)t.push(e),e=Xt(e,1);const n=this.dateRef.current,a=this.range.current;let r=(this.container.current.offsetWidth-a.offsetWidth)/2-n.offsetWidth/4,o=a.offsetWidth/70;n.style.left=r+32*o+"px",this.setState({currentSliderRange:t,currentSelectedDay:er(new Date,this.props.i18n.locale),firstDay:tr(t[0],this.props.i18n.locale),lastDay:tr(t[t.length-1],this.props.i18n.locale)})}componentWillUnmount(){window.removeEventListener("keydown",this.onPressKey)}componentDidUpdate(t,e,n){t.i18n!==this.props.i18n&&this.updateDates(e)}onPressKey(t){this.range.current;switch(t.code){case"ArrowLeft":t.preventDefault(),this.range.current.value>0&&(this.range.current.value=this.range.current.value-1,this.onSliderChange({target:{value:this.range.current.value}}));break;case"ArrowRight":t.preventDefault(),this.range.current.value<69&&(this.range.current.value=Number(this.range.current.value)+1,this.onSliderChange({target:{value:this.range.current.value}}))}}onSliderChange(t){const{currentDateValue:e,currentSliderRange:n}=this.state,a=this.dateRef.current,r=this.range.current,o=this.container.current;let i=t.target.value,s=(o.offsetWidth-r.offsetWidth)/2-a.offsetWidth/4,l=r.offsetWidth/70,c=Qa[i];a.style.left=s+l*i+"px",this.setState({currentDateValue:i,currentPosition:c,currentSelectedDay:er(n[i],this.props.i18n.locale)},this.submitChanges)}onBtnClick(t){this.setState({showDatePicker:!0,datePickerPosition:t})}onChooseDate(t){const e=this.dateRef.current,n=this.range.current;let a=(this.container.current.offsetWidth-n.offsetWidth)/2-e.offsetWidth/4,r=n.offsetWidth/70;e.style.left=a+r*(.5+("left"===this.state.datePickerPosition?0:69))+"px",this.calendarWillClose();let o=[];if("left"===this.state.datePickerPosition){let e=1;for(let n=1;n<=70;n++)1===n?o.push(t):(o.push(this.rangePreProcces(t,e)),e++)}else{let e=69;for(let n=1;n<=70;n++)70===n?o.push(t):(o.push(this.rangePreProcces(t,-1*e)),e--)}this.setState({currentSliderRange:o,currentSelectedDay:er(t,this.props.i18n.locale),firstDay:tr(o[0],this.props.i18n.locale),lastDay:tr(o[o.length-1],this.props.i18n.locale),currentDateValue:"left"===this.state.datePickerPosition?0:69,currentPosition:24.5},this.submitChanges)}updateDates(t){const{currentDateValue:e,currentSliderRange:n}=t;this.setState({currentSelectedDay:er(n[e],this.props.i18n.locale),firstDay:tr(n[0],this.props.i18n.locale),lastDay:tr(n[n.length-1],this.props.i18n.locale)})}calendarWillClose(){this.setState({datePickerPosition:this.state.datePickerPosition+" hide"},()=>setTimeout(()=>this.closeDatePicker(),400))}closeDatePicker(){this.setState({showDatePicker:!1,datePickerPosition:this.state.datePickerPosition.replace(" hide","")})}rangePreProcces(t,e){let n=new Date(t);return n.setDate(t.getDate()+e),n}submitChanges(){const{currentSliderRange:t,currentDateValue:e}=this.state;this.props.onChange(t[e],t[0],t[t.length-1])}render(t){return u("div",{class:"sliderWrapper "+nr+" "+(""!==this.props.children?"open":""),ref:this.container},this.props.children,u("div",{class:ar+" "+rr+" "+(""!==this.props.children?"open":"")},u(Ra,{close:this.calendarWillClose,onSelect:this.onChooseDate,show:this.state.showDatePicker,customClass:this.state.datePickerPosition}),u("div",{class:ir,ref:this.dateRef},u("span",null,this.state.currentSelectedDay)),u("span",{title:"Select Start Date",class:"first "+or,onClick:t=>this.onBtnClick("left")},u(cr,null)," ",this.state.firstDay),u("button",{onClick:t=>this.onBtnClick("left"),class:"first "+sr}),u("input",{ref:this.range,onInput:this.onSliderChange,type:"range",min:"0",max:"69",step:"1",value:this.state.currentDateValue}),u("span",{class:"last "+sr}),u("span",{title:"Select End Date",class:"last "+or},this.state.lastDay)))}}class cr extends g{render(t){return u("span",null,ue)}}let dr;const hr=I(dr||(dr=(t=>t)`
  & {
    position: absolute;
    bottom: 150px;
    left: 10px;
...
`));class ur extends g{constructor(){super(),this.state={showDialog:!1,y:"bottom",x:"left"},this.btn={},this.onClick=this.onClick.bind(this),this.initBtn=this.initBtn.bind(this),this.onTouch=this.onTouch.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this),this.onDrop=this.onDrop.bind(this)}initBtn(t){this.btn=t,t.addEventListener("touchmove",this.onTouch),t.addEventListener("touchend",this.onTouchEnd),t.addEventListener("dragend",this.onDrop)}onTouch(t){let e=t.targetTouches[0];this.btn.style.left=e.pageX+"px",this.btn.style.top=e.pageY+"px"}onTouchEnd(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=Number(this.btn.style.top.replace("px","")),i=Number(this.btn.style.left.replace("px",""));o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=160&&(this.btn.style.top="160px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onDrop(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=t.clientY,i=t.clientX;0===o&&0===i&&(i=t.screenX,o=t.screenY),this.btn.style.top=o+"px",o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=60&&(this.btn.style.top="70px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onClick(){this.setState({showDialog:!this.state.showDialog})}render({i18n:t}){return u("div",{onClick:this.onClick,draggable:"true",ref:this.initBtn,class:hr},he,u("div",{class:"dialog "+(this.state.showDialog?"show":"")+" "+this.state.y+" "+this.state.x},u("div",null,u("span",null,u("div",{class:"color green"})),u("span",null,t.t("mapLegend.no"))),u("div",null,u("span",null,u("div",{class:"color orange"})),u("span",null,t.t("mapLegend.partial"))),u("div",null,u("span",null,u("div",{class:"color red"})),u("span",null,t.t("mapLegend.full"))),u("div",null,u("span",null,u("div",{class:"color gray"})),u("span",null,t.t("mapLegend.noData"))),u("div",null,u("span",null,u("div",{class:"color covidstripes"})),u("span",null,t.t("mapLegend.cases")))))}}let pr,fr,gr=t=>t;const mr=I(pr||(pr=gr`
  & {
    position: absolute;
    top: 25vh;
    right: 5vw;
...
`));class wr extends g{constructor(){super(),this.state={showLangOpt:!1},this.toggleLangOpts=this.toggleLangOpts.bind(this),this.changeCurrentLanguage=this.changeCurrentLanguage.bind(this)}toggleLangOpts(){this.setState({showLangOpt:!this.state.showLangOpt})}changeCurrentLanguage(t){this.toggleLangOpts(),this.props.onLocateChange(t)}render({i18n:t,languages:e},{showLangOpt:n}){var a;return[u("div",{class:mr,onClick:this.toggleLangOpts},null===(a=t.locale)||void 0===a?void 0:a.toUpperCase(),u("div",{class:"circleBtn"},pe)),u("div",{class:`${br} ${n?"show":""}`},e.map(e=>u("div",{class:"langOpt "+(e===t.locale?"active":""),onClick:()=>this.changeCurrentLanguage(e)},null==e?void 0:e.toUpperCase().replace("-","\n"))))]}}var Cr=["ar","en","en-US","es","es-ES","es-MX","it","pt","pt-BR","ru","zh-CN","zh-HK"];let vr;const xr=function(t,e,n){var a,r,o,i,s,l,c=0,d=!1,h=!1,u=!0;if("function"!=typeof t)throw new TypeError("Expected a function");function p(e){var n=a,o=r;return a=r=void 0,c=e,i=t.apply(o,n)}function f(t){return c=t,s=setTimeout(m,e),d?p(t):i}function g(t){var n=t-l;return void 0===l||n>=e||n<0||h&&t-c>=o}function m(){var t=Aa();if(g(t))return b(t);s=setTimeout(m,function(t){var n=e-(t-l);return h?Ua(n,o-(t-c)):n}(t))}function b(t){return s=void 0,u&&a?p(t):(a=r=void 0,i)}function w(){var t=Aa(),n=g(t);if(a=arguments,r=this,l=t,n){if(void 0===s)return f(l);if(h)return clearTimeout(s),s=setTimeout(m,e),p(l)}return void 0===s&&(s=setTimeout(m,e)),i}return e=Ha(e)||0,La(n)&&(d=!!n.leading,o=(h="maxWait"in n)?Ea(Ha(n.maxWait)||0,e):o,u="trailing"in n?!!n.trailing:u),w.cancel=function(){void 0!==s&&clearTimeout(s),c=0,a=l=r=s=void 0},w.flush=function(){return void 0===s?i:b(Aa())},w}(()=>{let t={menuDialogClosed:!1,countryDialogClosed:!1};const e=new URLSearchParams(location.search);e.has("country")||e.has("iso2")?t.countryDialogClosed=!0:t.menuDialogClosed=!0,Gt.close(t)},10,{leading:!0,trailing:!1}),yr=I(vr||(vr=(t=>t)`
  & {
    position: fixed;
    z-index: 1100;
    top: 74px;
...
`));function _r(t){return Zt(t,"yyyy-MM-dd")}("requestIdleCallback"in window?window.requestIdleCallback:t=>setTimeout(t,1e3))(()=>{import("./2c9ec13b.js"),import("./02b6fc16.js")}),console.log("🌐 Project Lockdown, version: 0.0.0"),window.addEventListener("appinstalled",()=>{window.location.reload()}),A("(prefers-color-scheme: dark)",t=>{const e=localStorage.getItem("darkmode");null!==e?"true"===e&&(document.documentElement.classList.add("dark"),Fn(!0)):t?(document.documentElement.classList.add("dark"),Fn(!0)):(document.documentElement.classList.remove("dark"),Fn(!1))}),function(e,n,a){var r,o,c;t.__&&t.__(e,n),o=(r=a===i)?null:a&&a.__k||n.__k,e=u(f,null,[e]),c=[],M(n,(r?n:a||n).__k=e,o||s,s,void 0!==n.ownerSVGElement,a&&!r?[a]:o?null:n.childNodes.length?l.slice.call(n.childNodes):null,c,a||s,r),L(c,e)}([" ",u(class extends g{constructor(){super(),this.state={dialog:{opened:!1,template:{},title:""},haveSelectedDate:!1,startDate:!1,endDate:!1,currentLanguage:{t:t=>t},languages:[],baseLanguages:[]},this.__onPathChanged=this.__onPathChanged.bind(this),this.__closeCountryInfo=this.__closeCountryInfo.bind(this),this.__closeDialog=this.__closeDialog.bind(this),this.__showDialog=this.__showDialog.bind(this),this.__showDialogRoute=this.__showDialogRoute.bind(this),this.__onSelectDate=this.__onSelectDate.bind(this),this.__initi18n=this.__initi18n.bind(this),this.__getTranslation=this.__getTranslation.bind(this),this.__onLocateChange=this.__onLocateChange.bind(this)}async componentDidMount(){this.__onPathChanged(),A("(min-width: 960px)",t=>{this.setState({isMobile:!getMatchedCSSRules})})}componentWillMount(){$t.addEventListener("path-changed",this.__onPathChanged),window.i18n?this.__initi18n():setTimeout(this.__initi18n,300),this.setState({showStatsbox:1==Number($t.url.searchParams.get("statsbox")||1),showMenu:1==Number($t.url.searchParams.get("menu")||1),showSlider:1==Number($t.url.searchParams.get("slider")||1)})}componentWillUnmount(){$t.removeEventListener("path-changed",this.__onPathChanged)}render(){const t=this.state.haveSelectedDate?_r(this.state.haveSelectedDate):_r(new Date);return[this.state.showStatsbox?[u(qe,{selectedDate:t,showStatsbox:this.state.showStatsbox,startDate:this.state.startDate,endDate:this.state.endDate,show:!this.state.dialog.opened,i18n:this.state.currentLanguage}),this.state.dialog.opened?"":u("div",{class:yr},u(Fe,{selectedDate:t,startDate:this.state.startDate,endDate:this.state.endDate,i18n:this.state.currentLanguage,onLocateChange:this.__onLocateChange}))]:"",this.state.showMenu?u(pa,{opened:this.state.dialog.opened,isMobile:this.state.isMobile,changeRoute:this.__showDialogRoute,close:this.__closeDialog,locale:this.state.currentLanguage,onLocateChange:this.__onLocateChange}):"",u(Oe,{selectedDate:t,startDate:this.state.startDate,endDate:this.state.endDate,currentLanguage:this.state.currentLanguage}),u(ur,{i18n:this.state.currentLanguage}),u(wr,{i18n:this.state.currentLanguage,languages:this.state.baseLanguages,onLocateChange:this.__onLocateChange}),this.state.showSlider?u(lr,{onChange:this.__onSelectDate,i18n:this.state.currentLanguage},this.state.dialog.opened?u(fa,{component:()=>import("./02b6fc16.js"),props:{country:this.state.dialog.title,iso2:this.state.dialog.iso2,date:this.state.haveSelectedDate||new Date,i18n:this.state.currentLanguage,startDate:this.state.startDate,endDate:this.state.endDate,onClose:this.__closeDialog}}):""):""]}async __initi18n(){let t=navigator.language||navigator.userLanguage,e=window.i18n,n=await(async()=>{let t={},e=0;for(let n=0;n<Cr.length;n++)try{let e=await import("./translations/"+Cr[n]+"/index.js");if(e=e.default,e.languageId===Cr[n]?t[Cr[n]]=Fa(e):console.warn(`The iso value of ${Cr[n]} not match`),n===Cr.length-1)return t}catch(a){if(console.log(a),e++,n===Cr.length-1)return t;continue}if(e===Cr-1)return console.log(t),t})(),a=Object.keys(n),r={},o=[];a.forEach(t=>{t.includes("-")?t.includes("zh-")&&o.push(t):o.push(t),r[t]={t:this.__getTranslation,i18n:e.create({values:n[t]}),locale:t}});let i=function(t,e){e.indexOf(t);{let n=t.split("-")[0];if(e.indexOf(n)>=0)return n;{if(t.includes("-TW")||t.includes("-tw"))return"zh-HK";let a=e.filter(t=>t.split("-")[0].contains(n));return a.length>0?a[0]:"en"}}}(t,a);this.setState({i18nLanguages:r,currentLanguage:r[i],languages:a,baseLanguages:o})}__getTranslation(t){let e=t.split(".").join("_");return this.state.currentLanguage.i18n(e)}__showDialogRoute({template:t,title:e}){const n=$t.url.searchParams.get("country");n?$t.setPath(`${e}?country=${n}`):$t.setPath(e),this.state.isMobile&&($t.setSearchParam("country",null),this.__showDialog({template:t,title:e}))}__onPathChanged(){const t=$t.url.searchParams.get("country"),e=$t.url.searchParams.get("iso2"),n=this.state.haveSelectedDate||new Date;t&&e&&this.setState({dialog:{opened:!0,template:[" ",u(fa,{component:()=>import("./02b6fc16.js"),props:{country:t,iso2:e,date:n}})," "],title:t,iso2:e,date:n}},()=>console.log(this.state))}__showDialog({template:t,title:e}){this.setState({dialog:{opened:!0,template:t,title:e}})}__closeCountryInfo(){$t.setSearchParam("country",void 0),$t.setSearchParam("iso2",void 0)}__closeDialog(){this.setState({dialog:{opened:!1,template:"",title:""}}),xr(),this.__closeCountryInfo()}__onSelectDate(t,e,n){this.setState({haveSelectedDate:t,startDate:e,endDate:n})}__onLocateChange(t){this.state.i18nLanguages[t]&&this.setState({currentLanguage:this.state.i18nLanguages[t]})}},null)," "],document.getElementById("app"));export{Y as A,X as B,Q as C,J as D,qt as E,bt as F,Z as G,G as H,K as I,tt as J,et as K,Xt as a,Vn as b,I as c,ee as d,oe as e,Zt as f,se as g,u as h,ie as i,ge as j,me as k,Wn as l,g as m,Ce as n,ae as o,be as p,ye as q,B as r,xe as s,N as t,_e as u,ve as v,we as w,ke as x,re as y,$t as z};
