...
`));class ur extends g{constructor(){super(),this.state={showDialog:!1,y:"bottom",x:"left"},this.btn={},this.onClick=this.onClick.bind(this),this.initBtn=this.initBtn.bind(this),this.onTouch=this.onTouch.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this)}initBtn(t){this.btn=t,t.addEventListener("touchmove",this.onTouch),t.addEventListener("touchend",this.onTouchEnd)}onTouch(t){let e=t.targetTouches[0];this.btn.style.left=e.pageX+"px",this.btn.style.top=e.pageY+"px"}onTouchEnd(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=Number(this.btn.style.top.replace("px","")),i=Number(this.btn.style.left.replace("px",""));o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=160&&(this.btn.style.top="160px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onClick(){this.setState({showDialog:!this.state.showDialog})}render({i18n:t}){return u("div",{onClick:this.onClick,draggable:"true",ref:this.initBtn,class:hr},he,u("div",{class:"dialog "+(this.state.showDialog?"show":"")+" "+this.state.y+" "+this.state.x},u("div",null,u("span",null,u("div",{class:"color green"})),u("span",null,t.t("mapLegend.no"))),u("div",null,u("span",null,u("div",{class:"color orange"})),u("span",null,t.t("mapLegend.partial"))),u("div",null,u("span",null,u("div",{class:"color red"})),u("span",null,t.t("mapLegend.full"))),u("div",null,u("span",null,u("div",{class:"color gray"})),u("span",null,t.t("mapLegend.noData")))))}}let pr,fr,gr=t=>t;const mr=I(pr||(pr=gr`
  & {
    position: absolute;
    top: 25vh;
    right: 2.5vw;
