...
`)),Cn=u("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-right",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},u("path",{stroke:"none",d:"M0 0h24v24H0z"}),u("polyline",{points:"9 6 15 12 9 18"})),xn=u("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-down",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},u("path",{stroke:"none",d:"M0 0h24v24H0z"}),u("polyline",{points:"6 9 12 15 18 9"})),yn={url:new URL("./src/services/updatesService.js",document.baseURI).href};const _n=new class extends It{async getUpdates(t){if(t||!this.updates)try{this.updates=await fetch(new URL("../../data/updates.json",yn.url)).then(t=>t.json()),await this.updates}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:this.updates}}};let kn,Mn,Dn=t=>t;const Ln=O(kn||(kn=Dn`
  & {
    display: flex;
    align-items: center;
...
`));let Pn;const Tn={new_entry:"new entry",announcement:"announcement",rectification:"rectification",promoting_project:"project promotion",promoting_petition:"petition"};function zn(){var t,e;const[n,a]=$e(void 0);return Ge(async()=>{const t=await _n.getUpdates();a(t)},[]),navigator.onLine||"success"===(null==n?void 0:n.status)?!n&&navigator.onLine?u("div",{class:Ln},ue):"failed"===n.status&&navigator.onLine?u("div",{style:"margin-top: 14px;"},"An error occured while fetching updates."):u("div",{class:Hn},u("ul",null,null==n||null===(t=n.data)||void 0===t||null===(e=t.updates)||void 0===e?void 0:e.map(t=>u("li",null,u("div",{class:"ld-ticker--bar"},u("div",{class:"ld-ticker--dot-container"},u("div",{"aria-label":Tn[t.type.toLowerCase()],class:"ld-ticker--dot "+t.type.toLowerCase()})),u("div",{class:"ld-ticker--line"})),u("div",{class:"ld-ticker--content"},u("div",{class:"ld-ticker--title"},t.title),u("div",{class:"ld-ticker--content"},t.content),t.link?u("div",{class:"ld-ticker--link"},u("a",{target:"_blank",rel:"noopener noreferer",href:t.link},"Source")):"",u("div",{class:"ld-ticker--date"},t.date)))))):u("div",{class:Sn},he,u("b",null,"You are not connected to the internet"),u("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."))}const Hn=O(Pn||(Pn=(t=>t)`
  & ul {
    list-style: none;
    margin: 0;
    padding: 20px 0 0 0;
...
`));class tr extends g{constructor(){super(),this.state={showDialog:!1,y:"bottom",x:"left"},this.btn={},this.onClick=this.onClick.bind(this),this.initBtn=this.initBtn.bind(this),this.onTouch=this.onTouch.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this),this.onDrop=this.onDrop.bind(this)}initBtn(t){this.btn=t,t.addEventListener("touchmove",this.onTouch),t.addEventListener("touchend",this.onTouchEnd),t.addEventListener("dragend",this.onDrop)}onTouch(t){let e=t.targetTouches[0];this.btn.style.left=e.pageX+"px",this.btn.style.top=e.pageY+"px"}onTouchEnd(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=Number(this.btn.style.top.replace("px","")),i=Number(this.btn.style.left.replace("px",""));o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=160&&(this.btn.style.top="160px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onDrop(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=t.clientY,i=t.clientX;0===o&&0===i&&(i=t.screenX,o=t.screenY),this.btn.style.top=o+"px",o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=60&&(this.btn.style.top="70px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onClick(){this.setState({showDialog:!this.state.showDialog})}render(t){return u("div",{onClick:this.onClick,draggable:"true",ref:this.initBtn,class:Ja},ve,u("div",{class:"dialog "+(this.state.showDialog?"show":"")+" "+this.state.y+" "+this.state.x},u("div",null,u("span",null,u("div",{class:"color red"})),u("span",null,_e),u("span",null,xe)),u("div",null,u("span",null,u("div",{class:"color orange"})),u("span",null,ye),u("span",null,xe)),u("div",null,u("span",null,u("div",{class:"color green"})),u("span",null,_e),u("span",null,Ce)),u("div",null,u("span",null,u("div",{class:"color blue"})),u("span",null,ye),u("span",null,Ce)),u("div",null,u("span",null,u("div",{class:"color gray"})),u("span",null,"NO DATA"))))}}let er;const nr=function(t,e,n){var a,r,o,i,s,l,c=0,d=!1,h=!1,u=!0;if("function"!=typeof t)throw new TypeError("Expected a function");function p(e){var n=a,o=r;return a=r=void 0,c=e,i=t.apply(o,n)}function f(t){return c=t,s=setTimeout(m,e),d?p(t):i}function g(t){var n=t-l;return void 0===l||n>=e||n<0||h&&t-c>=o}function m(){var t=_a();if(g(t))return b(t);s=setTimeout(m,function(t){var n=e-(t-l);return h?Ma(n,o-(t-c)):n}(t))}function b(t){return s=void 0,u&&a?p(t):(a=r=void 0,i)}function w(){var t=_a(),n=g(t);if(a=arguments,r=this,l=t,n){if(void 0===s)return f(l);if(h)return clearTimeout(s),s=setTimeout(m,e),p(l)}return void 0===s&&(s=setTimeout(m,e)),i}return e=ya(e)||0,ma(n)&&(d=!!n.leading,o=(h="maxWait"in n)?ka(ya(n.maxWait)||0,e):o,u="trailing"in n?!!n.trailing:u),w.cancel=function(){void 0!==s&&clearTimeout(s),c=0,a=l=r=s=void 0},w.flush=function(){return void 0===s?i:b(_a())},w}(()=>{let t={menuDialogClosed:!1,countryDialogClosed:!1};const e=new URLSearchParams(location.search);e.has("country")||e.has("iso2")?t.countryDialogClosed=!0:t.menuDialogClosed=!0,Yt.close(t)},10,{leading:!0,trailing:!1}),ar=O(er||(er=(t=>t)`
  & {
    position: fixed;
    z-index: 1100;
    top: 74px;
...
`));function rr(t){return Bt(t,"yyyy-MM-dd")}("requestIdleCallback"in window?window.requestIdleCallback:t=>setTimeout(t,1e3))(()=>{import("./618227d3.js"),import("./fce32b20.js")}),console.log("🌐 Project Lockdown, version: 0.0.0"),window.addEventListener("appinstalled",()=>{window.location.reload()}),A("(prefers-color-scheme: dark)",t=>{const e=localStorage.getItem("darkmode");null!==e?"true"===e&&(document.documentElement.classList.add("dark"),En(!0)):t?(document.documentElement.classList.add("dark"),En(!0)):(document.documentElement.classList.remove("dark"),En(!1))}),function(e,n,a){var r,o,c;t.__&&t.__(e,n),o=(r=a===i)?null:a&&a.__k||n.__k,e=u(f,null,[e]),c=[],M(n,(r?n:a||n).__k=e,o||s,s,void 0!==n.ownerSVGElement,a&&!r?[a]:o?null:n.childNodes.length?l.slice.call(n.childNodes):null,c,a||s,r),D(c,e)}([" ",u(class extends g{constructor(){super(),this.state={dialog:{opened:!1,template:{},title:""},haveSelectedDate:!1,startDate:!1,endDate:!1},this.__onPathChanged=this.__onPathChanged.bind(this),this.__closeCountryInfo=this.__closeCountryInfo.bind(this),this.__closeDialog=this.__closeDialog.bind(this),this.__showDialog=this.__showDialog.bind(this),this.__showDialogRoute=this.__showDialogRoute.bind(this),this.__onSelectDate=this.__onSelectDate.bind(this)}async componentDidMount(){this.__onPathChanged(),A("(min-width: 960px)",t=>{this.setState({isMobile:!getMatchedCSSRules})})}componentWillMount(){Ft.addEventListener("path-changed",this.__onPathChanged),this.setState({showStatsbox:1==Number(Ft.url.searchParams.get("statsbox")||1),showMenu:1==Number(Ft.url.searchParams.get("menu")||1),showSlider:1==Number(Ft.url.searchParams.get("slider")||1)})}componentWillUnmount(){Ft.removeEventListener("path-changed",this.__onPathChanged)}render(){const t=this.state.haveSelectedDate?rr(this.state.haveSelectedDate):rr(new Date);return[this.state.showStatsbox?[u(We,{selectedDate:t,showStatsbox:this.state.showStatsbox,startDate:this.state.startDate,endDate:this.state.endDate,show:!this.state.dialog.opened}),this.state.dialog.opened?"":u("div",{class:ar},u(re,{selectedDate:t,startDate:this.state.startDate,endDate:this.state.endDate}))]:"",this.state.showMenu?u(aa,{opened:this.state.dialog.opened,isMobile:this.state.isMobile,changeRoute:this.__showDialogRoute,close:this.__closeDialog}):"",u(Jt,{selectedDate:t,startDate:this.state.startDate,endDate:this.state.endDate}),u(tr,null),this.state.showSlider?u(Xa,{onChange:this.__onSelectDate},this.state.dialog.opened?u(ra,{component:()=>import("./fce32b20.js"),props:{country:this.state.dialog.title,iso2:this.state.dialog.iso2,date:this.state.haveSelectedDate||new Date,startDate:this.state.startDate,endDate:this.state.endDate,onClose:this.__closeDialog}}):""):""]}__showDialogRoute({template:t,title:e}){const n=Ft.url.searchParams.get("country");n?Ft.setPath(`${e}?country=${n}`):Ft.setPath(e),this.state.isMobile&&(Ft.setSearchParam("country",null),this.__showDialog({template:t,title:e}))}__onPathChanged(){const t=Ft.url.searchParams.get("country"),e=Ft.url.searchParams.get("iso2"),n=this.state.haveSelectedDate||new Date;t&&e&&this.setState({dialog:{opened:!0,template:[" ",u(ra,{component:()=>import("./fce32b20.js"),props:{country:t,iso2:e,date:n}})," "],title:t,iso2:e,date:n}},()=>console.log(this.state))}__showDialog({template:t,title:e}){this.setState({dialog:{opened:!0,template:t,title:e}})}__closeCountryInfo(){Ft.setSearchParam("country",void 0),Ft.setSearchParam("iso2",void 0)}__closeDialog(){this.setState({dialog:{opened:!1,template:"",title:""}}),nr(),this.__closeCountryInfo()}__onSelectDate(t,e,n){this.setState({haveSelectedDate:t,startDate:e,endDate:n})}},null)," "],document.getElementById("app"));export{It as E,qt as a,Sn as b,O as c,ce as d,pe as e,Bt as f,ge as g,u as h,fe as i,Me as j,De as k,Ln as l,g as m,Pe as n,he as o,Le as p,He as q,B as r,ze as s,R as t,Ae as u,Te as v,Se as w,Ee as x,ue as y,Ft as z};
