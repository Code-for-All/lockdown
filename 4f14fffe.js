...
`));class P extends HTMLElement{constructor(){super(),this._show=this._show.bind(this),this._hide=this._hide.bind(this)}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","tooltip"),this.hasAttribute("tabindex")||this.setAttribute("tabindex",-1),this._hide(),this._target=document.querySelector("[aria-describedby="+this.id+"]"),this._target&&(this._target.addEventListener("focus",this._show),this._target.addEventListener("blur",this._hide),this._target.addEventListener("mouseenter",this._show),this._target.addEventListener("mouseleave",this._hide))}disconnectedCallback(){this._target&&(this._target.removeEventListener("focus",this._show),this._target.removeEventListener("blur",this._hide),this._target.removeEventListener("mouseenter",this._show),this._target.removeEventListener("mouseleave",this._hide),this._target=null)}_show(){this.hidden=!1}_hide(){this.hidden=!0}}window.customElements.define("tool-tip",P);const F={1:"YES",2:"PARTIALLY",3:"NO",4:"UNCLEAR",5:"NA"},O={1:"YES",2:"PARTIAL",3:"NO",4:"UNCLEAR"},Y=["Land","Flight","Sea"],W={commerce:{text:"Commerce"},foreigners_inbound:{text:"Foreigners (in)"},foreigners_outbound:{text:"Foreigners (out)"},local:{text:"In between cities"},nationals_inbound:{text:"Nationals (in)"},nationals_outbound:{text:"Nationals (out)"},stopovers:{text:"Stopovers"},cross_border_workers:{text:"Cross border workers"}},H=[{id:"lockdown_status",label:"Stay Home",icon:u},{id:"going_to_shops",label:"Shopping",icon:h},{id:"city_movement_restriction",label:"Outdoors",icon:p},{id:"military_not_deployed",label:"Military",icon:v},{id:"attending_religious_sites",label:"Religious Sites",icon:g},{id:"electricity_nominal",label:"Electricity",icon:b},{id:"going_to_work",label:"Go to Work",icon:m},{id:"water_nominal",label:"Water",icon:y},{id:"academia_allowed",label:"Go to Schools",icon:f},{id:"internet_nominal",label:"Telecom",icon:x}],Z=[{id:1,name:"Daily Life"},{id:2,name:"Mobility"},{id:3,name:"Reports"}];class q extends o{render(t){var e,a;let{coronaData:i,populationData:r,countryDetails:o,country:n,date:d}=this.props;return[l("h2",{class:"ld-font-subheader"},l("span",null,n)," ",l("span",null,s(d,"dd/MM/yyyy"))),l("dl",{class:"data"},l("div",{class:"data-entry is-half"},l("dt",null,"Population"),l("dd",{class:"data-value"},null!==(e=Number(null==r?void 0:r.Population).toLocaleString())&&void 0!==e?e:"Error")),l("div",{class:"data-entry is-half"},l("dt",null,"Max assembly"),l("dd",{class:"data-value"},null!==(a=null==o?void 0:o.max_gathering)&&void 0!==a?a:"Unknown")),l("div",{class:"data-entry is-third"},l("dt",null,"Cases"),l("dd",{class:"data-value"},(null==i?void 0:i.total_confirmed)?Number(null==i?void 0:i.total_confirmed).toLocaleString():"Not Availabe")),l("div",{class:"data-entry is-third"},l("dt",null,"Recoveries"),l("dd",{class:"data-value"},(null==i?void 0:i.total_recovered)?Number(null==i?void 0:i.total_recovered).toLocaleString():"Not Availabe")),l("div",{class:"data-entry is-third"},l("dt",null,"Deaths"),l("dd",{class:"data-value"},(null==i?void 0:i.total_deaths)?Number(null==i?void 0:i.total_deaths).toLocaleString():"Not Availabe"))),l(B,null),"success"===o.status?[l("h2",{class:"ld-font-subheader last"},"Daily life (restrictions)"),l("ul",{class:"measures"},(c=o.measures,H.map(t=>{var e;const a=null==c?void 0:c.find(e=>e.label===t.id);return{...t,value:null!==(e=O[a.value])&&void 0!==e?e:O[4]}})).map(t=>l("li",null,l("div",{class:"measure-wrapper"},l("div",{"aria-labelledby":"measure-label-"+t.id,class:"measure measure-"+t.value,"aria-label":t.value.toLowerCase()},t.icon),l("span",{id:"measure-label-"+t.id,class:"measure-label"},t.label)))))]:l("div",{class:"dialog"},l("h2",null,"Measures"),"Failed to get data for this country.")];var c}}class G extends o{render(t){let{countryDetails:e}=this.props;return"success"===e.status?[l("br",null),l("br",null),l(B,null),l("h2",{class:"ld-font-subheader last transport"},"Transport (restrictions)"),l("dl",null,l("div",{class:"ld-travel"},l("dt",null),l("div",{class:"ld-travel--values"},l("dd",{class:"ld-travel--val-icon"},E),l("dd",{class:"ld-travel--val-icon"},k),l("dd",{class:"ld-travel--val-icon"},D))),Object.keys(e.travel).map((t,a)=>l("div",{class:"ld-travel"},l("dt",null,W[t].text),l("div",{class:"ld-travel--values"},e.travel[t].map((t,e)=>{var a,s,i,r,o;return l("dd",{"aria-label":Y[e]+": "+(null!==(a=null===(s=F[t])||void 0===s?void 0:s.toLowerCase())&&void 0!==a?a:F[4].toLowerCase()),"data-tooltip":null!==(i=null===(r=F[t])||void 0===r?void 0:r.toLowerCase())&&void 0!==i?i:F[4].toLowerCase(),class:"ld-travel--symbol ld-travel--val-"+(null!==(o=F[t])&&void 0!==o?o:F[5])})})))))]:[l("div",{class:"dialog"},l("h2",null,"Measures"),"Failed to get data for this country.")," "]}}class B extends o{render(t){return l("div",{class:"legend ld-font-legend"},l("dl",null,l("div",{class:"legend-item"},l("dt",{class:"legend-green","aria-label":"green"}),l("dd",null,"None")),l("div",{class:"legend-item"},l("dt",{class:"legend-yellow","aria-label":"yellow"}),l("dd",null,"Partial")),l("div",{class:"legend-item"},l("dt",{class:"legend-red","aria-label":"red"}),l("dd",null,"Total")),l("div",{class:"legend-item"},l("dt",{class:"legend-gray","aria-label":"gray"}),l("dd",null,"Unclear"))))}}class J extends o{render(t){return l("div",{class:$},l("h3",null,"Coming Soon"))}}export default class extends o{constructor(t){super(t),this.changeTab=this.changeTab.bind(this),this.state={currentTab:1}}async componentDidUpdate(t){if(this.props.date!==t.date){const{startDate:t,endDate:e}=this.props;this.setState({coronaData:await C.getCountry({iso2:this.props.iso2,date:this.props.date,startDate:t,endDate:e}),countryDetails:await R.getDetails({iso2:this.props.iso2,date:this.props.date,startDate:t,endDate:e})})}}async componentWillMount(){const{startDate:t,endDate:e}=this.props;this.setState({coronaData:await C.getCountry({iso2:this.props.iso2,date:this.props.date,startDate:t,endDate:e}),populationData:await N.getPopulation(),countryDetails:await R.getDetails({iso2:this.props.iso2,date:this.props.date,startDate:t,endDate:e})})}changeTab(t){this.setState({currentTab:t})}render(e,{coronaData:a,populationData:s,countryDetails:i}){var r,o;if(!navigator.onLine&&("success"!==(null==a?void 0:a.status)||"success"!==(null==s||null===(o=s.data)||void 0===o?void 0:o.status)||"success"!==(null==i?void 0:i.status)))return l("div",{class:"countryInfo "+d},n,l("b",null,"You are not connected to the internet"),l("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."));return a||s||i||!navigator.onLine?[l("div",{class:U},Z.map(t=>l("div",{onClick:()=>this.changeTab(t.id),class:"tab "+(this.state.currentTab===t.id?"active":"")},t.name)),l("button",{onClick:this.props.onClose},_)),l("div",{class:"countryInfo "+z},1===this.state.currentTab?l(q,{date:this.props.date,country:this.props.country,coronaData:null===(r=a.data)||void 0===r?void 0:r.find(e=>function(e,a){t(2,arguments);var s=L(e),i=L(a);return s.getTime()===i.getTime()}(new Date(e.last_updated),this.props.date)),populationData:null==s?void 0:s.data[this.props.iso2],countryDetails:i}):2===this.state.currentTab?l(G,{countryDetails:i}):l(J,null))]:l("div",{class:"countryInfo loader "+c},w)}}
