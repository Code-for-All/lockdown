import{r as i,t as r,E as e,f as t,a as o,c as a,b as s,w as n,d,v as l,o as c,e as g,g as y,h as u,i as h,j as p,k as m,s as Q,l as A,m as f,n as b,p as v,q as x,u as S,x as w,y as E,z as M,A as C}from"./bcb0d327.js";function N(e){i(1,arguments);var t=r(e);return t.setHours(0,0,0,0),t}const k={url:new URL("./src/services/coronastatusService.js",document.baseURI).href};new class extends e{async getCoronaStatus(i){return!i&&this.__coronastatus||(this.__coronastatus=fetch(new URL("../../data/coronastatus.json",k.url)).then(i=>i.json()),await this.__coronastatus,this.dispatchEvent(new Event("change"))),this.__coronastatus}};const U=new class extends e{constructor(){super(),this.cache={}}async getCountry(i){var r;let{iso2:e,date:a}=i,s=i.startDate,n=i.endDate;if(e=encodeURI(e),s=t(s||o(new Date,-14),"yyyy-MM-dd"),n=t(n||o(new Date,80),"yyyy-MM-dd"),!/^[a-zA-Z]{2}$/.test(e))return;const d=`${e}${s}${n}`;if(i.forceRefresh||this._shouldInvalidate()||"failed"===(null===(r=this.cache[d])||void 0===r?void 0:r.status)||!this.cache[d]){try{this.cache[d]={};const i=await(await fetch(`https://api.coronatracker.com/v3/analytics/trend/country?countryCode=${e}&startDate=${s}&endDate=${n}`)).json();this.cache[d]={status:"success",data:i},this.__lastUpdate=Date.now()}catch{this.cache[d]={status:"failed"}}this.dispatchEvent(new Event("change"))}return this.cache[d]}},{apiEndpoint:L}=a;const I=new class extends e{constructor(){super(),this.cache={}}async getDetails(i){var r;let{iso2:e,date:a,daysRange:s}=i,n=i.startDate,d=i.endDate;if(e=encodeURI(e),n=t(n||o(new Date,-14),"yyyy-MM-dd"),d=t(d||o(new Date,s),"yyyy-MM-dd"),!/^[a-zA-Z]{2}$/.test(e))return;let l=`${e}${n}${d}`;if(i.forceRefresh||this._shouldInvalidate()||"failed"===(null===(r=this.cache[l])||void 0===r?void 0:r.status)||!this.cache[l])try{this.cache[l]={};const i=await(await fetch(`${L}/status/${e}/${n}/${d}`)).json();this.cache[l]=i}catch(i){this.cache[l]={status:"failed"}}var c=this.cache[l];if("failed"===c.status)return this.dispatchEvent(new Event("change")),c;const g={};var y=c[t(a,"yyyy-MM-dd")];for(const i of["land","flight","sea"])for(const{label:r,value:e}of y.lockdown[i])Array.isArray(g[r])?g[r].push(e):g[r]=[e];var u={status:"success",date:y.lockdown.date,measures:y.lockdown.measure,travel:g,max_gathering:y.lockdown.max_gathering[0].value};return this.__lastUpdate=Date.now(),this.dispatchEvent(new Event("change")),u}},_={url:new URL("./src/services/populationService.js",document.baseURI).href};const D=new class extends e{constructor(){super(),this.cache={}}async getPopulation(i){var r;if(i||!this.__population)try{this.__population=await fetch(new URL("../../data/population.json",_.url)).then(i=>i.json())}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:null!==(r=this.__population)&&void 0!==r?r:0}}};new class extends e{constructor(){super(),this.cache={}}async getAdvice(i){var r;let{iso2:e}=i;if(e=encodeURI(e),/^[a-zA-Z]{2}$/.test(e)){if(i.forceRefresh||"failed"===(null===(r=this.cache[e])||void 0===r?void 0:r.status)||!this.cache[e]){try{this.cache[e]={};const i=await(await fetch("https://www.travel-advisory.info/api?countrycode="+e)).json();return this.cache[e]={status:"success",advice:i.data[e].advisory.message,score:i.data[e].advisory.score+"/5"},this.cache[e]}catch(i){this.cache[e]={status:"failed"}}return this.dispatchEvent(new Event("change")),this.cache[e]}return this.cache[e]}}};let R,T,P,G=i=>i;const B=s(R||(R=G`
  &{
    width: 100%;
    display: flex;
    position: relative;
