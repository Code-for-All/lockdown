...
`)),Oe=t=>[u("a",{class:"skiplink",href:"#main"},"Go to main content"),u("header",{class:We+" "+(t.show?"":"hide")},u("div",{class:"ld-logo-wrapper"},u("a",{href:"","aria-current":"page"},u("p",null,"BETA"),ge)),u("div",{class:"totals"},u(ce,{selectedDate:t.selectedDate,startDate:t.startDate,endDate:t.endDate,i18n:t.i18n})))];var Be,Ne,Re,Ie=0,Fe=[],Ze=t.__r,Ye=t.diffed,qe=t.__c,$e=t.unmount;function Ge(e,n){t.__h&&t.__h(Ne,e,Ie||n),Ie=0;var a=Ne.__H||(Ne.__H={__:[],__h:[]});return e>=a.__.length&&a.__.push({}),a.__[e]}function Xe(t){return Ie=1,function(t,e,n){var a=Ge(Be++,2);return a.t=t,a.__c||(a.__c=Ne,a.__=[n?n(e):an(void 0,e),function(t){var e=a.t(a.__[0],t);a.__[0]!==e&&(a.__[0]=e,a.__c.setState({}))}]),a.__}(an,t)}function Qe(e,n){var a=Ge(Be++,3);!t.__s&&nn(a.__H,n)&&(a.__=e,a.__H=n,Ne.__H.__h.push(a))}function Ke(t){return Ie=5,function(t,e){var n=Ge(Be++,7);return nn(n.__H,e)?(n.__H=e,n.__h=t,n.__=t()):n.__}((function(){return{current:t}}),[])}function Je(){Fe.some((function(e){if(e.__P)try{e.__H.__h.forEach(tn),e.__H.__h.forEach(en),e.__H.__h=[]}catch(n){return e.__H.__h=[],t.__e(n,e.__v),!0}})),Fe=[]}function tn(t){"function"==typeof t.u&&t.u()}function en(t){t.u=t.__()}function nn(t,e){return!t||e.some((function(e,n){return e!==t[n]}))}function an(t,e){return"function"==typeof e?e(t):e}function rn(t,e){for(var n in t)if("__source"!==n&&!(n in e))return!0;for(var a in e)if("__source"!==a&&t[a]!==e[a])return!0;return!1}t.__r=function(t){Ze&&Ze(t),Be=0;var e=(Ne=t.__c).__H;e&&(e.__h.forEach(tn),e.__h.forEach(en),e.__h=[])},t.diffed=function(e){Ye&&Ye(e);var n=e.__c;n&&n.__H&&n.__H.__h.length&&(1!==Fe.push(n)&&Re===t.requestAnimationFrame||((Re=t.requestAnimationFrame)||function(t){var e,n=function(){clearTimeout(a),cancelAnimationFrame(e),setTimeout(t)},a=setTimeout(n,100);"undefined"!=typeof window&&(e=requestAnimationFrame(n))})(Je))},t.__c=function(e,n){n.some((function(e){try{e.__h.forEach(tn),e.__h=e.__h.filter((function(t){return!t.__||en(t)}))}catch(a){n.some((function(t){t.__h&&(t.__h=[])})),n=[],t.__e(a,e.__v)}})),qe&&qe(e,n)},t.unmount=function(e){$e&&$e(e);var n=e.__c;if(n&&n.__H)try{n.__H.__.forEach(tn)}catch(e){t.__e(e,n.__v)}};!function(t){var e,n;function a(e){var n;return(n=t.call(this,e)||this).isPureReactComponent=!0,n}n=t,(e=a).prototype=Object.create(n.prototype),e.prototype.constructor=e,e.__proto__=n,a.prototype.shouldComponentUpdate=function(t,e){return rn(this.props,t)||rn(this.state,e)}}(g);var on=t.__b;t.__b=function(t){t.type&&t.type.t&&t.ref&&(t.props.ref=t.ref,t.ref=null),on&&on(t)};var sn=t.__e;function ln(t){return t&&((t=function(t,e){for(var n in e)t[n]=e[n];return t}({},t)).__c=null,t.__k=t.__k&&t.__k.map(ln)),t}function cn(){this.__u=0,this.o=null,this.__b=null}function dn(t){var e=t.__.__c;return e&&e.u&&e.u(t)}function hn(){this.i=null,this.l=null}t.__e=function(t,e,n){if(t.then)for(var a,r=e;r=r.__;)if((a=r.__c)&&a.__c)return a.__c(t,e.__c);sn(t,e,n)},(cn.prototype=new g).__c=function(t,e){var n=this;null==n.o&&(n.o=[]),n.o.push(e);var a=dn(n.__v),r=!1,o=function(){r||(r=!0,a?a(i):i())};e.__c=e.componentWillUnmount,e.componentWillUnmount=function(){o(),e.__c&&e.__c()};var i=function(){var t;if(!--n.__u)for(n.__v.__k[0]=n.state.u,n.setState({u:n.__b=null});t=n.o.pop();)t.forceUpdate()};n.__u++||n.setState({u:n.__b=n.__v.__k[0]}),t.then(o,o)},cn.prototype.render=function(t,e){return this.__b&&(this.__v.__k[0]=ln(this.__b),this.__b=null),[u(g,null,e.u?null:t.children),e.u&&t.fallback]};var un=function(t,e,n){if(++n[1]===n[0]&&t.l.delete(e),t.props.revealOrder&&("t"!==t.props.revealOrder[0]||!t.l.size))for(n=t.i;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;t.i=n=n[2]}};(hn.prototype=new g).u=function(t){var e=this,n=dn(e.__v),a=e.l.get(t);return a[0]++,function(r){var o=function(){e.props.revealOrder?(a.push(r),un(e,t,a)):r()};n?n(o):o()}},hn.prototype.render=function(t){this.i=null,this.l=new Map;var e=x(t.children);t.revealOrder&&"b"===t.revealOrder[0]&&e.reverse();for(var n=e.length;n--;)this.l.set(e[n],this.i=[1,0,this.i]);return t.children},hn.prototype.componentDidUpdate=hn.prototype.componentDidMount=function(){var t=this;t.l.forEach((function(e,n){un(t,n,e)}))};!function(){function t(){}var e=t.prototype;e.getChildContext=function(){return this.props.context},e.render=function(t){return t.children}}();var pn=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;g.prototype.isReactComponent={};var fn="undefined"!=typeof Symbol&&Symbol.for&&Symbol.for("react.element")||60103,gn=t.event;function mn(t,e){t["UNSAFE_"+e]&&!t[e]&&Object.defineProperty(t,e,{configurable:!1,get:function(){return this["UNSAFE_"+e]},set:function(t){this["UNSAFE_"+e]=t}})}t.event=function(t){gn&&(t=gn(t)),t.persist=function(){};var e=!1,n=!1,a=t.stopPropagation;t.stopPropagation=function(){a.call(t),e=!0};var r=t.preventDefault;return t.preventDefault=function(){r.call(t),n=!0},t.isPropagationStopped=function(){return e},t.isDefaultPrevented=function(){return n},t.nativeEvent=t};var bn={configurable:!0,get:function(){return this.class}},wn=t.vnode;t.vnode=function(t){t.$$typeof=fn;var e=t.type,n=t.props;if(e){if(n.class!=n.className&&(bn.enumerable="className"in n,null!=n.className&&(n.class=n.className),Object.defineProperty(n,"className",bn)),"function"!=typeof e){var a,r,o;for(o in n.defaultValue&&void 0!==n.value&&(n.value||0===n.value||(n.value=n.defaultValue),delete n.defaultValue),Array.isArray(n.value)&&n.multiple&&"select"===e&&(x(n.children).forEach((function(t){-1!=n.value.indexOf(t.props.value)&&(t.props.selected=!0)})),delete n.value),n)if(a=pn.test(o))break;if(a)for(o in r=t.props={},n)r[pn.test(o)?o.replace(/[A-Z0-9]/,"-$&").toLowerCase():o]=n[o]}!function(e){var n=t.type,a=t.props;if(a&&"string"==typeof n){var r={};for(var o in a)/^on(Ani|Tra|Tou)/.test(o)&&(a[o.toLowerCase()]=a[o],delete a[o]),r[o.toLowerCase()]=o;if(r.ondoubleclick&&(a.ondblclick=a[r.ondoubleclick],delete a[r.ondoubleclick]),r.onbeforeinput&&(a.onbeforeinput=a[r.onbeforeinput],delete a[r.onbeforeinput]),r.onchange&&("textarea"===n||"input"===n.toLowerCase()&&!/^fil|che|ra/i.test(a.type))){var i=r.oninput||"oninput";a[i]||(a[i]=a[r.onchange],delete a[r.onchange])}}}(),"function"==typeof e&&!e.m&&e.prototype&&(mn(e.prototype,"componentWillMount"),mn(e.prototype,"componentWillReceiveProps"),mn(e.prototype,"componentWillUpdate"),e.m=!0)}wn&&wn(t)};let vn;function Cn(t){const[e,n]=Xe(!1),a=Ke(null);return Qe(()=>{e&&a.current.focus({preventScroll:!0})},[e]),Qe(()=>{t.currentDropdown!==t.toggle&&n(!1)},[t.currentDropdown]),u("div",{class:xn},u("div",{class:"ld-expandable"},u("button",{onClick:()=>{t.onDropDown(!e&&t.toggle),n(!e)},class:"ld-expandable--toggle","aria-expanded":e},u("div",{class:"ld-expandable--icon"},e?_n:yn),u("div",{class:"ld-expandable--toggle-content"},u("h2",null,t.toggle))),u("div",{ref:a,class:"ld-expandable--detail "+(e?"ld-expandable--expanded":"ld-expandable--closed"),role:"region",tabindex:"-1"},t.detail)))}const xn=B(vn||(vn=(t=>t)`
  .ld-expandable {
    width: 100%;
    height: auto;
...
`)),yn=u("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-right",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},u("path",{stroke:"none",d:"M0 0h24v24H0z"}),u("polyline",{points:"9 6 15 12 9 18"})),_n=u("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-down",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},u("path",{stroke:"none",d:"M0 0h24v24H0z"}),u("polyline",{points:"6 9 12 15 18 9"})),kn={url:new URL("./src/services/updatesService.js",document.baseURI).href};const Mn=new class extends qt{async getUpdates(t){if(t||!this.updates)try{this.updates=await fetch(new URL("../../data/updates.json",kn.url)).then(t=>t.json()),await this.updates}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:this.updates}}};let Ln,Dn,Sn=t=>t;const Pn=B(Ln||(Ln=Sn`
  & {
    display: flex;
    align-items: center;
...
`));let Hn;const Tn={new_entry:"new entry",announcement:"announcement",rectification:"rectification",promoting_project:"project promotion",promoting_petition:"petition"};function An(){var t,e;const[n,a]=Xe(void 0);return Qe(async()=>{const t=await Mn.getUpdates();a(t)},[]),navigator.onLine||"success"===(null==n?void 0:n.status)?!n&&navigator.onLine?u("div",{class:Pn},be):"failed"===n.status&&navigator.onLine?u("div",{style:"margin-top: 14px;"},"An error occured while fetching updates."):u("div",{class:En},u("ul",null,null==n||null===(t=n.data)||void 0===t||null===(e=t.updates)||void 0===e?void 0:e.map(t=>u("li",null,u("div",{class:"ld-ticker--bar"},u("div",{class:"ld-ticker--dot-container"},u("div",{"aria-label":Tn[t.type.toLowerCase()],class:"ld-ticker--dot "+t.type.toLowerCase()})),u("div",{class:"ld-ticker--line"})),u("div",{class:"ld-ticker--content"},u("div",{class:"ld-ticker--title"},t.title),u("div",{class:"ld-ticker--content"},t.content),t.link?u("div",{class:"ld-ticker--link"},u("a",{target:"_blank",rel:"noopener noreferer",href:t.link},"Source")):"",u("div",{class:"ld-ticker--date"},t.date)))))):u("div",{class:zn},me,u("b",null,"You are not connected to the internet"),u("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."))}const En=B(Hn||(Hn=(t=>t)`
  & ul {
    list-style: none;
    margin: 0;
    padding: 20px 0 0 0;
...
`));function Un(t){let e;"serviceWorker"in navigator&&navigator.serviceWorker.getRegistration().then(n=>{n&&(n.addEventListener("updatefound",()=>{e=n.installing,e.addEventListener("statechange",()=>{"installed"===e.state&&navigator.serviceWorker.controller&&t(!0)})}),n.waiting&&navigator.serviceWorker.controller&&(t(!0),e=n.waiting))})}function Vn(t){const[e,n]=[...document.querySelectorAll("link[rel='icon']")],a=document.querySelector("link[rel='manifest']"),r=document.querySelector("meta[name='theme-color']");t?(a.href="/manifest-dark.json",e.href="src/assets/favicon-32x32-dark.png",n.href="src/assets/favicon-16x16-dark.png",r.setAttribute("content","#303136")):(a.href="/manifest.json",e.href="src/assets/favicon-32x32.png",n.href="src/assets/favicon-16x16.png",r.setAttribute("content","#ffffff")),document.getElementsByTagName("head")[0].appendChild(a),document.getElementsByTagName("head")[0].appendChild(e),document.getElementsByTagName("head")[0].appendChild(n),document.getElementsByTagName("head")[0].appendChild(r)}let jn,Wn;window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),Wn=!0,jn=t});class On extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}).innerHTML="<slot><button>Install</button></slot>"}connectedCallback(){this.setAttribute("hidden",""),this.addEventListener("click",this._handlePrompt.bind(this)),window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),jn=t,this.removeAttribute("hidden"),this.dispatchEvent(new CustomEvent("pwa-installable",{detail:!0}))}),Wn&&this.removeAttribute("hidden")}async _handlePrompt(t){t.preventDefault(),jn.prompt();const{outcome:e}=await jn.userChoice;"accepted"===e?(this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!0})),this.setAttribute("hidden",""),jn=null):this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!1}))}}customElements.define("pwa-install-button",On);class Bn extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"}).innerHTML="<slot><button>New update available!</button></slot>",this._refreshing=!1}async connectedCallback(){this.addEventListener("click",this._postMessage.bind(this)),navigator.serviceWorker.addEventListener("controllerchange",()=>{this._refreshing||(window.location.reload(),this._refreshing=!0)})}async _postMessage(t){t.preventDefault();(await navigator.serviceWorker.getRegistration()).waiting.postMessage({type:"SKIP_WAITING"})}}customElements.define("pwa-update-available",Bn);let Nn;const Rn=B(Nn||(Nn=(t=>t)`
  & {
    padding-top: 20px;
  }
...
`)),ra=(t,e,n,a,r,o)=>{switch(t){case"info":return{title:"info",template:[u("h1",null,"Lockdown"),u("p",{class:"ld-alpha"},o.t("menu.informationSection.banner")),u("p",null,u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.main.text")),u(Cn,{toggle:o.t("menu.informationSection.about.title"),currentDropdown:n,onDropDown:a,detail:u("p",null,o.t("menu.informationSection.about.text.p1"),u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.about.text.p2"),u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.about.text.p3"))}),u(Cn,{toggle:o.t("menu.informationSection.sources.title"),currentDropdown:n,onDropDown:a,detail:u("p",null,u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.sources.subtitle"),u("ul",{class:"ld-sources"},u("li",null,u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://TIOF.Click/LockdownData"}," ",o.t("menu.informationSection.sources.linksList.first.linkTitle")),u("br",null),o.t("menu.informationSection.sources.linksList.first.text")),u("li",null,u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://covid19api.com/"},o.t("menu.informationSection.sources.linksList.second.linkTitle")),u("br",null),o.t("menu.informationSection.sources.linksList.second.text")," ",u("a",{href:"https://systems.jhu.edu/",target:"_blank"},o.t("menu.informationSection.sources.linksList.second.highlight")),u("br",null))),o.t("menu.informationSection.sources.issues.text")," ",u("a",{rel:"noopener noreferrer",target:"_blank",href:"https://github.com/Code-for-All/lockdown/issues"},o.t("menu.informationSection.sources.issues.highlight")),".")}),u(Cn,{toggle:o.t("menu.informationSection.credits.title"),currentDropdown:n,onDropDown:a,detail:u("p",null,u("b",null,o.t("menu.informationSection.main.name")),o.t("menu.informationSection.credits.text"),u("a",{href:"https://docs.google.com/spreadsheets/d/1mVyQxxLxAF3E1dw870WHXTOLgYzmumojvzIekpgvLV0/edit?ts=5e74ac83#gid=634415797",target:"_blank"},o.t("menu.informationSection.credits.highlight")),".")}),u(Cn,{toggle:o.t("menu.informationSection.dataPrivacity.title"),currentDropdown:n,onDropDown:a,detail:[u("p",null,o.t("menu.informationSection.dataPrivacity.paragraphs.p1")),u("p",null,o.t("menu.informationSection.dataPrivacity.paragraphs.p2"))]})]};case"settings":return{title:"settings",template:[" ",u(In,{onClose:e,onLocateChange:r,locale:o})," "]};case"contribute":return{title:"contribute",template:[u("p",null,"Do you have any NPI source you would want to share with us? Please follow this link:"),u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://docs.google.com/forms/d/e/1FAIpQLSfDWe2qlzUnd3e-YYspMzT9adUswDEYIdJMb7jz7ule34-yiA/viewform"},"Submit data"),u("p",null,"Additionally, you can become part of the project by joining one of the following teams:",u("ul",null,u("li",null,"Editors"),u("li",null,"Devs"),u("li",null,"UI/UX"))),u("p",null,"Contact us via Telegram at:",u("br",null),u("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://t.me/ProjectLockdown"}," @ProjectLockdown"))]};case"updates":return{title:"updates",template:[" ",u(An,null)," "]};default:return{title:"",template:void 0}}};class oa extends g{constructor(t){super(t),this.state={activeItem:"info",showLateralMenu:!1,showMenu:!1,currentDropdown:1},this.showSideBar=this.showSideBar.bind(this),this.closeNavbar=this.closeNavbar.bind(this),this.switchContent=this.switchContent.bind(this),this.onDropDown=this.onDropDown.bind(this)}componentDidMount(){let t=0;A("(min-width: 960px)",e=>{this.setState({isMobile:!e}),e&&t>0&&(t++,this.props.close())})}showSideBar(){this.setState({showLateralMenu:!0,showMenu:!0})}switchContent(t){if("settings"===t&&this.state.updateAvailable&&this.setState({updateAvailable:!1}),this.state.isMobile&&this.props.opened&&t===this.prevVal)return this.props.close(),this.setState({activeItem:this.prevVal}),void(this.prevVal="");this.prevVal=t,this.setState({activeItem:t,showLateralMenu:t!==this.state.activeItem})}closeNavbar(){this.setState({showLateralMenu:!1,showSideBar:!1,activeItem:"info"})}onDropDown(t){this.setState({currentDropdown:t})}render(t,{activeItem:e,updateAvailable:n,currentDropdown:a}){return this.state.showLateralMenu||!0===this.props.isMobile?[u("div",{class:"menu-overlay "+aa}),u("main",{id:"main",class:"ld-menu "+ta+" "+(this.state.showLateralMenu?Jn:"")},u("div",{class:"ld-menu-nav"},u("button",{class:na,onClick:this.closeNavbar},fe),u("nav",null,u(Zn,{onClose:this.closeNavbar,switchContent:this.switchContent},u("button",{id:"info"},"info"),u("button",{id:"settings"},"settings"),u("button",{id:"updates"},"updates"),u("button",{id:"contribute"},"contribute")))),u("div",{class:"ld-menu--content"},u("div",{class:"mb-only"},u("div",{class:"ld-menu--header"},u("h1",null,e))),ra(e,this.closeNavbar,a,this.onDropDown,t.onLocateChange,t.locale).template))]:u("button",{onClick:this.showSideBar,class:ea},_e)}}class ia extends g{async componentWillMount(){const t=await this.props.component(),e=t.default||t;this.setState({Component:e})}render({props:t},{Component:e}){return u(e,t)}}var sa="object"==typeof global&&global&&global.Object===Object&&global,la="object"==typeof self&&self&&self.Object===Object&&self,ca=sa||la||Function("return this")(),da=ca.Symbol,ha=Object.prototype,ua=ha.hasOwnProperty,pa=ha.toString,fa=da?da.toStringTag:void 0;var ga=Object.prototype.toString;var ma=da?da.toStringTag:void 0;function ba(t){return null==t?void 0===t?"[object Undefined]":"[object Null]":ma&&ma in Object(t)?function(t){var e=ua.call(t,fa),n=t[fa];try{t[fa]=void 0;var a=!0}catch(t){}var r=pa.call(t);return a&&(e?t[fa]=n:delete t[fa]),r}(t):function(t){return ga.call(t)}(t)}function wa(t){var e=typeof t;return null!=t&&("object"==e||"function"==e)}var va=/^\s+|\s+$/g,Ca=/^[-+]0x[0-9a-f]+$/i,xa=/^0b[01]+$/i,ya=/^0o[0-7]+$/i,_a=parseInt;function ka(t){if("number"==typeof t)return t;if(function(t){return"symbol"==typeof t||function(t){return null!=t&&"object"==typeof t}(t)&&"[object Symbol]"==ba(t)}(t))return NaN;if(wa(t)){var e="function"==typeof t.valueOf?t.valueOf():t;t=wa(e)?e+"":e}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(va,"");var n=xa.test(t);return n||ya.test(t)?_a(t.slice(2),n?2:8):Ca.test(t)?NaN:+t}var Ma=function(){return ca.Date.now()},La=Math.max,Da=Math.min;let Sa,Pa,za=t=>t;const Ha=B(Sa||(Sa=za`
  & {
    @media (max-width: 960px) {
      max-width: 200px;
    }
...
`)),Aa=["S","M","T","W","T","F","S"],Ea=["January","February","March","April","May","June","July","August","September","October","November","December"];class Ua extends g{constructor(){super(),this.state={days:[],currentMonth:(new Date).getMonth(),lastSelection:!1,currentYear:2020,allMonthsDate:new Array(12),enableArrows:!1},this.onPressKey=this.onPressKey.bind(this),this.getMonthData=this.getMonthData.bind(this),this.fillAllMonths=this.fillAllMonths.bind(this),this.chooseDay=this.chooseDay.bind(this),this.changeMonth=this.changeMonth.bind(this)}componentDidMount(){window.addEventListener("keydown",this.onPressKey);const{currentMonth:t,allMonthsDate:e}=this.state;let n=new Date(2020,t,1),a=new Date(2020,t+1,0),r=this.getMonthData(n,a),o=e;o[t]=r,this.setState({days:r,allMonthsDate:o},this.fillAllMonths)}componentWillUnmount(){window.removeEventListener("keydown",this.onPressKey)}onPressKey(t){console.log(t),"Escape"===t.code&&this.props.show&&this.props.close()}getMonthData(t,e){let n=e.getDate(),a=7-(t.getDay()+1),r=n+a,o=r/7,i=0;r%7>0&&(i=7-r%7,r+=7-r%7,o=r/7);let s=[],l=0;for(let t=0;t<o;t++){s.push([]);for(let e=0;e<7;e++)0===t&&e<a||t===o-1&&i>0&&e>7-i-1?s[t].push({day:null,label:Aa[e]}):(l++,s[t].push({day:l,label:Aa[e]}))}return s}fillAllMonths(){const t=this.state.currentMonth;let e,n,a=this.state.allMonthsDate;for(let r=0;r<12;r++)if(r!==t){e=new Date(2020,r,1),n=new Date(2020,r+1,0);let t=this.getMonthData(e,n);a[r]=t}this.setState({allMonthsDate:a,enableArrows:!0})}chooseDay(t,e,n){let a=this.state.days;!1!==this.state.lastSelection&&(a[this.state.lastSelection[0]][this.state.lastSelection[1]].selected=!1),t.selected=!0,a[e][n]=t,this.props.onSelect(new Date(this.state.currentYear,this.state.currentMonth,t.day)),this.setState({days:a,lastSelection:[e,n]})}changeMonth(t){const{enableArrows:e,currentMonth:n,allMonthsDate:a}=this.state;if(e){let e,r;(n>0||t)&&(n<11||!t)&&(t?(r=n+1,e=a[r]):(r=n-1,e=a[r]),this.setState({days:e,currentMonth:r}))}}render(t){return[u("div",{class:"overlay "+Ta+" "+(this.props.show?"show":""),onClick:this.props.close}),u("div",{class:"calendar "+Ha+" "+(this.props.show?"show":"")+" "+this.props.customClass},u("div",{class:"calendar actions"},u("span",{onClick:()=>this.changeMonth(!1)},xe),u("h3",null,Ea[this.state.currentMonth]," ",this.state.currentYear),u("span",{onClick:()=>this.changeMonth(!0)},ye)),u("div",{class:"calendar header"},Aa.map(t=>u("div",{class:"header item"},t))),u("div",{class:"calendar container"},this.state.days.map((t,e)=>u("div",{class:"week"},t.map((t,n)=>u("div",{onClick:()=>this.chooseDay(t,e,n),class:`day ${null===t.day?"empty":""} ${t.selected?"selected":""}`},u("span",null,t.day)))))))]}}const Va=t=>{if("object"==typeof t){let e={};return Object.keys(t).forEach(n=>{let a=function t(e,n){if("object"!=typeof e||Array.isArray(e)){let t={};return t[n]=e,t}{let a=[];for(let r in e){let o;if(o=t(e[r],n?`${n}_${r}`:r),Array.isArray(o)){let t={};for(let e of o)t={...t,...e};o=t}a.push(o)}return a}}(t[n],n);if(Array.isArray(a)){let t={};for(let e of a)t={...t,...e};a=t}e={...e,...a}}),e}return t};let ja,Wa,Oa,Ba,Na,Ra,Ia=t=>t;const Fa=[7.5,16,24.5,33,41.5,50,58.5,67,75.5,84,94];let Za=!1;function Ya(t,e){let n=e;return void 0!==e?(n=e.replace("-",""),"zhHK"===n&&(n="zhTW"),void 0!==Za[n]&&null!==Za[n]||(n=e.split("-")[0],void 0!==Za[n]&&null!==Za[n]||(n="enUS"))):n="enUS",Zt(t,"dd MMM",{locale:Za?Za[n]:et})}function qa(t,e){let n=e;return e?(n=e.replace("-",""),void 0!==Za[n]&&null!==Za[n]||(n=e.split("-")[0],void 0!==Za[n]&&null!==Za[n]||(n="enUS"))):n="enUS",Zt(t,"dd MMMM yyyy",{locale:Za?Za[n]:et})}const $a=B(ja||(ja=Ia`
  & {
    position: absolute;
    bottom: 30px;
    left: 0;
...
`));class tr extends g{constructor(){super(),this.state={currentDateValue:35,currentPosition:24.5,datePickerPosition:"left",showDatePicker:!1,currentSelectedDay:"",firstDay:"",lastDay:"",currentSliderRange:[]},this.dateRef={},this.range={},this.container={},this.onSliderChange=this.onSliderChange.bind(this),this.onBtnClick=this.onBtnClick.bind(this),this.onChooseDate=this.onChooseDate.bind(this),this.calendarWillClose=this.calendarWillClose.bind(this),this.closeDatePicker=this.closeDatePicker.bind(this),this.submitChanges=this.submitChanges.bind(this),this.onPressKey=this.onPressKey.bind(this),this.updateDates=this.updateDates.bind(this)}async componentWillMount(){Za=await(async t=>({...await import("./286c6038.js")}))()}componentDidMount(){window.addEventListener("keydown",this.onPressKey);let t=[],e=Xt(new Date,-35);for(let n=1;n<=70;n++)t.push(e),e=Xt(e,1);const n=this.dateRef.current,a=this.range.current;let r=(this.container.current.offsetWidth-a.offsetWidth)/2-n.offsetWidth/4,o=a.offsetWidth/70;n.style.left=r+32*o+"px",this.setState({currentSliderRange:t,currentSelectedDay:qa(new Date,this.props.i18n.locale),firstDay:Ya(t[0],this.props.i18n.locale),lastDay:Ya(t[t.length-1],this.props.i18n.locale)})}componentWillUnmount(){window.removeEventListener("keydown",this.onPressKey)}componentDidUpdate(t,e,n){t.i18n!==this.props.i18n&&this.updateDates(e)}onPressKey(t){this.range.current;switch(t.code){case"ArrowLeft":t.preventDefault(),this.range.current.value>0&&(this.range.current.value=this.range.current.value-1,this.onSliderChange({target:{value:this.range.current.value}}));break;case"ArrowRight":t.preventDefault(),this.range.current.value<69&&(this.range.current.value=Number(this.range.current.value)+1,this.onSliderChange({target:{value:this.range.current.value}}))}}onSliderChange(t){const{currentDateValue:e,currentSliderRange:n}=this.state,a=this.dateRef.current,r=this.range.current,o=this.container.current;let i=t.target.value,s=(o.offsetWidth-r.offsetWidth)/2-a.offsetWidth/4,l=r.offsetWidth/70,c=Fa[i];a.style.left=s+l*i+"px",this.setState({currentDateValue:i,currentPosition:c,currentSelectedDay:qa(n[i],this.props.i18n.locale)},this.submitChanges)}onBtnClick(t){this.setState({showDatePicker:!0,datePickerPosition:t})}onChooseDate(t){const e=this.dateRef.current,n=this.range.current;let a=(this.container.current.offsetWidth-n.offsetWidth)/2-e.offsetWidth/4,r=n.offsetWidth/70;e.style.left=a+r*(.5+("left"===this.state.datePickerPosition?0:69))+"px",this.calendarWillClose();let o=[];if("left"===this.state.datePickerPosition){let e=1;for(let n=1;n<=70;n++)1===n?o.push(t):(o.push(this.rangePreProcces(t,e)),e++)}else{let e=69;for(let n=1;n<=70;n++)70===n?o.push(t):(o.push(this.rangePreProcces(t,-1*e)),e--)}this.setState({currentSliderRange:o,currentSelectedDay:qa(t,this.props.i18n.locale),firstDay:Ya(o[0],this.props.i18n.locale),lastDay:Ya(o[o.length-1],this.props.i18n.locale),currentDateValue:"left"===this.state.datePickerPosition?0:69,currentPosition:24.5},this.submitChanges)}updateDates(t){const{currentDateValue:e,currentSliderRange:n}=t;this.setState({currentSelectedDay:qa(n[e],this.props.i18n.locale),firstDay:Ya(n[0],this.props.i18n.locale),lastDay:Ya(n[n.length-1],this.props.i18n.locale)})}calendarWillClose(){this.setState({datePickerPosition:this.state.datePickerPosition+" hide"},()=>setTimeout(()=>this.closeDatePicker(),400))}closeDatePicker(){this.setState({showDatePicker:!1,datePickerPosition:this.state.datePickerPosition.replace(" hide","")})}rangePreProcces(t,e){let n=new Date(t);return n.setDate(t.getDate()+e),n}submitChanges(){const{currentSliderRange:t,currentDateValue:e}=this.state;this.props.onChange(t[e],t[0],t[t.length-1])}render(t){return u("div",{class:"sliderWrapper "+$a+" "+(""!==this.props.children?"open":""),ref:this.container},this.props.children,u("div",{class:Ga+" "+Xa+" "+(""!==this.props.children?"open":"")},u(Ua,{close:this.calendarWillClose,onSelect:this.onChooseDate,show:this.state.showDatePicker,customClass:this.state.datePickerPosition}),u("div",{class:Ka,ref:this.dateRef},u("span",null,this.state.currentSelectedDay)),u("span",{title:"Select Start Date",class:"first "+Qa,onClick:t=>this.onBtnClick("left")},u(er,null)," ",this.state.firstDay),u("button",{onClick:t=>this.onBtnClick("left"),class:"first "+Ja}),u("input",{ref:this.range,onInput:this.onSliderChange,type:"range",min:"0",max:"69",step:"1",value:this.state.currentDateValue}),u("button",{onClick:t=>this.onBtnClick("right"),class:"last "+Ja}),u("span",{title:"Select End Date",class:"last "+Qa,onClick:t=>this.onBtnClick("right")},u(er,null)," ",this.state.lastDay)))}}class er extends g{render(t){return u("span",null,Me)}}let nr;const ar=B(nr||(nr=(t=>t)`
  & {
    position: absolute;
    bottom: 150px;
    left: 10px;
...
`));class rr extends g{constructor(){super(),this.state={showDialog:!1,y:"bottom",x:"left"},this.btn={},this.onClick=this.onClick.bind(this),this.initBtn=this.initBtn.bind(this),this.onTouch=this.onTouch.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this),this.onDrop=this.onDrop.bind(this)}initBtn(t){this.btn=t,t.addEventListener("touchmove",this.onTouch),t.addEventListener("touchend",this.onTouchEnd),t.addEventListener("dragend",this.onDrop)}onTouch(t){let e=t.targetTouches[0];this.btn.style.left=e.pageX+"px",this.btn.style.top=e.pageY+"px"}onTouchEnd(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=Number(this.btn.style.top.replace("px","")),i=Number(this.btn.style.left.replace("px",""));o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=160&&(this.btn.style.top="160px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onDrop(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=t.clientY,i=t.clientX;0===o&&0===i&&(i=t.screenX,o=t.screenY),this.btn.style.top=o+"px",o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=60&&(this.btn.style.top="70px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onClick(){this.setState({showDialog:!this.state.showDialog})}render({i18n:t}){return u("div",{onClick:this.onClick,draggable:"true",ref:this.initBtn,class:ar},ke,u("div",{class:"dialog "+(this.state.showDialog?"show":"")+" "+this.state.y+" "+this.state.x},u("div",null,u("span",null,u("div",{class:"color green"})),u("span",null,t.t("mapLegend.no"))),u("div",null,u("span",null,u("div",{class:"color orange"})),u("span",null,t.t("mapLegend.partial"))),u("div",null,u("span",null,u("div",{class:"color red"})),u("span",null,t.t("mapLegend.full"))),u("div",null,u("span",null,u("div",{class:"color gray"})),u("span",null,t.t("mapLegend.noData"))),u("div",null,u("span",null,u("div",{class:"color covidstripes"})),u("span",null,t.t("mapLegend.cases")))))}}let or,ir,sr=t=>t;const lr=B(or||(or=sr`
  & {
    position: absolute;
    top: 25vh;
    right: 5vw;
...
`));class dr extends g{constructor(){super(),this.state={showLangOpt:!1},this.toggleLangOpts=this.toggleLangOpts.bind(this),this.changeCurrentLanguage=this.changeCurrentLanguage.bind(this)}toggleLangOpts(){this.setState({showLangOpt:!this.state.showLangOpt})}changeCurrentLanguage(t){this.toggleLangOpts(),this.props.onLocateChange(t)}render({i18n:t,languages:e},{showLangOpt:n}){var a;return[u("div",{class:lr,onClick:this.toggleLangOpts},null===(a=t.locale)||void 0===a?void 0:a.toUpperCase(),u("div",{class:"circleBtn"},Le)),u("div",{class:`${cr} ${n?"show":""}`},e.map(e=>u("div",{class:"langOpt "+(e===t.locale?"active":""),onClick:()=>this.changeCurrentLanguage(e)},null==e?void 0:e.toUpperCase().replace("-","\n"))))]}}var hr=["en","en-US","es","es-ES","es-MX","pt","pt-BR","zh-CN","zh-HK"];let ur;const pr=function(t,e,n){var a,r,o,i,s,l,c=0,d=!1,h=!1,u=!0;if("function"!=typeof t)throw new TypeError("Expected a function");function p(e){var n=a,o=r;return a=r=void 0,c=e,i=t.apply(o,n)}function f(t){return c=t,s=setTimeout(m,e),d?p(t):i}function g(t){var n=t-l;return void 0===l||n>=e||n<0||h&&t-c>=o}function m(){var t=Ma();if(g(t))return b(t);s=setTimeout(m,function(t){var n=e-(t-l);return h?Da(n,o-(t-c)):n}(t))}function b(t){return s=void 0,u&&a?p(t):(a=r=void 0,i)}function w(){var t=Ma(),n=g(t);if(a=arguments,r=this,l=t,n){if(void 0===s)return f(l);if(h)return clearTimeout(s),s=setTimeout(m,e),p(l)}return void 0===s&&(s=setTimeout(m,e)),i}return e=ka(e)||0,wa(n)&&(d=!!n.leading,o=(h="maxWait"in n)?La(ka(n.maxWait)||0,e):o,u="trailing"in n?!!n.trailing:u),w.cancel=function(){void 0!==s&&clearTimeout(s),c=0,a=l=r=s=void 0},w.flush=function(){return void 0===s?i:b(Ma())},w}(()=>{let t={menuDialogClosed:!1,countryDialogClosed:!1};const e=new URLSearchParams(location.search);e.has("country")||e.has("iso2")?t.countryDialogClosed=!0:t.menuDialogClosed=!0,Gt.close(t)},10,{leading:!0,trailing:!1}),fr=B(ur||(ur=(t=>t)`
  & {
    position: fixed;
    z-index: 1100;
    top: 74px;
...
`));function gr(t){return Zt(t,"yyyy-MM-dd")}("requestIdleCallback"in window?window.requestIdleCallback:t=>setTimeout(t,1e3))(()=>{import("./4b2c5554.js"),import("./1405dee5.js")}),console.log("🌐 Project Lockdown, version: 0.0.0"),window.addEventListener("appinstalled",()=>{window.location.reload()}),A("(prefers-color-scheme: dark)",t=>{const e=localStorage.getItem("darkmode");null!==e?"true"===e&&(document.documentElement.classList.add("dark"),Vn(!0)):t?(document.documentElement.classList.add("dark"),Vn(!0)):(document.documentElement.classList.remove("dark"),Vn(!1))}),function(e,n,a){var r,o,c;t.__&&t.__(e,n),o=(r=a===i)?null:a&&a.__k||n.__k,e=u(f,null,[e]),c=[],M(n,(r?n:a||n).__k=e,o||s,s,void 0!==n.ownerSVGElement,a&&!r?[a]:o?null:n.childNodes.length?l.slice.call(n.childNodes):null,c,a||s,r),L(c,e)}([" ",u(class extends g{constructor(){super(),this.state={dialog:{opened:!1,template:{},title:""},haveSelectedDate:!1,startDate:!1,endDate:!1,currentLanguage:{t:t=>t},languages:[],baseLanguages:[]},this.__onPathChanged=this.__onPathChanged.bind(this),this.__closeCountryInfo=this.__closeCountryInfo.bind(this),this.__closeDialog=this.__closeDialog.bind(this),this.__showDialog=this.__showDialog.bind(this),this.__showDialogRoute=this.__showDialogRoute.bind(this),this.__onSelectDate=this.__onSelectDate.bind(this),this.__initi18n=this.__initi18n.bind(this),this.__getTranslation=this.__getTranslation.bind(this),this.__onLocateChange=this.__onLocateChange.bind(this)}async componentDidMount(){this.__onPathChanged(),A("(min-width: 960px)",t=>{this.setState({isMobile:!getMatchedCSSRules})})}componentWillMount(){$t.addEventListener("path-changed",this.__onPathChanged),window.i18n?this.__initi18n():setTimeout(this.__initi18n,300),this.setState({showStatsbox:1==Number($t.url.searchParams.get("statsbox")||1),showMenu:1==Number($t.url.searchParams.get("menu")||1),showSlider:1==Number($t.url.searchParams.get("slider")||1)})}componentWillUnmount(){$t.removeEventListener("path-changed",this.__onPathChanged)}render(){const t=this.state.haveSelectedDate?gr(this.state.haveSelectedDate):gr(new Date);return[this.state.showStatsbox?[u(Oe,{selectedDate:t,showStatsbox:this.state.showStatsbox,startDate:this.state.startDate,endDate:this.state.endDate,show:!this.state.dialog.opened,i18n:this.state.currentLanguage}),this.state.dialog.opened?"":u("div",{class:fr},u(ce,{selectedDate:t,startDate:this.state.startDate,endDate:this.state.endDate,i18n:this.state.currentLanguage,onLocateChange:this.__onLocateChange}))]:"",this.state.showMenu?u(oa,{opened:this.state.dialog.opened,isMobile:this.state.isMobile,changeRoute:this.__showDialogRoute,close:this.__closeDialog,locale:this.state.currentLanguage,onLocateChange:this.__onLocateChange}):"",u(re,{selectedDate:t,startDate:this.state.startDate,endDate:this.state.endDate,currentLanguage:this.state.currentLanguage}),u(rr,{i18n:this.state.currentLanguage}),u(dr,{i18n:this.state.currentLanguage,languages:this.state.baseLanguages,onLocateChange:this.__onLocateChange}),this.state.showSlider?u(tr,{onChange:this.__onSelectDate,i18n:this.state.currentLanguage},this.state.dialog.opened?u(ia,{component:()=>import("./1405dee5.js"),props:{country:this.state.dialog.title,iso2:this.state.dialog.iso2,date:this.state.haveSelectedDate||new Date,i18n:this.state.currentLanguage,startDate:this.state.startDate,endDate:this.state.endDate,onClose:this.__closeDialog}}):""):""]}async __initi18n(){let t=navigator.language||navigator.userLanguage,e=window.i18n,n=await(async()=>{let t={},e=0;for(let n=0;n<hr.length;n++)try{let e=await import("./translations/"+hr[n]+"/index.js");if(e=e.default,e.languageId===hr[n]?t[hr[n]]=Va(e):console.warn(`The iso value of ${hr[n]} not match`),n===hr.length-1)return t}catch(a){if(console.log(a),e++,n===hr.length-1)return t;continue}if(e===hr-1)return console.log(t),t})(),a=Object.keys(n),r={},o=[];a.forEach(t=>{t.includes("-")?t.includes("zh-")&&o.push(t):o.push(t),r[t]={t:this.__getTranslation,i18n:e.create({values:n[t]}),locale:t}});let i=function(t,e){e.indexOf(t);{let n=t.split("-")[0];if(e.indexOf(n)>=0)return n;{if(t.includes("-TW")||t.includes("-tw"))return"zh-HK";let a=e.filter(t=>t.split("-")[0].contains(n));return a.length>0?a[0]:"en"}}}(t,a);this.setState({i18nLanguages:r,currentLanguage:r[i],languages:a,baseLanguages:o})}__getTranslation(t){let e=t.split(".").join("_");return this.state.currentLanguage.i18n(e)}__showDialogRoute({template:t,title:e}){const n=$t.url.searchParams.get("country");n?$t.setPath(`${e}?country=${n}`):$t.setPath(e),this.state.isMobile&&($t.setSearchParam("country",null),this.__showDialog({template:t,title:e}))}__onPathChanged(){const t=$t.url.searchParams.get("country"),e=$t.url.searchParams.get("iso2"),n=this.state.haveSelectedDate||new Date;t&&e&&this.setState({dialog:{opened:!0,template:[" ",u(ia,{component:()=>import("./1405dee5.js"),props:{country:t,iso2:e,date:n}})," "],title:t,iso2:e,date:n}},()=>console.log(this.state))}__showDialog({template:t,title:e}){this.setState({dialog:{opened:!0,template:t,title:e}})}__closeCountryInfo(){$t.setSearchParam("country",void 0),$t.setSearchParam("iso2",void 0)}__closeDialog(){this.setState({dialog:{opened:!1,template:"",title:""}}),pr(),this.__closeCountryInfo()}__onSelectDate(t,e,n){this.setState({haveSelectedDate:t,startDate:e,endDate:n})}__onLocateChange(t){this.state.i18nLanguages[t]&&this.setState({currentLanguage:this.state.i18nLanguages[t]})}},null)," "],document.getElementById("app"));export{Y as A,X as B,K as C,J as D,qt as E,bt as F,Z as G,G as H,Q as I,tt as J,et as K,Xt as a,zn as b,B as c,fe as d,we as e,Zt as f,Ce as g,u as h,ve as i,De as j,Se as k,Pn as l,g as m,He as n,me as o,Pe as p,Ee as q,N as r,Ae as s,R as t,Ue as u,Te as v,ze as w,Ve as x,be as y,$t as z};
