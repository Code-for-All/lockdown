...
`));class Fe extends g{constructor(){super(),this.state={totals:{}}}async componentDidUpdate(t){if(this.props.selectedDate!==t.selectedDate){const{startDate:t,endDate:e,selectedDate:n}=this.props;this.setState({totals:await Ie.getTotals({date:n,startDate:t,endDate:e})})}}async componentDidMount(){A("(min-width: 900px)",t=>{this.setState({desktop:t})});const t=await Ie.getTotals({date:this.props.selectedDate,startDate:this.props.startDate,endDate:this.props.endDate});this.setState({totals:t})}render({selectedDate:t,i18n:e},{totals:n,desktop:a}){var r,o;const i=[{description:e.t("header.totals.territoriesLockdown"),value:Number((null===(r=n.territories)||void 0===r?void 0:r.lockdown)||0).toLocaleString()},{description:e.t("header.totals.peopleAffected"),value:Number((null===(o=n.territories)||void 0===o?void 0:o.affected)||0).toLocaleString()}];return u("div",{class:Re},u("dl",null,(a?i:i.slice(0,2)).map(t=>u("div",null,u("dt",{class:"ld-font-light"},t.description),u("dd",{class:"ld-font-front"},t.value)))))}}let Ze;const Ye=B(Ze||(Ze=(t=>t)`
  @keyframes fadeOutUp {
    from {
      opacity: 1;
    }
...
`));let On;const Bn={new_entry:"new entry",announcement:"announcement",rectification:"rectification",promoting_project:"project promotion",promoting_petition:"petition"};function In(){var t,e;const[n,a]=rn(void 0);return on(async()=>{const t=await An.getUpdates();a(t)},[]),navigator.onLine||"success"===(null==n?void 0:n.status)?!n&&navigator.onLine?u("div",{class:Wn},re):"failed"===n.status&&navigator.onLine?u("div",{style:"margin-top: 14px;"},"An error occured while fetching updates."):u("div",{class:Nn},u("ul",null,null==n||null===(t=n.data)||void 0===t||null===(e=t.updates)||void 0===e?void 0:e.map(t=>u("li",null,u("div",{class:"ld-ticker--bar"},u("div",{class:"ld-ticker--dot-container"},u("div",{"aria-label":Bn[t.type.toLowerCase()],class:"ld-ticker--dot "+t.type.toLowerCase()})),u("div",{class:"ld-ticker--line"})),u("div",{class:"ld-ticker--content"},u("div",{class:"ld-ticker--title"},t.title),u("div",{class:"ld-ticker--content"},t.content),t.link?u("div",{class:"ld-ticker--link"},u("a",{target:"_blank",rel:"noopener noreferer",href:t.link},"Source")):"",u("div",{class:"ld-ticker--date"},t.date)))))):u("div",{class:Vn},ae,u("b",null,"You are not connected to the internet"),u("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."))}const Nn=B(On||(On=(t=>t)`
  & ul {
    list-style: none;
    margin: 0;
    padding: 20px 0 0 0;
