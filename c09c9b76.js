...
`)),Ce=()=>[h("a",{class:"skiplink",href:"#main"},"Go to main content"),h("header",{class:xe},h("div",{class:"ld-logo-wrapper"},h("a",{href:"","aria-current":"page"},h("p",null,"ALPHA"),se)),h("div",{class:"totals"},h(J,null)))];var Le,Ae,Se,Me=0,ze=[],Ee=t.__r,Pe=t.diffed,je=t.__c,He=t.unmount;function De(e,a){t.__h&&t.__h(Ae,e,Me||a),Me=0;var n=Ae.__H||(Ae.__H={__:[],__h:[]});return e>=n.__.length&&n.__.push({}),n.__[e]}function Te(e){return Me=1,function(e,t,a){var n=De(Le++,2);return n.__c||(n.__c=Ae,n.__=[a?a(t):We(void 0,t),function(t){var a=e(n.__[0],t);n.__[0]!==a&&(n.__[0]=a,n.__c.setState({}))}]),n.__}(We,e)}function Ie(e,a){var n=De(Le++,3);!t.__s&&Oe(n.__H,a)&&(n.__=e,n.__H=a,Ae.__H.__h.push(n))}function qe(e){return Me=5,function(e,t){var a=De(Le++,7);return Oe(a.__H,t)?(a.__H=t,a.__h=e,a.__=e()):a.__}((function(){return{current:e}}),[])}function Ue(){ze.some((function(e){if(e.__P)try{e.__H.__h.forEach(Re),e.__H.__h.forEach(Ne),e.__H.__h=[]}catch(a){return e.__H.__h=[],t.__e(a,e.__v),!0}})),ze=[]}function Re(e){e.t&&e.t()}function Ne(e){var t=e.__();"function"==typeof t&&(e.t=t)}function Oe(e,t){return!e||t.some((function(t,a){return t!==e[a]}))}function We(e,t){return"function"==typeof t?t(e):t}function Ve(e,t){for(var a in e)if("__source"!==a&&!(a in t))return!0;for(var n in t)if("__source"!==n&&e[n]!==t[n])return!0;return!1}t.__r=function(e){Ee&&Ee(e),Le=0,(Ae=e.__c).__H&&(Ae.__H.__h.forEach(Re),Ae.__H.__h.forEach(Ne),Ae.__H.__h=[])},t.diffed=function(e){Pe&&Pe(e);var a=e.__c;if(a){var n=a.__H;n&&n.__h.length&&(1!==ze.push(a)&&Se===t.requestAnimationFrame||((Se=t.requestAnimationFrame)||function(e){var t,a=function(){clearTimeout(n),cancelAnimationFrame(t),setTimeout(e)},n=setTimeout(a,100);"undefined"!=typeof window&&(t=requestAnimationFrame(a))})(Ue))}},t.__c=function(e,a){a.some((function(e){try{e.__h.forEach(Re),e.__h=e.__h.filter((function(e){return!e.__||Ne(e)}))}catch(n){a.some((function(e){e.__h&&(e.__h=[])})),a=[],t.__e(n,e.__v)}})),je&&je(e,a)},t.unmount=function(e){He&&He(e);var a=e.__c;if(a){var n=a.__H;if(n)try{n.__.forEach((function(e){return e.t&&e.t()}))}catch(e){t.__e(e,a.__v)}}};!function(e){var t,a;function n(t){var a;return(a=e.call(this,t)||this).isPureReactComponent=!0,a}a=e,(t=n).prototype=Object.create(a.prototype),t.prototype.constructor=t,t.__proto__=a,n.prototype.shouldComponentUpdate=function(e,t){return Ve(this.props,e)||Ve(this.state,t)}}(g);var $e=t.__b;t.__b=function(e){e.type&&e.type.t&&e.ref&&(e.props.ref=e.ref,e.ref=null),$e&&$e(e)};var Fe=t.__e;function Be(e){return e&&((e=function(e,t){for(var a in t)e[a]=t[a];return e}({},e)).__c=null,e.__k=e.__k&&e.__k.map(Be)),e}function Ye(){this.__u=0,this.o=null,this.__b=null}function Ge(e){var t=e.__.__c;return t&&t.u&&t.u(e)}function Qe(){this.i=null,this.l=null}t.__e=function(e,t,a){if(e.then)for(var n,r=t;r=r.__;)if((n=r.__c)&&n.__c)return n.__c(e,t.__c);Fe(e,t,a)},(Ye.prototype=new g).__c=function(e,t){var a=this;null==a.o&&(a.o=[]),a.o.push(t);var n=Ge(a.__v),r=!1,o=function(){r||(r=!0,n?n(s):s())};t.__c=t.componentWillUnmount,t.componentWillUnmount=function(){o(),t.__c&&t.__c()};var s=function(){var e;if(!--a.__u)for(a.__v.__k[0]=a.state.u,a.setState({u:a.__b=null});e=a.o.pop();)e.forceUpdate()};a.__u++||a.setState({u:a.__b=a.__v.__k[0]}),e.then(o,o)},Ye.prototype.render=function(e,t){return this.__b&&(this.__v.__k[0]=Be(this.__b),this.__b=null),[h(g,null,t.u?null:e.children),t.u&&e.fallback]};var Ze=function(e,t,a){if(++a[1]===a[0]&&e.l.delete(t),e.props.revealOrder&&("t"!==e.props.revealOrder[0]||!e.l.size))for(a=e.i;a;){for(;a.length>3;)a.pop()();if(a[1]<a[0])break;e.i=a=a[2]}};(Qe.prototype=new g).u=function(e){var t=this,a=Ge(t.__v),n=t.l.get(e);return n[0]++,function(r){var o=function(){t.props.revealOrder?(n.push(r),Ze(t,e,n)):r()};a?a(o):o()}},Qe.prototype.render=function(e){this.i=null,this.l=new Map;var t=k(e.children);e.revealOrder&&"b"===e.revealOrder[0]&&t.reverse();for(var a=t.length;a--;)this.l.set(t[a],this.i=[1,0,this.i]);return e.children},Qe.prototype.componentDidUpdate=Qe.prototype.componentDidMount=function(){var e=this;e.l.forEach((function(t,a){Ze(e,a,t)}))};!function(){function e(){}var t=e.prototype;t.getChildContext=function(){return this.props.context},t.render=function(e){return e.children}}();var Ke=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;g.prototype.isReactComponent={};var Xe="undefined"!=typeof Symbol&&Symbol.for&&Symbol.for("react.element")||60103,Je=t.event;function et(e,t){e["UNSAFE_"+t]&&!e[t]&&Object.defineProperty(e,t,{configurable:!1,get:function(){return this["UNSAFE_"+t]},set:function(e){this["UNSAFE_"+t]=e}})}t.event=function(e){Je&&(e=Je(e)),e.persist=function(){};var t=!1,a=!1,n=e.stopPropagation;e.stopPropagation=function(){n.call(e),t=!0};var r=e.preventDefault;return e.preventDefault=function(){r.call(e),a=!0},e.isPropagationStopped=function(){return t},e.isDefaultPrevented=function(){return a},e.nativeEvent=e};var tt={configurable:!0,get:function(){return this.class}},at=t.vnode;t.vnode=function(e){e.$$typeof=Xe;var t=e.type,a=e.props;if(t){if(a.class!=a.className&&(tt.enumerable="className"in a,null!=a.className&&(a.class=a.className),Object.defineProperty(a,"className",tt)),"function"!=typeof t){var n,r,o;for(o in a.defaultValue&&void 0!==a.value&&(a.value||0===a.value||(a.value=a.defaultValue),delete a.defaultValue),Array.isArray(a.value)&&a.multiple&&"select"===t&&(k(a.children).forEach((function(e){-1!=a.value.indexOf(e.props.value)&&(e.props.selected=!0)})),delete a.value),a)if(n=Ke.test(o))break;if(n)for(o in r=e.props={},a)r[Ke.test(o)?o.replace(/[A-Z0-9]/,"-$&").toLowerCase():o]=a[o]}!function(t){var a=e.type,n=e.props;if(n&&"string"==typeof a){var r={};for(var o in n)/^on(Ani|Tra|Tou)/.test(o)&&(n[o.toLowerCase()]=n[o],delete n[o]),r[o.toLowerCase()]=o;if(r.ondoubleclick&&(n.ondblclick=n[r.ondoubleclick],delete n[r.ondoubleclick]),r.onbeforeinput&&(n.onbeforeinput=n[r.onbeforeinput],delete n[r.onbeforeinput]),r.onchange&&("textarea"===a||"input"===a.toLowerCase()&&!/^fil|che|ra/i.test(n.type))){var s=r.oninput||"oninput";n[s]||(n[s]=n[r.onchange],delete n[r.onchange])}}}(),"function"==typeof t&&!t.m&&t.prototype&&(et(t.prototype,"componentWillMount"),et(t.prototype,"componentWillReceiveProps"),et(t.prototype,"componentWillUpdate"),t.m=!0)}at&&at(e)};let nt;function rt(e){const[t,a]=Te(!1),n=qe(null);return Ie(()=>{t&&n.current.focus({preventScroll:!0})},[t]),h("div",{class:ot},h("div",{class:"ld-expandable"},h("button",{onClick:()=>a(!t),class:"ld-expandable--toggle","aria-expanded":t},h("div",{class:"ld-expandable--icon"},t?lt:st),h("div",{class:"ld-expandable--toggle-content"},h("h2",null,e.toggle))),h("div",{ref:n,class:"ld-expandable--detail "+(t?"ld-expandable--expanded":"ld-expandable--closed"),role:"region",tabindex:"-1"},e.detail)))}const ot=N(nt||(nt=(e=>e)`
  .ld-expandable {
    width: 100%;
    height: auto;
...
`)),st=h("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-right",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},h("path",{stroke:"none",d:"M0 0h24v24H0z"}),h("polyline",{points:"9 6 15 12 9 18"})),lt=h("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-down",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},h("path",{stroke:"none",d:"M0 0h24v24H0z"}),h("polyline",{points:"6 9 12 15 18 9"})),it={url:new URL("./src/services/updatesService.js",document.baseURI).href};const ct=new class extends O{async getUpdates(e){if(e||!this.updates)try{this.updates=await fetch(new URL("../../data/updates.json",it.url)).then(e=>e.json()),await this.updates}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:this.updates}}};let dt,ut,ht=e=>e;const pt=N(dt||(dt=ht`
  & {
    display: flex;
    align-items: center;
...
`));let gt;const _t={new_entry:"new entry",announcement:"announcement",rectification:"rectification",promoting_project:"project promotion",promoting_petition:"petition"};function vt(){var e,t;const[a,n]=Te(void 0);return Ie(async()=>{const e=await ct.getUpdates();n(e)},[]),navigator.onLine||"success"===(null==a?void 0:a.status)?!a&&navigator.onLine?h("div",{class:pt},ie):"failed"===a.status&&navigator.onLine?h("div",{style:"margin-top: 14px;"},"An error occured while fetching updates."):h("div",{class:mt},h("ul",null,null==a||null===(e=a.data)||void 0===e||null===(t=e.updates)||void 0===t?void 0:t.map(e=>h("li",null,h("div",{class:"ld-ticker--bar"},h("div",{class:"ld-ticker--dot-container"},h("div",{"aria-label":_t[e.type.toLowerCase()],class:"ld-ticker--dot "+e.type.toLowerCase()})),h("div",{class:"ld-ticker--line"})),h("div",{class:"ld-ticker--content"},h("div",{class:"ld-ticker--title"},e.title),h("div",{class:"ld-ticker--content"},e.content),e.link?h("div",{class:"ld-ticker--link"},h("a",{target:"_blank",rel:"noopener noreferer",href:e.link},"Source")):"",h("div",{class:"ld-ticker--date"},e.date)))))):h("div",{class:ft},le,h("b",null,"You are not connected to the internet"),h("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."))}const mt=N(gt||(gt=(e=>e)`
  & ul {
    list-style: none;
    margin: 0;
    padding: 20px 0 0 0;
...
`));function bt(e){let t;"serviceWorker"in navigator&&navigator.serviceWorker.getRegistration().then(a=>{a&&(a.addEventListener("updatefound",()=>{t=a.installing,t.addEventListener("statechange",()=>{"installed"===t.state&&navigator.serviceWorker.controller&&e(!0)})}),a.waiting&&navigator.serviceWorker.controller&&(e(!0),t=a.waiting))})}function wt(e){const[t,a]=[...document.querySelectorAll("link[rel='icon']")],n=document.querySelector("link[rel='manifest']"),r=document.querySelector("meta[name='theme-color']");e?(n.href="/manifest-dark.json",t.href="src/assets/favicon-32x32-dark.png",a.href="src/assets/favicon-16x16-dark.png",r.setAttribute("content","#303136")):(n.href="/manifest.json",t.href="src/assets/favicon-32x32.png",a.href="src/assets/favicon-16x16.png",r.setAttribute("content","#ffffff")),document.getElementsByTagName("head")[0].appendChild(n),document.getElementsByTagName("head")[0].appendChild(t),document.getElementsByTagName("head")[0].appendChild(a),document.getElementsByTagName("head")[0].appendChild(r)}let kt,yt;window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),yt=!0,kt=e});class xt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).innerHTML="<slot><button>Install</button></slot>"}connectedCallback(){this.setAttribute("hidden",""),this.addEventListener("click",this._handlePrompt.bind(this)),window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),kt=e,this.removeAttribute("hidden"),this.dispatchEvent(new CustomEvent("pwa-installable",{detail:!0}))}),yt&&this.removeAttribute("hidden")}async _handlePrompt(e){e.preventDefault(),kt.prompt();const{outcome:t}=await kt.userChoice;"accepted"===t?(this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!0})),this.setAttribute("hidden",""),kt=null):this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!1}))}}customElements.define("pwa-install-button",xt);class Ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).innerHTML="<slot><button>New update available!</button></slot>",this._refreshing=!1}async connectedCallback(){this.addEventListener("click",this._postMessage.bind(this)),navigator.serviceWorker.addEventListener("controllerchange",()=>{this._refreshing||(window.location.reload(),this._refreshing=!0)})}async _postMessage(e){e.preventDefault(),(await navigator.serviceWorker.getRegistration()).waiting.postMessage({type:"SKIP_WAITING"})}}customElements.define("pwa-update-available",Ct);let Lt;const At=N(Lt||(Lt=(e=>e)`
  & {
    padding-top: 20px;
  }
...
`)),jt=e=>{switch(e){case"info":return{title:"info",template:[h("h1",null,"Lockdown"),h("p",{class:"ld-alpha"},"Project lockdown is currently in alpha. Not all data may be available yet."),h("p",null,h("b",null,"Project Lockdown")," aims to map the different lockdowns around the world, offering the public a number of relevant metrics\n            in order to provide an overview of the restrictions applied worldwide. We hope this will help evaluate the seriousness of the\n            COVID-19 pandemic and help journalists and Human Rights defenders in their reporting and overseeing tasks."),h(rt,{toggle:"About",detail:h("p",null,"While lockdowns generally help countries to flatten the curve, and prevent COVID-19 from spreading, countries with a\n                dictatorial nature may see this as an opportunity to increase their grasp over a country, and even potentially lead to\n                martial law type scenarios. Governments may unnecesarily prolong lockdowns or not stick to their announced end dates for\n                political gain. ",h("b",null,"Project Lockdown")," aims to visualize these situations.")}),h(rt,{toggle:"Legend",detail:[h("p",null,"The map shows two parameters for territories:"),h("ol",null,h("li",null,"If the country is under any type of lockdown"),h("li",null,"If there are covid cases in the country")),h("table",{class:Pt},h("tr",null,h("th",{scope:"col"}),h("th",{scope:"col"},"Lockdown"),h("th",{scope:"col"},"COVID-19")),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"blue",class:"blue circle"})),h("td",null,h("div",{"aria-label":"no"},re)),h("td",null,h("div",{"aria-label":"no"},re))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"green",class:"green circle"})),h("td",null,h("div",{"aria-label":"no"},re)),h("td",null,h("div",{"aria-label":"yes"},oe))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"yellow",class:"yellow circle"})),h("td",null,h("div",{"aria-label":"yes"},oe)),h("td",null,h("div",{"aria-label":"no"},re))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"red",class:"red circle"})),h("td",null,h("div",{"aria-label":"yes"},oe)),h("td",null,h("div",{"aria-label":"yes"},oe))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"gray",class:"default circle"})),h("td",null,"No Data",h("p",{class:"note"},"(please contribute)")),h("td",null,"No Data",h("p",{class:"note"},"(please contribute)"))))]}),h(rt,{toggle:"Sources",detail:h("p",null,h("b",null,"Project Lockdown")," uses a variety of sources to compile all the information showcased. We make sure to only consider sources that are reliable and verifiable.\n                You can check all the ",h("a",{rel:"noopener noreferrer",target:"_blank",href:"https://www.TIOF.Click/LockdownData"},"sources")," employed here:",h("ul",{class:"ld-sources"},h("li",null,h("a",{rel:"noopener noreferrer",target:"_blank",href:"https://api.coronatracker.com/"},"Coronatracker API"),h("br",null),"Recognized by ",h("a",{rel:"noopener noreferrer",target:"_blank",href:"https://www.who.int/bulletin/online_first/COVID-19/en/"},"WHO")),h("li",null,"For reference data see the ",h("b",null,"Data Sources")," Tab."),h("li",null,"For country data see the ",h("b",null,"Find the Countries")," Tab by it's ISO Alpha 3 code.\n                    (Quick find through Global Tab)")),"If you find any errors, please help us and report it ",h("a",{rel:"noopener noreferrer",target:"_blank",href:"https://github.com/Code-for-All/lockdown/issues"},"by creating an issue here"),".")}),h(rt,{toggle:"Credits",detail:h("p",null,h("b",null,"Project Lockdown")," is a Civic Tech initiative from a number of organizations and individuals. You can find the",h("a",{rel:"noopener noreferrer",target:"_blank",href:"https://www.TIOF.Click/LockdownData"},"list of project members")," here\n                under the ",h("b",null,"Credits")," tab.")}),h(rt,{toggle:"Data & Privacy",detail:[h("p",null,"We do not collect any information from our visitors."),h("p",null,"All information from any project member shown anywhere in the application is under their prior consent.")]})]};case"settings":return{title:"settings",template:[" ",h(St,null)," "]};case"contribute":return{title:"contribute",template:[h("p",null,h("b",null,"Project Lockdown")," is made possible by the contribution of many individuals who are giving their time to make possible that everyone has access to the right information."),h("p",null,"Do you have any information you want to contribute? Please follow this link:"),h("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://docs.google.com/forms/d/e/1FAIpQLSfDWe2qlzUnd3e-YYspMzT9adUswDEYIdJMb7jz7ule34-yiA/viewform"},"Submit data"),h("p",null,"Additionally, you can become part of the project by joining one of the following teams:",h("ul",null,h("li",null,"Editors"),h("li",null,"Devs"),h("li",null,"UI/UX"))),h("p",null,"Contact us via Telegram at:",h("br",null),h("a",{class:"ld-link"},"@ProjectLockdown"))]};case"updates":return{title:"updates",template:[" ",h(vt,null)," "]};default:return{title:"",template:void 0}}};class Ht extends g{constructor(e){super(e),this.state={activeItem:"info"},this.switchContent=this.switchContent.bind(this)}componentDidMount(){let e=0;H("(min-width: 960px)",t=>{this.setState({isMobile:!t}),t&&e>0&&(e++,this.props.close())})}switchContent(e){if("settings"===e&&this.state.updateAvailable&&this.setState({updateAvailable:!1}),this.state.isMobile&&this.props.opened&&e===this.prevVal)return this.props.close(),this.setState({activeItem:this.prevVal}),void(this.prevVal="");this.props.changeRoute(jt(e)),this.prevVal=e,this.setState({activeItem:e})}render(e,{activeItem:t,updateAvailable:a}){return h("main",{id:"main",class:"ld-menu"},h("div",{class:"ld-menu-nav"},h("nav",null,h(zt,{switchContent:this.switchContent},h("button",{id:"info"},"info"),h("button",{id:"settings"},"settings"),h("button",{id:"updates"},"updates"),h("button",{id:"contribute"},"contribute")))),h("div",{class:"ld-menu--content"},h("div",{class:"mb-only"},h("div",{class:"ld-menu--header"},h("h1",null,t))),jt(t).template))}}class Dt extends g{async componentWillMount(){const e=await this.props.component(),t=e.default||e;this.setState({Component:t})}render({props:e},{Component:t}){return h(t,e)}}var Tt="object"==typeof global&&global&&global.Object===Object&&global,It="object"==typeof self&&self&&self.Object===Object&&self,qt=Tt||It||Function("return this")(),Ut=qt.Symbol,Rt=Object.prototype,Nt=Rt.hasOwnProperty,Ot=Rt.toString,Wt=Ut?Ut.toStringTag:void 0;var Vt=Object.prototype.toString;var $t=Ut?Ut.toStringTag:void 0;function Ft(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":$t&&$t in Object(e)?function(e){var t=Nt.call(e,Wt),a=e[Wt];try{e[Wt]=void 0;var n=!0}catch(e){}var r=Ot.call(e);return n&&(t?e[Wt]=a:delete e[Wt]),r}(e):function(e){return Vt.call(e)}(e)}function Bt(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)}var Yt=/^\s+|\s+$/g,Gt=/^[-+]0x[0-9a-f]+$/i,Qt=/^0b[01]+$/i,Zt=/^0o[0-7]+$/i,Kt=parseInt;function Xt(e){if("number"==typeof e)return e;if(function(e){return"symbol"==typeof e||function(e){return null!=e&&"object"==typeof e}(e)&&"[object Symbol]"==Ft(e)}(e))return NaN;if(Bt(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=Bt(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(Yt,"");var a=Qt.test(e);return a||Zt.test(e)?Kt(e.slice(2),a?2:8):Gt.test(e)?NaN:+e}var Jt=function(){return qt.Date.now()},ea=Math.max,ta=Math.min;let aa;const na=function(e,t,a){var n,r,o,s,l,i,c=0,d=!1,u=!1,h=!0;if("function"!=typeof e)throw new TypeError("Expected a function");function p(t){var a=n,o=r;return n=r=void 0,c=t,s=e.apply(o,a)}function f(e){return c=e,l=setTimeout(_,t),d?p(e):s}function g(e){var a=e-i;return void 0===i||a>=t||a<0||u&&e-c>=o}function _(){var e=Jt();if(g(e))return v(e);l=setTimeout(_,function(e){var a=t-(e-i);return u?ta(a,o-(e-c)):a}(e))}function v(e){return l=void 0,h&&n?p(e):(n=r=void 0,s)}function m(){var e=Jt(),a=g(e);if(n=arguments,r=this,i=e,a){if(void 0===l)return f(i);if(u)return clearTimeout(l),l=setTimeout(_,t),p(i)}return void 0===l&&(l=setTimeout(_,t)),s}return t=Xt(t)||0,Bt(a)&&(d=!!a.leading,o=(u="maxWait"in a)?ea(Xt(a.maxWait)||0,t):o,h="trailing"in a?!!a.trailing:h),m.cancel=function(){void 0!==l&&clearTimeout(l),c=0,n=i=r=l=void 0},m.flush=function(){return void 0===l?s:v(Jt())},m}(()=>{let e={menuDialogClosed:!1,countryDialogClosed:!1};const t=new URLSearchParams(location.search);t.has("country")||t.has("iso2")?e.countryDialogClosed=!0:e.menuDialogClosed=!0,V.close(e)},10,{leading:!0,trailing:!1}),ra=N(aa||(aa=(e=>e)`
  & {
    position: fixed;
    z-index: 1100;
    top: 74px;
...
`));("requestIdleCallback"in window?window.requestIdleCallback:e=>setTimeout(e,1e3))(()=>{import("./34c15c53.js"),import("./a681ce47.js")}),console.log("🌐 Project Lockdown, version: 0.0.0"),window.addEventListener("appinstalled",()=>{window.location.reload()}),H("(prefers-color-scheme: dark)",e=>{const t=localStorage.getItem("darkmode");null!==t?"true"===t&&(document.documentElement.classList.add("dark"),wt(!0)):e?(document.documentElement.classList.add("dark"),wt(!0)):(document.documentElement.classList.remove("dark"),wt(!1))}),function(e,a,n){var r,o,c;t.__&&t.__(e,a),o=(r=n===s)?null:n&&n.__k||a.__k,e=h(f,null,[e]),c=[],L(a,(r?a:n||a).__k=e,o||l,l,void 0!==a.ownerSVGElement,n&&!r?[n]:o?null:i.slice.call(a.childNodes),c,n||l,r),A(c,e)}([" ",h(class extends g{constructor(){super(),this.state={dialog:{opened:!1,template:{},title:""}},this.__onPathChanged=this.__onPathChanged.bind(this),this.__closeCountryInfo=this.__closeCountryInfo.bind(this),this.__closeDialog=this.__closeDialog.bind(this),this.__showDialog=this.__showDialog.bind(this),this.__showDialogRoute=this.__showDialogRoute.bind(this)}async componentDidMount(){this.__onPathChanged(),H("(min-width: 960px)",e=>{this.setState({isMobile:!e})})}componentWillMount(){W.addEventListener("path-changed",this.__onPathChanged)}componentWillUnmount(){W.removeEventListener("path-changed",this.__onPathChanged)}render(){return[h(Ce,null),h("div",{class:ra},h(J,null)),h(Ht,{opened:this.state.dialog.opened,changeRoute:this.__showDialogRoute,close:this.__closeDialog}),h(G,null),this.state.dialog.opened?h(Dt,{component:()=>import("./34c15c53.js"),props:{...this.state.dialog,onClose:this.__closeDialog}}):""]}__showDialogRoute({template:e,title:t}){const a=W.url.searchParams.get("country");a?W.setPath(`${t}?country=${a}`):W.setPath(t),this.state.isMobile&&(W.setSearchParam("country",null),this.__showDialog({template:e,title:t}))}__onPathChanged(){const e=W.url.searchParams.get("country"),t=W.url.searchParams.get("iso2");e&&t&&this.setState({dialog:{opened:!0,template:[" ",h(Dt,{component:()=>import("./a681ce47.js"),props:{country:e,iso2:t}})," "],title:e}})}__showDialog({template:e,title:t}){this.setState({dialog:{opened:!0,template:e,title:t}})}__closeCountryInfo(){W.setSearchParam("country",void 0),W.setSearchParam("iso2",void 0)}__closeDialog(){this.setState({dialog:{opened:!1,template:"",title:""}}),na(),this.__closeCountryInfo()}},null)," "],document.getElementById("app"));export{O as E,re as a,ft as b,N as c,he as d,pe as e,fe as f,_e as g,h,ve as i,be as j,we as k,pt as l,g as m,ke as n,le as o,ie as p,ue as q,W as r,me as s,de as t,ce as u,ge as w};
