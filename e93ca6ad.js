import{E as t,f as e,c as a,m as s,h as i,o,a as l,l as r,b as n,s as d,d as c,e as u,r as h,g as p,w as v,i as g,j as b,k as m,n as f,p as x,t as y,q as w,u as _}from"./39098dfc.js";const k={url:new URL("./src/services/coronastatusService.js",document.baseURI).href};new class extends t{async getCoronaStatus(t){return!t&&this.__coronastatus||(this.__coronastatus=fetch(new URL("../../data/coronastatus.json",k.url)).then(t=>t.json()),await this.__coronastatus,this.dispatchEvent(new Event("change"))),this.__coronastatus}};const E=new class extends t{constructor(){super(),this.cache={}}async getCountry(t){var e;let{iso2:a,date:s}=t;if(a=encodeURI(a),/^[a-zA-Z]{2}$/.test(a)){if(t.forceRefresh||this._shouldInvalidate()||"failed"===(null===(e=this.cache[a])||void 0===e?void 0:e.status)||!this.cache[a]){try{var i,o,l,r,n,d;this.cache[a]={};const t=await(await fetch("https://api.coronatracker.com/v3/stats/worldometer/country?countryCode="+a)).json();return this.cache[a]={status:"success",totalConfirmed:null!==(i=null===(o=t[0])||void 0===o?void 0:o.totalConfirmed)&&void 0!==i?i:0,totalDeaths:null!==(l=null===(r=t[0])||void 0===r?void 0:r.totalDeaths)&&void 0!==l?l:0,totalRecovered:null!==(n=null===(d=t[0])||void 0===d?void 0:d.totalRecovered)&&void 0!==n?n:0},this.__lastUpdate=Date.now(),this.cache[a]}catch{this.cache[a]={status:"failed"}}return this.dispatchEvent(new Event("change")),this.cache[a]}return this.cache[a]}}},L={url:new URL("./src/services/countryDetailService.js",document.baseURI).href};const C=new class extends t{constructor(){super(),this.cache={}}async getDetails(t){var a;let{iso2:s,date:i}=t;if(s=encodeURI(s),!/^[a-zA-Z]{2}$/.test(s))return;let o=""+s;if(t.forceRefresh||this._shouldInvalidate()||"failed"===(null===(a=this.cache[o])||void 0===a?void 0:a.status)||!this.cache[o])try{this.cache[o]={};const t=await(await fetch(new URL(`../../data/territories/${s}.json`,L.url))).json();this.cache[o]=t}catch(t){this.cache[o]={status:"failed"}}var l=this.cache[o];if("failed"===l.status)return this.dispatchEvent(new Event("change")),l;const r={};var n=l[e(i,"yyyy-MM-dd")];for(const t of Object.keys(n.lockdown.travel))for(const{label:e,value:a}of n.lockdown.travel[t])Array.isArray(r[e])?r[e].push(a):r[e]=[a];var d={status:"success",date:n.lockdown.date,measures:n.lockdown.measures,travel:r,max_gathering:n.lockdown.max_gathering};return this.__lastUpdate=Date.now(),this.dispatchEvent(new Event("change")),d}},D={url:new URL("./src/services/populationService.js",document.baseURI).href};const R=new class extends t{constructor(){super(),this.cache={}}async getPopulation(t){var e;if(t||!this.__population)try{this.__population=await fetch(new URL("../../data/population.json",D.url)).then(t=>t.json()),await this.__population}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:null!==(e=this.__population)&&void 0!==e?e:0}}};new class extends t{constructor(){super(),this.cache={}}async getAdvice(t){var e;let{iso2:a}=t;if(a=encodeURI(a),/^[a-zA-Z]{2}$/.test(a)){if(t.forceRefresh||"failed"===(null===(e=this.cache[a])||void 0===e?void 0:e.status)||!this.cache[a]){try{this.cache[a]={};const t=await(await fetch("https://www.travel-advisory.info/api?countrycode="+a)).json();return this.cache[a]={status:"success",advice:t.data[a].advisory.message,score:t.data[a].advisory.score+"/5"},this.cache[a]}catch(t){this.cache[a]={status:"failed"}}return this.dispatchEvent(new Event("change")),this.cache[a]}return this.cache[a]}}};let A,S,j,U=t=>t;const I=a(A||(A=U`
  &{
    width: 100%;
    display: flex;
    position: relative;
