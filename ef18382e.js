...
`)),Gt={asia:{lng:95.955971,lat:21.916222,zoom:2.8},europe:{lng:52.160455,lat:10.371094,zoom:4},usa:{lng:45.089036,lat:-100.898438,zoom:3},africa:{lng:21.525828,lat:4.214943,zoom:3.2}};function Qt(t){let e;switch(t){case"1":e="#eb5757";break;case"2":e="#f2994a";break;case"3":e="#6fcf97";break;case"4":e="#7aaeff";break;default:e="#CCCCCC"}return e}function Xt(t){let e={};for(let n in t)for(let a in t[n].data)for(let r in t[n].data[a]){let o=t[n].data[a][r];"all"!==a&&"US"!==a||(e[o.unit_code]=o)}return e}class Jt extends g{constructor(){super(),this.__handleSelect=this.__handleSelect.bind(this),this.initMap=this.initMap.bind(this),this.updateMap=this.updateMap.bind(this);let t={lng:0,lat:0,zoom:2},e=window.location.href,n=!1;for(let a in Gt)-1!=e.indexOf("lockdown."+a)&&(t=Gt[a],n=!0);this.state={lng:t.lng,lat:t.lat,zoom:t.zoom,countries:[],mapData:{},lookupTable:{},isMapReady:!1,isLocationSet:n}}setMapState(t,e=[],n){e.forEach((function(e){t.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:n[e.ISO].feature_id},{kind:e.lockdown_status,name:e.name})}))}async initMap(t,e){window.mapboxgl||(console.log("check the map"),await((t=100)=>new Promise(e=>{setTimeout(()=>{e()},t)}))(),await this.initMap(t,e));let n=new window.mapboxgl.Map({accessToken:"pk.eyJ1IjoiamZxdWVyYWx0IiwiYSI6ImNrOWZpZHF3ajBic2YzbHQwYzQ5bGRnaXgifQ.NcQInXQmMy93L47QBMCAfg",container:this.ref,style:"mapbox://styles/jfqueralt/ck9hi7wl616pz1iugty1cpeiv?optimize=true",center:[this.state.lng,this.state.lat],zoom:this.state.zoom});window.map=n;const a=t[this.props.selectedDate];n.on("style.load",()=>{let t=null;n.on("mousemove","admin-0-fill",(function(e){var a=n.queryRenderedFeatures(e.point,{layers:["admin-0-fill"]});e.features.length>0&&(t&&n.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:t},{hover:!1}),t=a[0].id,n.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:t},{hover:!0}))})),n.on("click","admin-0-fill",(function(t){const e=n.queryRenderedFeatures(t.point,{layers:["admin-0-fill"]});Ft.setSearchParam("country",e[0].state.name),Ft.setSearchParam("iso2",e[0].properties.iso_3166_1)})),console.log("the style is loaded")}),n.on("load",(function(){console.log("map is loaded"),r(e)}));const r=t=>{n.addSource("admin-0",{type:"vector",url:"mapbox://mapbox.boundaries-adm0-v3"});const e=Xt(t);n.addLayer({id:"admin-0-fill",type:"fill",source:"admin-0","source-layer":"boundaries_admin_0",filter:["any",["==","all",["get","worldview"]],["in","US",["get","worldview"]]],paint:{"fill-color":["case",["!=",["feature-state","kind"],null],["match",["feature-state","kind"],"1",Qt("1"),"2",Qt("2"),"3",Qt("3"),"4",Qt("4"),"#CCCCCC"],["case",["boolean",["feature-state","hover"],!1],"rgba(204,204,204,0.5)","rgba(204,204,204,0)"]],"fill-opacity":["case",["boolean",["feature-state","hover"],!1],.7,1]}},"waterway-label");const r=t=>{a.forEach((function(t){n.setFeatureState({source:"admin-0",sourceLayer:"boundaries_admin_0",id:e[t.ISO].feature_id},{kind:t.lockdown_status,name:t.name})})),this.setState({isMapReady:!0})};n.isSourceLoaded("admin-0")?r():n.on("sourcedata",(function t(e){"admin-0"===e.sourceId&&e.isSourceLoaded&&(r(),n.off("sourcedata",t))}))};return this.setState({map:n}),n}updateMap(t,e,n){const a=Xt(e),r=t[n];this.setMapState(this.state.map,r,a)}async componentDidMount(){Yt.addEventListener("close",t=>{t.detail.countryDialogClosed&&form.focus()});const[t,e]=await Promise.all([fetch(new URL("../../data/lockdown.json",Zt.url)).then(t=>t.json()),fetch(new URL("./../../data/boundaries-adm0-v3.json",Zt.url)).then(t=>t.json())]),n=t["2020-04-26"];if(this.setState({countries:n,mapData:t,lookupTable:e}),await this.initMap(t,e),navigator.permissions){const t=await navigator.permissions.query({name:"geolocation"});"granted"!==t.state||this.state.isLocationSet||navigator.geolocation.getCurrentPosition(t=>{const{latitude:e,longitude:n}=t.coords;this.state.map.setCenter([n,e]),this.setState({isLocationSet:!0})}),t.addEventListener("change",t=>{"granted"!==t.target.state||this.state.isLocationSet?localStorage.removeItem("geolocation"):navigator.geolocation.getCurrentPosition(t=>{localStorage.setItem("geolocation","true");const{latitude:e,longitude:n}=t.coords;this.state.map.setCenter([n,e]),this.setState({isLocationSet:!0})})})}}componentWillUnmount(){this.state.map&&this.state.map.remove()}__handleSelect(t){t.preventDefault();const[e,n]=this.selectRef.value.split(",");Ft.setSearchParam("country",n),Ft.setSearchParam("iso2",e)}__resetFocus(){this.countrySelectRef.focus()}render(){var t;return[h("div",{class:$t},h("form",{id:"form",tabindex:"-1",onSubmit:this.__handleSelect},h("label",{for:"countries"},"Choose a country:"),h("select",{ref:t=>this.selectRef=t,id:"countries"},null===(t=this.state.countries)||void 0===t?void 0:t.map(t=>h("option",{value:t.ISO+","+t.name},t.name))),h("input",{type:"submit",value:"View country details"}))),h("div",{class:"map-container",ref:t=>this.ref=t})]}componentDidUpdate(t,e,n){this.state.isMapReady&&this.updateMap(this.state.mapData,this.state.lookupTable,this.props.selectedDate)}}const Kt={url:new URL("./src/services/totalsService.js",document.baseURI).href};const te=new class extends It{async getTotals(t){return!t&&this.__totals||(this.__totals=fetch(new URL("../../data/totals.json",Kt.url)).then(t=>t.json()),await this.__totals,this.dispatchEvent(new Event("change"))),this.__totals}};let ee;const ne=O(ee||(ee=(t=>t)`
  dl {
    display: flex;
    height: 100%;
    padding: 0;
...
`)),Ve=t=>[h("a",{class:"skiplink",href:"#main"},"Go to main content"),h("header",{class:Ue},h("div",{class:"ld-logo-wrapper"},h("a",{href:"","aria-current":"page"},h("p",null,"BETA"),de)),h("div",{class:"totals"},h(ae,{selectedDate:t.selectedDate})))];var je,Ne,We,Oe=0,Be=[],Re=t.__r,Ie=t.diffed,Fe=t.__c,Ye=t.unmount;function qe(e,n){t.__h&&t.__h(Ne,e,Oe||n),Oe=0;var a=Ne.__H||(Ne.__H={__:[],__h:[]});return e>=a.__.length&&a.__.push({}),a.__[e]}function Ze(t){return Oe=1,function(t,e,n){var a=qe(je++,2);return a.__c||(a.__c=Ne,a.__=[n?n(e):tn(void 0,e),function(e){var n=t(a.__[0],e);a.__[0]!==n&&(a.__[0]=n,a.__c.setState({}))}]),a.__}(tn,t)}function $e(e,n){var a=qe(je++,3);!t.__s&&Ke(a.__H,n)&&(a.__=e,a.__H=n,Ne.__H.__h.push(a))}function Ge(t){return Oe=5,function(t,e){var n=qe(je++,7);return Ke(n.__H,e)?(n.__H=e,n.__h=t,n.__=t()):n.__}((function(){return{current:t}}),[])}function Qe(){Be.some((function(e){if(e.__P)try{e.__H.__h.forEach(Xe),e.__H.__h.forEach(Je),e.__H.__h=[]}catch(n){return e.__H.__h=[],t.__e(n,e.__v),!0}})),Be=[]}function Xe(t){t.t&&t.t()}function Je(t){var e=t.__();"function"==typeof e&&(t.t=e)}function Ke(t,e){return!t||e.some((function(e,n){return e!==t[n]}))}function tn(t,e){return"function"==typeof e?e(t):e}function en(t,e){for(var n in t)if("__source"!==n&&!(n in e))return!0;for(var a in e)if("__source"!==a&&t[a]!==e[a])return!0;return!1}t.__r=function(t){Re&&Re(t),je=0,(Ne=t.__c).__H&&(Ne.__H.__h.forEach(Xe),Ne.__H.__h.forEach(Je),Ne.__H.__h=[])},t.diffed=function(e){Ie&&Ie(e);var n=e.__c;if(n){var a=n.__H;a&&a.__h.length&&(1!==Be.push(n)&&We===t.requestAnimationFrame||((We=t.requestAnimationFrame)||function(t){var e,n=function(){clearTimeout(a),cancelAnimationFrame(e),setTimeout(t)},a=setTimeout(n,100);"undefined"!=typeof window&&(e=requestAnimationFrame(n))})(Qe))}},t.__c=function(e,n){n.some((function(e){try{e.__h.forEach(Xe),e.__h=e.__h.filter((function(t){return!t.__||Je(t)}))}catch(a){n.some((function(t){t.__h&&(t.__h=[])})),n=[],t.__e(a,e.__v)}})),Fe&&Fe(e,n)},t.unmount=function(e){Ye&&Ye(e);var n=e.__c;if(n){var a=n.__H;if(a)try{a.__.forEach((function(t){return t.t&&t.t()}))}catch(e){t.__e(e,n.__v)}}};!function(t){var e,n;function a(e){var n;return(n=t.call(this,e)||this).isPureReactComponent=!0,n}n=t,(e=a).prototype=Object.create(n.prototype),e.prototype.constructor=e,e.__proto__=n,a.prototype.shouldComponentUpdate=function(t,e){return en(this.props,t)||en(this.state,e)}}(g);var nn=t.__b;t.__b=function(t){t.type&&t.type.t&&t.ref&&(t.props.ref=t.ref,t.ref=null),nn&&nn(t)};var an=t.__e;function rn(t){return t&&((t=function(t,e){for(var n in e)t[n]=e[n];return t}({},t)).__c=null,t.__k=t.__k&&t.__k.map(rn)),t}function on(){this.__u=0,this.o=null,this.__b=null}function sn(t){var e=t.__.__c;return e&&e.u&&e.u(t)}function ln(){this.i=null,this.l=null}t.__e=function(t,e,n){if(t.then)for(var a,r=e;r=r.__;)if((a=r.__c)&&a.__c)return a.__c(t,e.__c);an(t,e,n)},(on.prototype=new g).__c=function(t,e){var n=this;null==n.o&&(n.o=[]),n.o.push(e);var a=sn(n.__v),r=!1,o=function(){r||(r=!0,a?a(i):i())};e.__c=e.componentWillUnmount,e.componentWillUnmount=function(){o(),e.__c&&e.__c()};var i=function(){var t;if(!--n.__u)for(n.__v.__k[0]=n.state.u,n.setState({u:n.__b=null});t=n.o.pop();)t.forceUpdate()};n.__u++||n.setState({u:n.__b=n.__v.__k[0]}),t.then(o,o)},on.prototype.render=function(t,e){return this.__b&&(this.__v.__k[0]=rn(this.__b),this.__b=null),[h(g,null,e.u?null:t.children),e.u&&t.fallback]};var cn=function(t,e,n){if(++n[1]===n[0]&&t.l.delete(e),t.props.revealOrder&&("t"!==t.props.revealOrder[0]||!t.l.size))for(n=t.i;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;t.i=n=n[2]}};(ln.prototype=new g).u=function(t){var e=this,n=sn(e.__v),a=e.l.get(t);return a[0]++,function(r){var o=function(){e.props.revealOrder?(a.push(r),cn(e,t,a)):r()};n?n(o):o()}},ln.prototype.render=function(t){this.i=null,this.l=new Map;var e=x(t.children);t.revealOrder&&"b"===t.revealOrder[0]&&e.reverse();for(var n=e.length;n--;)this.l.set(e[n],this.i=[1,0,this.i]);return t.children},ln.prototype.componentDidUpdate=ln.prototype.componentDidMount=function(){var t=this;t.l.forEach((function(e,n){cn(t,n,e)}))};!function(){function t(){}var e=t.prototype;e.getChildContext=function(){return this.props.context},e.render=function(t){return t.children}}();var dn=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;g.prototype.isReactComponent={};var un="undefined"!=typeof Symbol&&Symbol.for&&Symbol.for("react.element")||60103,hn=t.event;function pn(t,e){t["UNSAFE_"+e]&&!t[e]&&Object.defineProperty(t,e,{configurable:!1,get:function(){return this["UNSAFE_"+e]},set:function(t){this["UNSAFE_"+e]=t}})}t.event=function(t){hn&&(t=hn(t)),t.persist=function(){};var e=!1,n=!1,a=t.stopPropagation;t.stopPropagation=function(){a.call(t),e=!0};var r=t.preventDefault;return t.preventDefault=function(){r.call(t),n=!0},t.isPropagationStopped=function(){return e},t.isDefaultPrevented=function(){return n},t.nativeEvent=t};var fn={configurable:!0,get:function(){return this.class}},gn=t.vnode;t.vnode=function(t){t.$$typeof=un;var e=t.type,n=t.props;if(e){if(n.class!=n.className&&(fn.enumerable="className"in n,null!=n.className&&(n.class=n.className),Object.defineProperty(n,"className",fn)),"function"!=typeof e){var a,r,o;for(o in n.defaultValue&&void 0!==n.value&&(n.value||0===n.value||(n.value=n.defaultValue),delete n.defaultValue),Array.isArray(n.value)&&n.multiple&&"select"===e&&(x(n.children).forEach((function(t){-1!=n.value.indexOf(t.props.value)&&(t.props.selected=!0)})),delete n.value),n)if(a=dn.test(o))break;if(a)for(o in r=t.props={},n)r[dn.test(o)?o.replace(/[A-Z0-9]/,"-$&").toLowerCase():o]=n[o]}!function(e){var n=t.type,a=t.props;if(a&&"string"==typeof n){var r={};for(var o in a)/^on(Ani|Tra|Tou)/.test(o)&&(a[o.toLowerCase()]=a[o],delete a[o]),r[o.toLowerCase()]=o;if(r.ondoubleclick&&(a.ondblclick=a[r.ondoubleclick],delete a[r.ondoubleclick]),r.onbeforeinput&&(a.onbeforeinput=a[r.onbeforeinput],delete a[r.onbeforeinput]),r.onchange&&("textarea"===n||"input"===n.toLowerCase()&&!/^fil|che|ra/i.test(a.type))){var i=r.oninput||"oninput";a[i]||(a[i]=a[r.onchange],delete a[r.onchange])}}}(),"function"==typeof e&&!e.m&&e.prototype&&(pn(e.prototype,"componentWillMount"),pn(e.prototype,"componentWillReceiveProps"),pn(e.prototype,"componentWillUpdate"),e.m=!0)}gn&&gn(t)};let mn;function bn(t){const[e,n]=Ze(!1),a=Ge(null);return $e(()=>{e&&a.current.focus({preventScroll:!0})},[e]),h("div",{class:vn},h("div",{class:"ld-expandable"},h("button",{onClick:()=>n(!e),class:"ld-expandable--toggle","aria-expanded":e},h("div",{class:"ld-expandable--icon"},e?Cn:wn),h("div",{class:"ld-expandable--toggle-content"},h("h2",null,t.toggle))),h("div",{ref:a,class:"ld-expandable--detail "+(e?"ld-expandable--expanded":"ld-expandable--closed"),role:"region",tabindex:"-1"},t.detail)))}const vn=O(mn||(mn=(t=>t)`
  .ld-expandable {
    width: 100%;
    height: auto;
...
`)),wn=h("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-right",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},h("path",{stroke:"none",d:"M0 0h24v24H0z"}),h("polyline",{points:"9 6 15 12 9 18"})),Cn=h("svg",{xmlns:"http://www.w3.org/2000/svg",class:"icon icon-tabler icon-tabler-chevron-down",width:"24",height:"24",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",fill:"none","stroke-linecap":"round","stroke-linejoin":"round"},h("path",{stroke:"none",d:"M0 0h24v24H0z"}),h("polyline",{points:"6 9 12 15 18 9"})),xn={url:new URL("./src/services/updatesService.js",document.baseURI).href};const _n=new class extends It{async getUpdates(t){if(t||!this.updates)try{this.updates=await fetch(new URL("../../data/updates.json",xn.url)).then(t=>t.json()),await this.updates}catch{return{status:"failed"}}return this.dispatchEvent(new Event("change")),{status:"success",data:this.updates}}};let yn,kn,Mn=t=>t;const Ln=O(yn||(yn=Mn`
  & {
    display: flex;
    align-items: center;
...
`));let Dn;const Pn={new_entry:"new entry",announcement:"announcement",rectification:"rectification",promoting_project:"project promotion",promoting_petition:"petition"};function Tn(){var t,e;const[n,a]=Ze(void 0);return $e(async()=>{const t=await _n.getUpdates();a(t)},[]),navigator.onLine||"success"===(null==n?void 0:n.status)?!n&&navigator.onLine?h("div",{class:Ln},he):"failed"===n.status&&navigator.onLine?h("div",{style:"margin-top: 14px;"},"An error occured while fetching updates."):h("div",{class:zn},h("ul",null,null==n||null===(t=n.data)||void 0===t||null===(e=t.updates)||void 0===e?void 0:e.map(t=>h("li",null,h("div",{class:"ld-ticker--bar"},h("div",{class:"ld-ticker--dot-container"},h("div",{"aria-label":Pn[t.type.toLowerCase()],class:"ld-ticker--dot "+t.type.toLowerCase()})),h("div",{class:"ld-ticker--line"})),h("div",{class:"ld-ticker--content"},h("div",{class:"ld-ticker--title"},t.title),h("div",{class:"ld-ticker--content"},t.content),t.link?h("div",{class:"ld-ticker--link"},h("a",{target:"_blank",rel:"noopener noreferer",href:t.link},"Source")):"",h("div",{class:"ld-ticker--date"},t.date)))))):h("div",{class:Sn},ue,h("b",null,"You are not connected to the internet"),h("p",null,"Information for this country can't be displayed because you are currently offline. Please check your internet connection."))}const zn=O(Dn||(Dn=(t=>t)`
  & ul {
    list-style: none;
    margin: 0;
    padding: 20px 0 0 0;
...
`));function Hn(t){let e;"serviceWorker"in navigator&&navigator.serviceWorker.getRegistration().then(n=>{n&&(n.addEventListener("updatefound",()=>{e=n.installing,e.addEventListener("statechange",()=>{"installed"===e.state&&navigator.serviceWorker.controller&&t(!0)})}),n.waiting&&navigator.serviceWorker.controller&&(t(!0),e=n.waiting))})}function An(t){const[e,n]=[...document.querySelectorAll("link[rel='icon']")],a=document.querySelector("link[rel='manifest']"),r=document.querySelector("meta[name='theme-color']");t?(a.href="/manifest-dark.json",e.href="src/assets/favicon-32x32-dark.png",n.href="src/assets/favicon-16x16-dark.png",r.setAttribute("content","#303136")):(a.href="/manifest.json",e.href="src/assets/favicon-32x32.png",n.href="src/assets/favicon-16x16.png",r.setAttribute("content","#ffffff")),document.getElementsByTagName("head")[0].appendChild(a),document.getElementsByTagName("head")[0].appendChild(e),document.getElementsByTagName("head")[0].appendChild(n),document.getElementsByTagName("head")[0].appendChild(r)}let En,Un;window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),Un=!0,En=t});class Vn extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).innerHTML="<slot><button>Install</button></slot>"}connectedCallback(){this.setAttribute("hidden",""),this.addEventListener("click",this._handlePrompt.bind(this)),window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),En=t,this.removeAttribute("hidden"),this.dispatchEvent(new CustomEvent("pwa-installable",{detail:!0}))}),Un&&this.removeAttribute("hidden")}async _handlePrompt(t){t.preventDefault(),En.prompt();const{outcome:e}=await En.userChoice;"accepted"===e?(this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!0})),this.setAttribute("hidden",""),En=null):this.dispatchEvent(new CustomEvent("pwa-installed",{detail:!1}))}}customElements.define("pwa-install-button",Vn);class jn extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).innerHTML="<slot><button>New update available!</button></slot>",this._refreshing=!1}async connectedCallback(){this.addEventListener("click",this._postMessage.bind(this)),navigator.serviceWorker.addEventListener("controllerchange",()=>{this._refreshing||(window.location.reload(),this._refreshing=!0)})}async _postMessage(t){t.preventDefault(),(await navigator.serviceWorker.getRegistration()).waiting.postMessage({type:"SKIP_WAITING"})}}customElements.define("pwa-update-available",jn);let Nn;const Wn=O(Nn||(Nn=(t=>t)`
  & {
    padding-top: 20px;
  }
...
`));function On(){const[t,e]=Ze(!1),[n,a]=Ze(!1);return $e(async()=>{if(Hn(t=>{a(t)}),navigator.permissions){const t=await navigator.permissions.query({name:"geolocation"});if("true"===localStorage.getItem("geolocation"))return void e(!1);"granted"!==t.state&&e(!0)}},[]),h("div",{class:Wn},h("button",{onClick:function(){document.getElementsByTagName("html")[0].classList.contains("dark")?(document.getElementsByTagName("html")[0].classList.remove("dark"),localStorage.setItem("darkmode","false"),An(!1)):(document.getElementsByTagName("html")[0].classList.add("dark"),localStorage.setItem("darkmode","true"),An(!0))},class:"ld-button"},"Toggle darkmode"),t?[" ",h("button",{onClick:function(){navigator.permissions&&navigator.geolocation.getCurrentPosition(()=>{e(!1)})},class:"ld-button"},"Allow geolocation")," "]:"",h("pwa-install-button",null,h("button",{class:"ld-button"},"Install app")),n?h("pwa-update-available",null,h("button",{class:"ld-button"},"Update app")):"")}const Bn={info:re,settings:oe,updates:ie,contribute:se};class Rn extends g{constructor(){super(),this.state={updateAvailable:!1,index:0},this.tabRefs={},this.__onFocusMove=this.__onFocusMove.bind(this),this.__onTabClick=this.__onTabClick.bind(this)}componentDidMount(){A("(min-width: 960px)",t=>{this.setState({isMobile:!t})}),Yt.addEventListener("close",t=>{t.detail.menuDialogClosed&&this.tabRefs["tab"+this.state.index].focus()}),Hn(t=>{this.setState({updateAvailable:t})})}updateIndex(t,e){"settings"===e&&this.state.updateAvailable&&this.setState({updateAvailable:!1}),this.setState({index:t}),this.tabRefs["tab"+t].focus(),this.state.isMobile||this.commit(e)}__onTabClick(t,e){this.updateIndex(t,e),this.commit(e)}commit(t){this.props.switchContent(t.toLowerCase())}__onFocusMove(t){const e=this.state.index;switch(t.keyCode){case 37:0!==e&&this.updateIndex(e-1,this.tabRefs["tab"+(e-1)].getAttribute("data-label").toLowerCase());break;case 39:e!==this.props.children.length-1&&this.updateIndex(e+1,this.tabRefs["tab"+(e+1)].getAttribute("data-label").toLowerCase())}}render(t,{index:e}){return h("ul",{class:"ld-menu--tabs",role:"tablist"},this.props.children.map((t,n)=>h("li",{role:"presentation",key:n},h("button",{role:"tab",ref:t=>this.tabRefs["tab"+n]=t,tabindex:e===n?"0":"-1","aria-selected":e===n?"true":"false",class:e===n?"ld-menu--active":"","data-label":t.props.id,onKeyUp:this.__onFocusMove,onClick:()=>this.__onTabClick(n,t.props.id)},"settings"===t.props.id&&this.state.updateAvailable?[" ",h("div",{class:"ld-menu--notification"})," "]:"",Bn[t.props.id],h("p",{class:e===n?"ld-menu--active":""},t.props.id.toUpperCase())))))}}let In,Fn,Yn,qn,Zn,$n,Gn=t=>t;const Qn=O(In||(In=Gn`
  & {
    margin-top: 30px;
    margin-bottom: 20px;
    width: 100%;
...
`)),na=t=>{switch(t){case"info":return{title:"info",template:[h("h1",null,"Lockdown"),h("p",{class:"ld-alpha"},"Project lockdown is currently in beta. Not all data may be available yet."),h("p",null,h("b",null,"Project Lockdown")," provides a mapping of the different NPIs (Non-Pharmaceutical Interventions) enforced by across the globe\n            in response to the COVID-19 crisis to visualize the success of different pandemic response measures, monitor effects on Human\n            and Digital Rights, and clarify evaluation metrics."),h(bn,{toggle:"About",detail:h("p",null,"Lockdown, quarantine, and isolation measures have been implemented across the globe to reduce the spread of COVID-19 and\n                reduce the strain on medical infrastructure. ",h("b",null,"Project Lockdown")," empowers citizens, journalists, and Human Rights\n                Defenderes to easily analyze the social and political effects of these measures. Founded on the values of transparency and\n                accountability, ",h("b",null,"Project Lockdown")," is committed to providing citizens of the world with the tools they need to stay\n                safe and informed.")}),h(bn,{toggle:"Legend",detail:[h("p",null,"The map shows two parameters for territories:"),h("ol",null,h("li",null,"If the country is under any type of lockdown"),h("li",null,"If there are covid cases in the country")),h("table",{class:Qn},h("tr",null,h("th",{scope:"col"}),h("th",{scope:"col"},"Lockdown"),h("th",{scope:"col"},"COVID-19")),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"blue",class:"blue circle"})),h("td",null,h("div",{"aria-label":"no"},le)),h("td",null,h("div",{"aria-label":"no"},le))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"green",class:"green circle"})),h("td",null,h("div",{"aria-label":"no"},le)),h("td",null,h("div",{"aria-label":"yes"},ce))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"yellow",class:"yellow circle"})),h("td",null,h("div",{"aria-label":"yes"},ce)),h("td",null,h("div",{"aria-label":"no"},le))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"red",class:"red circle"})),h("td",null,h("div",{"aria-label":"yes"},ce)),h("td",null,h("div",{"aria-label":"yes"},ce))),h("tr",null,h("td",{scope:"row"},h("div",{"aria-label":"gray",class:"default circle"})),h("td",null,"No Data",h("p",{class:"note"},"(please contribute)")),h("td",null,"No Data",h("p",{class:"note"},"(please contribute)"))))]}),h(bn,{toggle:"Sources",detail:h("p",null,h("b",null,"Project Lockdown")," combines multiple trusted sources to ensure that the data used is verified and accurate. You can find the full list of sources used here:",h("ul",{class:"ld-sources"},h("li",null,h("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://TIOF.Click/LockdownData"}," Project Lockdown's Database"),h("br",null),"(Collected from a number of NPI sources)"),h("li",null,h("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://covid19api.com/"},"Coronavirus COVID19 API"),h("br",null),"(Data sourced from ",h("a",{href:"https://systems.jhu.edu/",target:"_blank"},"Johns Hopkins CSSE)"),h("br",null))),"If you find any errors, please help us and report it ",h("a",{rel:"noopener noreferrer",target:"_blank",href:"https://github.com/Code-for-All/lockdown/issues"},"by creating an issue here"),".")}),h(bn,{toggle:"Credits",detail:h("p",null,h("b",null,"Project Lockdown")," is a Civic Tech initiative made possible by a number of dedicated individuals and organizations.\n                View the list of contributors",h("a",{href:"https://docs.google.com/spreadsheets/d/1mVyQxxLxAF3E1dw870WHXTOLgYzmumojvzIekpgvLV0/edit?ts=5e74ac83#gid=634415797",target:"_blank"},"here"),".")}),h(bn,{toggle:"Data & Privacy",detail:[h("p",null,"We do not collect any personal information from our visitors."),h("p",null,"All information on project members is provided with their consent.")]})]};case"settings":return{title:"settings",template:[" ",h(On,null)," "]};case"contribute":return{title:"contribute",template:[h("p",null,"Do you have any NPI source you would want to share with us? Please follow this link:"),h("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://docs.google.com/forms/d/e/1FAIpQLSfDWe2qlzUnd3e-YYspMzT9adUswDEYIdJMb7jz7ule34-yiA/viewform"},"Submit data"),h("p",null,"Additionally, you can become part of the project by joining one of the following teams:",h("ul",null,h("li",null,"Editors"),h("li",null,"Devs"),h("li",null,"UI/UX"))),h("p",null,"Contact us via Telegram at:",h("br",null),h("a",{class:"ld-link",target:"_blank",rel:"noopener noreferrer",href:"https://t.me/ProjectLockdown"}," @ProjectLockdown"))]};case"updates":return{title:"updates",template:[" ",h(Tn,null)," "]};default:return{title:"",template:void 0}}};class aa extends g{constructor(t){super(t),this.state={activeItem:"info",showLateralMenu:!1,showMenu:!1},this.showSideBar=this.showSideBar.bind(this),this.closeNavbar=this.closeNavbar.bind(this),this.switchContent=this.switchContent.bind(this)}componentDidMount(){let t=0;A("(min-width: 960px)",e=>{this.setState({isMobile:!e}),e&&t>0&&(t++,this.props.close())})}showSideBar(){this.setState({showLateralMenu:!0,showMenu:!0})}switchContent(t){if("settings"===t&&this.state.updateAvailable&&this.setState({updateAvailable:!1}),this.state.isMobile&&this.props.opened&&t===this.prevVal)return this.props.close(),this.setState({activeItem:this.prevVal}),void(this.prevVal="");this.props.changeRoute(na(t)),this.prevVal=t,this.setState({activeItem:t,showLateralMenu:t!==this.state.activeItem})}closeNavbar(){this.setState({showLateralMenu:!1,showSideBar:!1})}render(t,{activeItem:e,updateAvailable:n}){return this.state.showLateralMenu||!0===this.props.isMobile?[h("div",{class:"menu-overlay "+ea}),h("main",{id:"main",class:"ld-menu "+Jn+" "+(this.state.showLateralMenu?Xn:"")},h("div",{class:"ld-menu-nav"},h("button",{class:ta,onClick:this.closeNavbar},le),h("nav",null,h(Rn,{switchContent:this.switchContent},h("button",{id:"info"},"info"),h("button",{id:"settings"},"settings"),h("button",{id:"updates"},"updates"),h("button",{id:"contribute"},"contribute")))),h("div",{class:"ld-menu--content"},h("div",{class:"mb-only"},h("div",{class:"ld-menu--header"},h("h1",null,e))),na(e).template))]:h("button",{onClick:this.showSideBar,class:Kn},ve)}}class ra extends g{async componentWillMount(){const t=await this.props.component(),e=t.default||t;this.setState({Component:e})}render({props:t},{Component:e}){return h(e,t)}}var oa="object"==typeof global&&global&&global.Object===Object&&global,ia="object"==typeof self&&self&&self.Object===Object&&self,sa=oa||ia||Function("return this")(),la=sa.Symbol,ca=Object.prototype,da=ca.hasOwnProperty,ua=ca.toString,ha=la?la.toStringTag:void 0;var pa=Object.prototype.toString;var fa=la?la.toStringTag:void 0;function ga(t){return null==t?void 0===t?"[object Undefined]":"[object Null]":fa&&fa in Object(t)?function(t){var e=da.call(t,ha),n=t[ha];try{t[ha]=void 0;var a=!0}catch(t){}var r=ua.call(t);return a&&(e?t[ha]=n:delete t[ha]),r}(t):function(t){return pa.call(t)}(t)}function ma(t){var e=typeof t;return null!=t&&("object"==e||"function"==e)}var ba=/^\s+|\s+$/g,va=/^[-+]0x[0-9a-f]+$/i,wa=/^0b[01]+$/i,Ca=/^0o[0-7]+$/i,xa=parseInt;function _a(t){if("number"==typeof t)return t;if(function(t){return"symbol"==typeof t||function(t){return null!=t&&"object"==typeof t}(t)&&"[object Symbol]"==ga(t)}(t))return NaN;if(ma(t)){var e="function"==typeof t.valueOf?t.valueOf():t;t=ma(e)?e+"":e}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(ba,"");var n=wa.test(t);return n||Ca.test(t)?xa(t.slice(2),n?2:8):va.test(t)?NaN:+t}var ya=function(){return sa.Date.now()},ka=Math.max,Ma=Math.min;let La,Sa,Da=t=>t;const Pa=O(La||(La=Da`
  & {
    @media (max-width: 960px) {
      max-width: 200px;
    }
...
`));class Qa extends g{constructor(){super(),this.state={currentDateValue:2,currentPosition:24.5,datePickerPosition:"left",showDatePicker:!1,currentSelectedDay:"",firstDay:"",lastDay:"",currentSliderRange:[]},this.dateRef={},this.range={},this.onSliderChange=this.onSliderChange.bind(this),this.onBtnClick=this.onBtnClick.bind(this),this.onChooseDate=this.onChooseDate.bind(this),this.calendarWillClose=this.calendarWillClose.bind(this),this.closeDatePicker=this.closeDatePicker.bind(this),this.submitChanges=this.submitChanges.bind(this)}componentDidMount(){console.log(this.props.children);let t=new Date,e=[],n=7;for(let a=0;a<11;a++)a<2?e.push(this.rangePreProcces(t,0==a?-13:-7)):2!==a?(e.push(this.rangePreProcces(t,n)),n+=7):e.push(t);this.setState({currentSliderRange:e,currentSelectedDay:Ia(t),firstDay:Ra(e[0]),lastDay:Ra(e[e.length-1])})}onSliderChange(t){const{currentDateValue:e,currentSliderRange:n}=this.state,a=this.dateRef.current,r=Number(t.target.value);let o=Ba[r];a.style.left=o+"%",a.style.transform=`translate(-${o}%, 0)`,this.setState({currentDateValue:r,currentPosition:o,currentSelectedDay:Ia(n[r])},this.submitChanges)}onBtnClick(t){}onChooseDate(t){const e=this.dateRef.current;this.calendarWillClose();let n=[],a=7;for(let e=0;e<11;e++)e<2?n.push(this.rangePreProcces(t,0==e?-13:-7)):2!==e?(n.push(this.rangePreProcces(t,a)),a+=7):n.push(t);e.style.left="24.5%",e.style.transform="translate(-24.5%, 0)",this.setState({currentSliderRange:n,currentSelectedDay:Ia(t),firstDay:Ra(n[0]),lastDay:Ra(n[n.length-1]),currentDateValue:2,currentPosition:24.5})}calendarWillClose(){this.setState({datePickerPosition:this.state.datePickerPosition+" hide"},()=>setTimeout(()=>this.closeDatePicker(),400))}closeDatePicker(){this.setState({showDatePicker:!1,datePickerPosition:this.state.datePickerPosition.replace(" hide","")})}rangePreProcces(t,e){let n=new Date;return n.setDate(t.getDate()+e),n}submitChanges(){const{currentSliderRange:t,currentDateValue:e}=this.state;this.props.onChange(t[e],t[0],t[t.length-1])}render(t){return h("div",{class:"sliderWrapper "+Fa},this.props.children,h("div",{class:Ya+" "+qa+" "+(""!==this.props.children?"open":"")},h(Aa,{close:this.calendarWillClose,onSelect:this.onChooseDate,show:this.state.showDatePicker,customClass:this.state.datePickerPosition}),h("div",{class:$a,ref:this.dateRef},h("span",null,this.state.currentSelectedDay)),h("span",{class:"first "+Za},this.state.firstDay),h("button",{onClick:t=>this.onBtnClick("left"),class:"first "+Ga}),h("input",{ref:this.range,onInput:this.onSliderChange,type:"range",min:"0",max:"10",step:"1",value:this.state.currentDateValue}),h("button",{onClick:t=>this.onBtnClick("right"),class:"last "+Ga}),h("span",{class:"last "+Za},this.state.lastDay)))}}let Xa;const Ja=O(Xa||(Xa=(t=>t)`
  & {
    position: absolute;
    top: 45vh;
    left: 10px;
...
`));class Ka extends g{constructor(){super(),this.state={showDialog:!1,y:"bottom",x:"left"},this.btn={},this.onClick=this.onClick.bind(this),this.initBtn=this.initBtn.bind(this),this.onTouch=this.onTouch.bind(this),this.onTouchEnd=this.onTouchEnd.bind(this),this.onDrop=this.onDrop.bind(this)}initBtn(t){this.btn=t,t.addEventListener("touchmove",this.onTouch),t.addEventListener("touchend",this.onTouchEnd),t.addEventListener("dragend",this.onDrop)}onTouch(t){let e=t.targetTouches[0];this.btn.style.left=e.pageX+"px",this.btn.style.top=e.pageY+"px"}onTouchEnd(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=Number(this.btn.style.top.replace("px","")),i=Number(this.btn.style.left.replace("px",""));o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=160&&(this.btn.style.top="160px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onDrop(t){let e=this.state.x,n=this.state.y,a=window.innerWidth||window.clientWidth,r=window.innerHeight||window.clientHeight,o=t.clientY,i=t.clientX;this.btn.style.top=o+"px",o>r/2?(o>=r-150&&(this.btn.style.top=r-150+"px"),n="bottom"):(o<=60&&(this.btn.style.top="70px"),n="top"),i>a/2?(e="right",this.btn.style.left=a-70+"px"):(e="left",this.btn.style.left="10px"),this.setState({x:e,y:n})}onClick(){this.setState({showDialog:!this.state.showDialog})}render(t){return h("div",{onClick:this.onClick,draggable:"true",ref:this.initBtn,class:Ja},we,h("div",{class:"dialog "+(this.state.showDialog?"show":"")+" "+this.state.y+" "+this.state.x},h("div",null,h("span",null,h("div",{class:"color red"})),h("span",null,ye),h("span",null,xe)),h("div",null,h("span",null,h("div",{class:"color orange"})),h("span",null,_e),h("span",null,xe)),h("div",null,h("span",null,h("div",{class:"color green"})),h("span",null,ye),h("span",null,Ce)),h("div",null,h("span",null,h("div",{class:"color blue"})),h("span",null,_e),h("span",null,Ce)),h("div",null,h("span",null,h("div",{class:"color gray"})),h("span",null,"NO DATA"))))}}let tr;const er=function(t,e,n){var a,r,o,i,s,l,c=0,d=!1,u=!1,h=!0;if("function"!=typeof t)throw new TypeError("Expected a function");function p(e){var n=a,o=r;return a=r=void 0,c=e,i=t.apply(o,n)}function f(t){return c=t,s=setTimeout(m,e),d?p(t):i}function g(t){var n=t-l;return void 0===l||n>=e||n<0||u&&t-c>=o}function m(){var t=ya();if(g(t))return b(t);s=setTimeout(m,function(t){var n=e-(t-l);return u?Ma(n,o-(t-c)):n}(t))}function b(t){return s=void 0,h&&a?p(t):(a=r=void 0,i)}function v(){var t=ya(),n=g(t);if(a=arguments,r=this,l=t,n){if(void 0===s)return f(l);if(u)return clearTimeout(s),s=setTimeout(m,e),p(l)}return void 0===s&&(s=setTimeout(m,e)),i}return e=_a(e)||0,ma(n)&&(d=!!n.leading,o=(u="maxWait"in n)?ka(_a(n.maxWait)||0,e):o,h="trailing"in n?!!n.trailing:h),v.cancel=function(){void 0!==s&&clearTimeout(s),c=0,a=l=r=s=void 0},v.flush=function(){return void 0===s?i:b(ya())},v}(()=>{let t={menuDialogClosed:!1,countryDialogClosed:!1};const e=new URLSearchParams(location.search);e.has("country")||e.has("iso2")?t.countryDialogClosed=!0:t.menuDialogClosed=!0,Yt.close(t)},10,{leading:!0,trailing:!1}),nr=O(tr||(tr=(t=>t)`
  & {
    position: fixed;
    z-index: 1100;
    top: 74px;
...
`));function ar(t){return Bt(t,"yyyy-MM-dd")}("requestIdleCallback"in window?window.requestIdleCallback:t=>setTimeout(t,1e3))(()=>{import("./d7582d13.js"),import("./7058ba06.js")}),console.log("🌐 Project Lockdown, version: 0.0.0"),window.addEventListener("appinstalled",()=>{window.location.reload()}),A("(prefers-color-scheme: dark)",t=>{const e=localStorage.getItem("darkmode");null!==e?"true"===e&&(document.documentElement.classList.add("dark"),An(!0)):t?(document.documentElement.classList.add("dark"),An(!0)):(document.documentElement.classList.remove("dark"),An(!1))}),function(e,n,a){var r,o,c;t.__&&t.__(e,n),o=(r=a===i)?null:a&&a.__k||n.__k,e=h(f,null,[e]),c=[],M(n,(r?n:a||n).__k=e,o||s,s,void 0!==n.ownerSVGElement,a&&!r?[a]:o?null:l.slice.call(n.childNodes),c,a||s,r),L(c,e)}([" ",h(class extends g{constructor(){super(),this.state={dialog:{opened:!1,template:{},title:""},haveSelectedDate:!1},this.__onPathChanged=this.__onPathChanged.bind(this),this.__closeCountryInfo=this.__closeCountryInfo.bind(this),this.__closeDialog=this.__closeDialog.bind(this),this.__showDialog=this.__showDialog.bind(this),this.__showDialogRoute=this.__showDialogRoute.bind(this),this.__onSelectDate=this.__onSelectDate.bind(this)}async componentDidMount(){this.__onPathChanged(),A("(min-width: 960px)",t=>{this.setState({isMobile:!getMatchedCSSRules})})}componentWillMount(){Ft.addEventListener("path-changed",this.__onPathChanged),this.setState({showStatsbox:1==Number(Ft.url.searchParams.get("statsbox")||1),showMenu:1==Number(Ft.url.searchParams.get("menu")||1),showSlider:1==Number(Ft.url.searchParams.get("slider")||1)})}componentWillUnmount(){Ft.removeEventListener("path-changed",this.__onPathChanged)}render(){const t=this.state.haveSelectedDate?ar(this.state.haveSelectedDate):ar(new Date);return[this.state.showStatsbox?[h(Ve,{selectedDate:t,showStatsbox:this.state.showStatsbox}),this.state.dialog.opened?"":h("div",{class:nr},h(ae,{selectedDate:t}))]:"",this.state.showMenu?h(aa,{opened:this.state.dialog.opened,isMobile:this.state.isMobile,changeRoute:this.__showDialogRoute,close:this.__closeDialog}):"",h(Jt,{selectedDate:t}),h(Ka,null),this.state.showSlider?h(Qa,{onChange:this.__onSelectDate},this.state.dialog.opened?h(ra,{component:()=>import("./7058ba06.js"),props:{country:this.state.dialog.title,iso2:this.state.dialog.iso2,date:this.state.haveSelectedDate||new Date,onClose:this.__closeDialog}}):""):""]}__showDialogRoute({template:t,title:e}){const n=Ft.url.searchParams.get("country");n?Ft.setPath(`${e}?country=${n}`):Ft.setPath(e),this.state.isMobile&&(Ft.setSearchParam("country",null),this.__showDialog({template:t,title:e}))}__onPathChanged(){const t=Ft.url.searchParams.get("country"),e=Ft.url.searchParams.get("iso2"),n=this.state.haveSelectedDate||new Date;t&&e&&this.setState({dialog:{opened:!0,template:[" ",h(ra,{component:()=>import("./7058ba06.js"),props:{country:t,iso2:e,date:n}})," "],title:t,iso2:e,date:n}},()=>console.log(this.state))}__showDialog({template:t,title:e}){this.setState({dialog:{opened:!0,template:t,title:e}})}__closeCountryInfo(){Ft.setSearchParam("country",void 0),Ft.setSearchParam("iso2",void 0)}__closeDialog(){this.setState({dialog:{opened:!1,template:"",title:""}}),er(),this.__closeCountryInfo()}__onSelectDate(t){this.setState({haveSelectedDate:t})}},null)," "],document.getElementById("app"));export{It as E,Sn as a,ke as b,O as c,Me as d,De as e,Bt as f,ze as g,h,He as i,Pe as j,Ae as k,Ln as l,g as m,he as n,ue as o,le as p,ge as q,Le as r,Te as s,fe as t,pe as u,Ft as v,Se as w};
