...
export function Expandable(props){
  ...
  return html`
    <div class="ld-expandable">
      <button onClick=${() => setExpanded(!expanded)} id="button1" class="ld-expandable--toggle" aria-controls="t1" aria-expanded="${expanded}">
      ...
      <div ref=${detail} id="t1" class="ld-expandable--detail ${expanded ? 'ld-expandable--expanded' : 'ld-expandable--closed'}" role="region" tabindex="-1" >
        ${props.detail}
      </div>
    </div>
  `;
