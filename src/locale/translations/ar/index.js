    ...
    informationSection: {
      ...
      about: {
        ...
        text: {
          ...
          p2:
            'تمكين المواطنين والصحفيين والمدافعين عن حقوق الإنسان من تحليل الآثار الاجتماعية والسياسية المترتبة نتيجة هذه التدابير الوقائية بسهولة. تأسست على قيم الشفافية والمسئولية،',
          p3: 'وتلتزم بتزويد مواطني العالم بالأدوات اللازمة للبقاء في أمان وعلى علم بالمُجريات.',
        },
      },
      sources: {
        title: 'المصادر',
        subtitle:
          'مجموعة متعددة من المصادر الموثوقة لضمان التحقق من صحة البيانات المستخدمة ودقتها. يمكنك العثور على القائمة الكاملة للمصادر المستخدمة هنا:',
        linksList: {
          first: {
      ...
      credits: {
        title: 'الحقوق',
        text: 'هي مبادرة اجتماعية تقنية نفّذتها مجموعة من الأفراد والمنظمات المتفانية. اطلع على قائمة المساهمين',
        highlight: 'هنا',
      },
      dataPrivacity: {
