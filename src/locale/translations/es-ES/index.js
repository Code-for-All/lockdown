  ...
  "menu":{
    "informationSection":{
      ...
      "main":{
        ...
        "text":"muestra un mapeo de las distintas NPIs (del ingles Non-Pharmaceutical Interventions o Intervenciones No Farmaceuticas) aplicadas en todo el mundo en respuesta a la crisis de la COVID-19. El objetivo es visualizar las medidas adoptadas en respuesta ante la pandemia y evaluar sus efectos sobre los Derechos Humanos y Digitales."
      },
      "about":{
        "title":"Acerca de",
        "text":{
          "p1":"En un intento de reducir la propagación de la COVID-19 y reducir la presión sobre sus infraestructuras médicas, gobiernos de todo el mundo han implementado medidas de bloqueo, cuarentena y aislamiento.",
          "p2":"empodera a los ciudadanos, periodistas y defensores de los derechos humanos para analizar fácilmente los efectos sociales y políticos de estas medidas. Fundado en los valores de transparencia y responsabilidad,",
      ...
      "sources":{
        "title":"Recursos",
        "subtitle": "combina múltiples fuentes y una solida metodologia para garantizar que los datos presentados sean precisos. Puede encontrar la lista completa de fuentes utilizadas aquí:",
        "linksList":{
          "first":{
      ...
      "credits":{
        "title":"Creditos",
        "text": "es una iniciativa Civic Tech hecha posible por una red internacional de voluntarios y organizaciones. Consultar aqui la lista de ",
        "highlight":"miembros."
      },
      "dataPrivacity":{
